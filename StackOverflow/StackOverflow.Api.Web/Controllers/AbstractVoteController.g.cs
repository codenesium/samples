...
namespace StackOverflowNS.Api.Web
{
	public abstract class AbstractVoteController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> ByPostId(int postId, int? limit, int? offset)
		{
			...
			List<ApiVoteServerResponseModel> response = await this.VoteService.ByPostId(postId, query.Limit, query.Offset);
		...
		public async virtual Task<IActionResult> ByVoteTypeId(int voteTypeId, int? limit, int? offset)
		{
			...
			List<ApiVoteServerResponseModel> response = await this.VoteService.ByVoteTypeId(voteTypeId, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>bb589c49bda5477e32ab65b8c8e4da65</Hash>
</Codenesium>*/