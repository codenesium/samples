...
namespace StackOverflowNS.Api.Web
{
	...
	public class VoteTypeController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> VotesByVoteTypeId(int voteTypeId, int? limit, int? offset)
		{
			...
			List<ApiVoteServerResponseModel> response = await this.VoteTypeService.VotesByVoteTypeId(voteTypeId, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>e4daafa7547eb1ef906a7a85fa784153</Hash>
    <Hello>
