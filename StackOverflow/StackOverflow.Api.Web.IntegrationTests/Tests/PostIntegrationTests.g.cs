...
namespace StackOverflowNS.Api.Web.IntegrationTests
{
	...
	public partial class PostIntegrationTests
	{
		...
		public virtual async void TestBulkInsert()
		{
			...
			model2.SetProperties(3, 3, "C", DateTime.Parse("1/1/1989 12:00:00 AM"), 3, DateTime.Parse("1/1/1989 12:00:00 AM"), DateTime.Parse("1/1/1989 12:00:00 AM"), 3, DateTime.Parse("1/1/1989 12:00:00 AM"), DateTime.Parse("1/1/1989 12:00:00 AM"), "C", 3, 3, 3, 3, 3, "C", "C", 3);
			...
			context.Set<Post>().ToList()[1].LastEditorUserId.Should().Be(2);
			context.Set<Post>().ToList()[1].OwnerUserId.Should().Be(2);
			context.Set<Post>().ToList()[1].ParentId.Should().Be(2);
			context.Set<Post>().ToList()[1].PostTypeId.Should().Be(2);
			...
			context.Set<Post>().ToList()[2].LastEditorUserId.Should().Be(3);
			context.Set<Post>().ToList()[2].OwnerUserId.Should().Be(3);
			context.Set<Post>().ToList()[2].ParentId.Should().Be(3);
			context.Set<Post>().ToList()[2].PostTypeId.Should().Be(3);
		...
		public virtual async void TestCreate()
		{
			...
			result.Record.LastEditorUserId.Should().Be(2);
			result.Record.OwnerUserId.Should().Be(2);
			result.Record.ParentId.Should().Be(2);
			result.Record.PostTypeId.Should().Be(2);
		...
		public virtual async void TestUpdate()
		{
			...
			request.SetProperties(2, 2, "B", DateTime.Parse("1/1/1988 12:00:00 AM"), 2, DateTime.Parse("1/1/1988 12:00:00 AM"), DateTime.Parse("1/1/1988 12:00:00 AM"), 2, DateTime.Parse("1/1/1988 12:00:00 AM"), DateTime.Parse("1/1/1988 12:00:00 AM"), "B", 2, 2, 2, 2, 2, "B", "B", 2);
			...
			context.Set<Post>().ToList()[0].LastEditorUserId.Should().Be(2);
			context.Set<Post>().ToList()[0].OwnerUserId.Should().Be(2);
			context.Set<Post>().ToList()[0].ParentId.Should().Be(2);
			context.Set<Post>().ToList()[0].PostTypeId.Should().Be(2);
			...
			updateResponse.Record.LastEditorUserId.Should().Be(2);
			updateResponse.Record.OwnerUserId.Should().Be(2);
			updateResponse.Record.ParentId.Should().Be(2);
			updateResponse.Record.PostTypeId.Should().Be(2);
...
/*<Codenesium>
    <Hash>72217abef45531a6c88bad7e07218916</Hash>
</Codenesium>*/