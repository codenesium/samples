...
namespace StackOverflowNS.Api.Web.IntegrationTests
{
	...
	public partial class TagIntegrationTests
	{
		...
		public virtual async void TestBulkInsert()
		{
			...
			context.Set<Tag>().ToList()[1].ExcerptPostId.Should().Be(2);
			context.Set<Tag>().ToList()[1].TagName.Should().Be("B");
			context.Set<Tag>().ToList()[1].WikiPostId.Should().Be(2);

			context.Set<Tag>().ToList()[2].Count.Should().Be(3);
			context.Set<Tag>().ToList()[2].ExcerptPostId.Should().Be(3);
			context.Set<Tag>().ToList()[2].TagName.Should().Be("C");
			context.Set<Tag>().ToList()[2].WikiPostId.Should().Be(3);
		}
		...
		public virtual async void TestCreate()
		{
			...
			result.Record.ExcerptPostId.Should().Be(2);
			result.Record.TagName.Should().Be("B");
			result.Record.WikiPostId.Should().Be(2);
		}
		...
		public virtual async void TestUpdate()
		{
			...
			context.Set<Tag>().ToList()[0].ExcerptPostId.Should().Be(2);
			context.Set<Tag>().ToList()[0].TagName.Should().Be("B");
			context.Set<Tag>().ToList()[0].WikiPostId.Should().Be(2);

			updateResponse.Record.Id.Should().Be(1);
			updateResponse.Record.Count.Should().Be(2);
			updateResponse.Record.ExcerptPostId.Should().Be(2);
			updateResponse.Record.TagName.Should().Be("B");
			updateResponse.Record.WikiPostId.Should().Be(2);
		}
...
/*<Codenesium>
    <Hash>285eed5e1cea0a941ab25cc529f8e549</Hash>
</Codenesium>*/