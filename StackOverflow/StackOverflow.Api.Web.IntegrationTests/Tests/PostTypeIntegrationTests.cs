...
namespace StackOverflowNS.Api.Web.IntegrationTests
{
	...
	public partial class PostTypeIntegrationTests
	{
		...
		public virtual async void TestBulkInsert()
		{
			...
			context.Set<PostType>().ToList()[1].RwType.Should().Be("B");

			context.Set<PostType>().ToList()[2].RwType.Should().Be("C");
		}
		...
		public virtual async void TestForeignKeyPostsByPostTypeIdFound()
		{
			...
			var client = new ApiClient(testServer.CreateClient());
			client.SetBearerToken(JWTTestHelper.GenerateBearerToken());
			List<ApiPostClientResponseModel> response = await client.PostsByPostTypeId(1);
		...
		public virtual async void TestForeignKeyPostsByPostTypeIdNotFound()
		{
			...
			var client = new ApiClient(testServer.CreateClient());
			client.SetBearerToken(JWTTestHelper.GenerateBearerToken());
			List<ApiPostClientResponseModel> response = await client.PostsByPostTypeId(default(int));
...
/*<Codenesium>
    <Hash>1059d80a9cd7b0ac4bd8021ce5c795fc</Hash>
    <Hello>
