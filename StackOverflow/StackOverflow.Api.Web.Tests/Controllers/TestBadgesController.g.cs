...
namespace StackOverflowNS.Api.Web.Tests
{
        ...
        public partial class BadgesControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        BadgesController controller = new BadgesController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiBadgesResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiBadgesRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiBadgesRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        BadgesController controller = new BadgesController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>dd746ec0e2efc547a4e64ce1b9aebc19</Hash>
</Codenesium>*/