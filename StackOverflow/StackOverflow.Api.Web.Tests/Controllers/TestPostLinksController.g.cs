...
namespace StackOverflowNS.Api.Web.Tests
{
	...
	public partial class PostLinksControllerTests
	{
		...
		public async void Create_No_Errors()
		{
			...
			var createResponse = (response as CreatedResult).Value as CreateResponse<ApiPostLinksResponseModel>;
		...
		{
			PostLinksControllerMockFacade mock = new PostLinksControllerMockFacade();
			var mockResult = new Mock<UpdateResponse<ApiPostLinksResponseModel>>();
			...
			.Returns(Task.FromResult<UpdateResponse<ApiPostLinksResponseModel>>(mockResult.Object));
			...
			PostLinksController controller = new PostLinksController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiPostLinksModelMapper());
			controller.ControllerContext = new ControllerContext();
			controller.ControllerContext.HttpContext = new DefaultHttpContext();
		...
		public async void Update_No_Errors()
		{
			...
			var mockResult = new Mock<UpdateResponse<ApiPostLinksResponseModel>>();
			mockResult.SetupGet(x => x.Success).Returns(true);
			mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiPostLinksRequestModel>())).Returns(Task.FromResult<UpdateResponse<ApiPostLinksResponseModel>>(mockResult.Object));
			mock.ServiceMock.Setup(x => x.Get(It.IsAny<int>())).Returns(Task.FromResult(new ApiPostLinksResponseModel()));
			PostLinksController controller = new PostLinksController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiPostLinksModelMapper());
			controller.ControllerContext = new ControllerContext();
			controller.ControllerContext.HttpContext = new DefaultHttpContext();
	...
	public class PostLinksControllerMockFacade
	{
		...
		public Mock<IApiPostLinksModelMapper> ModelMapperMock { get; set; } = new Mock<IApiPostLinksModelMapper>();
	}
}

/*<Codenesium>
    <Hash>ce9aba0fa8aad8855f210cb2e86d0733</Hash>
</Codenesium>*/