...
namespace StackOverflowNS.Api.Web.Tests
{
        ...
        public partial class PostHistoryTypesControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        PostHistoryTypesController controller = new PostHistoryTypesController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiPostHistoryTypesResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiPostHistoryTypesRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiPostHistoryTypesRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        PostHistoryTypesController controller = new PostHistoryTypesController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>ee65bb154322d07ebf4b535264701088</Hash>
</Codenesium>*/