...
namespace StackOverflowNS.Api.DataAccess
{
	public abstract class AbstractBadgeRepository : AbstractRepository
	{
			...
			ListSortDirection sortDirection = ListSortDirection.Ascending)
		{
			...
			{
				return await this.Context.Set<Badge>().Where(predicate).AsQueryable().OrderByDescending(orderBy).Skip(offset).Take(limit).ToListAsync<Badge>();
			}
		}
...
/*<Codenesium>
    <Hash>5dc91c1564fafc17c5a90f07f50e0cdb</Hash>
</Codenesium>*/