		...
		public virtual Task<List<Post>> All(int limit = int.MaxValue, int offset = 0, string query = "")
		{
			...
			else
			{
				return this.Where(x =>
				                  ...
				                  (x.Body == null?false : x.Body.StartsWith(query)) ||
				                  ...
				                  (x.LastEditorDisplayName == null?false : x.LastEditorDisplayName.StartsWith(query)) ||
				                  ...
				                  x.Score == query.ToInt() ||
				                  (x.Tag == null?false : x.Tag.StartsWith(query)) ||
...
/*<Codenesium>
    <Hash>742454417798a31aae95b557f1d27744</Hash>
    <Hello>
