...
namespace StackOverflowNS.Api.Services.Tests
{
	...
	[Trait("Table", "Posts")]
	[Trait("Area", "ApiModel")]
	public class TestApiPostsServerModelMapper
	{
		[Fact]
		public void MapServerRequestToResponse()
		{
			...
			ApiPostsServerResponseModel response = mapper.MapServerRequestToResponse(1, model);
		...
		public void MapServerResponseToRequest()
		{
			...
			ApiPostsServerRequestModel response = mapper.MapServerResponseToRequest(model);
			response.Should().NotBeNull();
			response.AcceptedAnswerId.Should().Be(1);
			response.AnswerCount.Should().Be(1);
			response.Body.Should().Be("A");
		...
		public void CreatePatch()
		{
			...
			JsonPatchDocument<ApiPostsServerRequestModel> patch = mapper.CreatePatch(model);
			var response = new ApiPostsServerRequestModel();
...
/*<Codenesium>
    <Hash>cc82134afff5f116be92b2cfd50dc483</Hash>
</Codenesium>*/