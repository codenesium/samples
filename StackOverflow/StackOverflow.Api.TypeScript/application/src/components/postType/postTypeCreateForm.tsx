...
interface Props {
   ...
   const PostTypeCreateDisplay: React.SFC<FormikProps<PostTypeViewModel>> = (props: FormikProps<PostTypeViewModel>) => {
...
const PostTypeCreate = withFormik<Props, PostTypeViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.PostTypes,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.PostTypeClientRequestModel>;
  ...
  export default class PostTypeCreateComponent extends React.Component<PostTypeCreateComponentProps, PostTypeCreateComponentState> {
...
/*<Codenesium>
    <Hash>c70a9b4234d5ff0c665a4f7a3cc68b34</Hash>
</Codenesium>*/