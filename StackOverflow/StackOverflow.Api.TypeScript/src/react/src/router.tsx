      ...
      >
        ...
        <Switch>
          ...
          <Route
            ...
            component={wrapperHeader(WrappedBadgeCreateComponent)}
          />
          <Route
            path={ClientRoutes.Badges + '/edit/:id'}
            component={wrapperHeader(WrappedBadgeEditComponent)}
          />
          <Route
            path={ClientRoutes.Badges + '/:id'}
            component={wrapperHeader(WrappedBadgeDetailComponent)}
          />
          <Route
            path={ClientRoutes.Badges}
            component={wrapperHeader(WrappedBadgeSearchComponent)}
          />
          <Route
            path={ClientRoutes.Comments + '/create'}
            component={wrapperHeader(WrappedCommentCreateComponent)}
          />
          <Route
            path={ClientRoutes.Comments + '/edit/:id'}
            component={wrapperHeader(WrappedCommentEditComponent)}
          />
          <Route
            path={ClientRoutes.Comments + '/:id'}
            component={wrapperHeader(WrappedCommentDetailComponent)}
          />
          <Route
            path={ClientRoutes.Comments}
            component={wrapperHeader(WrappedCommentSearchComponent)}
          />
          <Route
            path={ClientRoutes.LinkTypes + '/create'}
            component={wrapperHeader(WrappedLinkTypeCreateComponent)}
          />
          <Route
            path={ClientRoutes.LinkTypes + '/edit/:id'}
            component={wrapperHeader(WrappedLinkTypeEditComponent)}
          />
          <Route
            path={ClientRoutes.LinkTypes + '/:id'}
            component={wrapperHeader(WrappedLinkTypeDetailComponent)}
          />
          <Route
            path={ClientRoutes.LinkTypes}
            component={wrapperHeader(WrappedLinkTypeSearchComponent)}
          />
          <Route
            path={ClientRoutes.PostHistories + '/create'}
            component={wrapperHeader(WrappedPostHistoryCreateComponent)}
          />
          <Route
            path={ClientRoutes.PostHistories + '/edit/:id'}
            component={wrapperHeader(WrappedPostHistoryEditComponent)}
          />
          <Route
            path={ClientRoutes.PostHistories + '/:id'}
            component={wrapperHeader(WrappedPostHistoryDetailComponent)}
          />
          <Route
            path={ClientRoutes.PostHistories}
            component={wrapperHeader(WrappedPostHistorySearchComponent)}
          />
          <Route
            path={ClientRoutes.PostHistoryTypes + '/create'}
            component={wrapperHeader(WrappedPostHistoryTypeCreateComponent)}
          />
          <Route
            path={ClientRoutes.PostHistoryTypes + '/edit/:id'}
            component={wrapperHeader(WrappedPostHistoryTypeEditComponent)}
          />
          <Route
            path={ClientRoutes.PostHistoryTypes + '/:id'}
            component={wrapperHeader(WrappedPostHistoryTypeDetailComponent)}
          />
          <Route
            path={ClientRoutes.PostHistoryTypes}
            component={wrapperHeader(WrappedPostHistoryTypeSearchComponent)}
          />
          <Route
            path={ClientRoutes.PostLinks + '/create'}
            component={wrapperHeader(WrappedPostLinkCreateComponent)}
          />
          <Route
            path={ClientRoutes.PostLinks + '/edit/:id'}
            component={wrapperHeader(WrappedPostLinkEditComponent)}
          />
          <Route
            path={ClientRoutes.PostLinks + '/:id'}
            component={wrapperHeader(WrappedPostLinkDetailComponent)}
          />
          <Route
            path={ClientRoutes.PostLinks}
            component={wrapperHeader(WrappedPostLinkSearchComponent)}
          />
          <Route
            path={ClientRoutes.Posts + '/create'}
            component={wrapperHeader(WrappedPostCreateComponent)}
          />
          <Route
            path={ClientRoutes.Posts + '/edit/:id'}
            component={wrapperHeader(WrappedPostEditComponent)}
          />
          <Route
            path={ClientRoutes.Posts + '/:id'}
            component={wrapperHeader(WrappedPostDetailComponent)}
          />
          <Route
            path={ClientRoutes.Posts}
            component={wrapperHeader(WrappedPostSearchComponent)}
          />
          <Route
            path={ClientRoutes.PostTypes + '/create'}
            component={wrapperHeader(WrappedPostTypeCreateComponent)}
          />
          <Route
            path={ClientRoutes.PostTypes + '/edit/:id'}
            component={wrapperHeader(WrappedPostTypeEditComponent)}
          />
          <Route
            path={ClientRoutes.PostTypes + '/:id'}
            component={wrapperHeader(WrappedPostTypeDetailComponent)}
          />
          <Route
            path={ClientRoutes.PostTypes}
            component={wrapperHeader(WrappedPostTypeSearchComponent)}
          />
          <Route
            path={ClientRoutes.Tags + '/create'}
            component={wrapperHeader(WrappedTagCreateComponent)}
          />
          <Route
            path={ClientRoutes.Tags + '/edit/:id'}
            component={wrapperHeader(WrappedTagEditComponent)}
          />
          <Route
            path={ClientRoutes.Tags + '/:id'}
            component={wrapperHeader(WrappedTagDetailComponent)}
          />
          <Route
            path={ClientRoutes.Tags}
            component={wrapperHeader(WrappedTagSearchComponent)}
          />
          <Route
          ...
          <Route
            ...
            component={wrapperHeader(WrappedVoteCreateComponent)}
          />
          <Route
            path={ClientRoutes.Votes + '/edit/:id'}
            component={wrapperHeader(WrappedVoteEditComponent)}
          />
          <Route
            path={ClientRoutes.Votes + '/:id'}
            component={wrapperHeader(WrappedVoteDetailComponent)}
          />
          <Route
            path={ClientRoutes.Votes}
            component={wrapperHeader(WrappedVoteSearchComponent)}
          />
          <Route
            path={ClientRoutes.VoteTypes + '/create'}
            component={wrapperHeader(WrappedVoteTypeCreateComponent)}
          />
          <Route
            path={ClientRoutes.VoteTypes + '/edit/:id'}
            component={wrapperHeader(WrappedVoteTypeEditComponent)}
          />
          <Route
            path={ClientRoutes.VoteTypes + '/:id'}
            component={wrapperHeader(WrappedVoteTypeDetailComponent)}
          />
          <Route
            path={ClientRoutes.VoteTypes}
            component={wrapperHeader(WrappedVoteTypeSearchComponent)}
          />
        </Switch>
      </Security>
    </BrowserRouter>
...
/*<Codenesium>
    <Hash>2f6b3fee039b94449a73fb4c4a87c0b9</Hash>
</Codenesium>*/