        ...
        <Switch>
          <Route exact path="/" component={Dashboard} />
					  ...
					  <Route path="/comments" component={CommentSearchComponent} />
										  <Route path="/linktypes/create" component={LinkTypeCreateComponent} />
					  <Route path="/linktypes/edit/:id" component={LinkTypeEditComponent} />
					  <Route path="/linktypes/:id" component={LinkTypeDetailComponent} />
					  <Route path="/linktypes" component={LinkTypeSearchComponent} />
										  <Route path="/posthistories/create" component={PostHistoryCreateComponent} />
					  <Route path="/posthistories/edit/:id" component={PostHistoryEditComponent} />
					  <Route path="/posthistories/:id" component={PostHistoryDetailComponent} />
					  <Route path="/posthistories" component={PostHistorySearchComponent} />
										  <Route path="/posthistorytypes/create" component={PostHistoryTypeCreateComponent} />
					  <Route path="/posthistorytypes/edit/:id" component={PostHistoryTypeEditComponent} />
					  <Route path="/posthistorytypes/:id" component={PostHistoryTypeDetailComponent} />
					  <Route path="/posthistorytypes" component={PostHistoryTypeSearchComponent} />
										  <Route path="/postlinks/create" component={PostLinkCreateComponent} />
					  <Route path="/postlinks/edit/:id" component={PostLinkEditComponent} />
					  ...
					  <Route path="/posts" component={PostSearchComponent} />
										  <Route path="/posttypes/create" component={PostTypeCreateComponent} />
					  <Route path="/posttypes/edit/:id" component={PostTypeEditComponent} />
					  ...
					  <Route path="/votes" component={VoteSearchComponent} />
										  <Route path="/votetypes/create" component={VoteTypeCreateComponent} />
					  <Route path="/votetypes/edit/:id" component={VoteTypeEditComponent} />
...
/*<Codenesium>
    <Hash>c0ba9aeb60baaa2ac332e2e9bf1da8d9</Hash>
</Codenesium>*/