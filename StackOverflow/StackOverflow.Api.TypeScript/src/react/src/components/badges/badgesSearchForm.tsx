...
interface BadgesSearchComponentState
{
    records:Array<BadgesViewModel>;
...
export default class BadgesSearchComponent extends React.Component<BadgesSearchComponentProps, BadgesSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<BadgesViewModel>(), filteredRecords:new Array<BadgesViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<BadgesViewModel>(), filteredRecords:new Array<BadgesViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedBadgesSearchComponent = Form.create({ name: 'Badges Search' })(BadgesSearchComponent);

/*<Codenesium>
    <Hash>2cef9ccda73ed88bf6c2012ea9cdf45d</Hash>
</Codenesium>*/