...
export default class BadgesSearchComponent extends React.Component<
  BadgesSearchComponentProps,
  BadgesSearchComponentState
> {
  state = {
...
export const WrappedBadgesSearchComponent = Form.create({
  name: 'Badges Search',
})(BadgesSearchComponent);
