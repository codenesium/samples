...
interface BadgesEditComponentProps {
  form: WrappedFormUtils;
  history: any;
  match: any;
}

interface BadgesEditComponentState {
...
class BadgesEditComponent extends React.Component<
  BadgesEditComponentProps,
  BadgesEditComponentState
> {
  state = {
  ...
  componentDidMount() {
    ...
    axios
      .get<Api.BadgesClientResponseModel>(
  ...
  submit = (model: BadgesViewModel) => {
    let mapper = new BadgesMapper();
    axios
      .put<CreateResponse<Api.BadgesClientRequestModel>>(
...
export const WrappedBadgesEditComponent = Form.create({ name: 'Badges Edit' })(
  BadgesEditComponent
);


/*<Codenesium>
    <Hash>d3829676b7cc84ffd2cdf97bfaa918ca</Hash>
</Codenesium>*/