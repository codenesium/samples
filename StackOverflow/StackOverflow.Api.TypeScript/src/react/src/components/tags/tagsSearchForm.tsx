...
export default class TagsSearchComponent extends React.Component<TagsSearchComponentProps, TagsSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<TagsViewModel>(), filteredRecords:new Array<TagsViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<TagsViewModel>(), filteredRecords:new Array<TagsViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedTagsSearchComponent = Form.create({ name: 'Tags Search' })(TagsSearchComponent);

/*<Codenesium>
    <Hash>966f7b5a377c8556db4dcb443c92b464</Hash>
</Codenesium>*/