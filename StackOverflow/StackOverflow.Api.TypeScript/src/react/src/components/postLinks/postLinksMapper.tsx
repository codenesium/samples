...
import PostLinksViewModel from  './postLinksViewModel';
	...
	mapApiResponseToViewModel(dto: Api.PostLinksClientResponseModel) : PostLinksViewModel 
	{
		...
		response.setProperties(dto.creationDate,dto.id,dto.linkTypeId,dto.postId,dto.relatedPostId);
						...
						if(dto.linkTypeIdNavigation != null)
				{
				  ...
				  dto.linkTypeIdNavigation.id,dto.linkTypeIdNavigation.rwType
				  );
				}
							...
							if(dto.relatedPostIdNavigation != null)
				{
				  ...
				  dto.relatedPostIdNavigation.acceptedAnswerId,dto.relatedPostIdNavigation.answerCount,dto.relatedPostIdNavigation.body,dto.relatedPostIdNavigation.closedDate,dto.relatedPostIdNavigation.commentCount,dto.relatedPostIdNavigation.communityOwnedDate,dto.relatedPostIdNavigation.creationDate,dto.relatedPostIdNavigation.favoriteCount,dto.relatedPostIdNavigation.id,dto.relatedPostIdNavigation.lastActivityDate,dto.relatedPostIdNavigation.lastEditDate,dto.relatedPostIdNavigation.lastEditorDisplayName,dto.relatedPostIdNavigation.lastEditorUserId,dto.relatedPostIdNavigation.ownerUserId,dto.relatedPostIdNavigation.parentId,dto.relatedPostIdNavigation.postTypeId,dto.relatedPostIdNavigation.score,dto.relatedPostIdNavigation.tag,dto.relatedPostIdNavigation.title,dto.relatedPostIdNavigation.viewCount
				  );
				}
	...
	mapViewModelToApiRequest(model: PostLinksViewModel) : Api.PostLinksClientRequestModel
	{
...
/*<Codenesium>
    <Hash>57ada060fa480be5f70ec667b76ca9a7</Hash>
</Codenesium>*/