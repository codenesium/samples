...
export default class PostLinksSearchComponent extends React.Component<PostLinksSearchComponentProps, PostLinksSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<PostLinksViewModel>(), filteredRecords:new Array<PostLinksViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<PostLinksViewModel>(), filteredRecords:new Array<PostLinksViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
            ...
            <ReactTable 
                ...
                columns={[{
                    ...
                    columns: [
                      ...
                      accessor: 'linkTypeId',
                      Cell: (props) => {
                        return <a href='' onClick={(e) => { e.preventDefault(); this.props.history.push(ClientRoutes.LinkTypes + '/' + props.original.linkTypeId); }}>
                          {String(
                      ...
                      Cell: (props) => {
                        return <a href='' onClick={(e) => { e.preventDefault(); this.props.history.push(ClientRoutes.Posts + '/' + props.original.relatedPostId); }}>
                          {String(
...
export const WrappedPostLinksSearchComponent = Form.create({ name: 'PostLinks Search' })(PostLinksSearchComponent);

/*<Codenesium>
    <Hash>57fda8e8268824f78ea67ee278a9e21a</Hash>
</Codenesium>*/