      ...
      return (
		...
		<Button 
		  ...
		  <div>
							...
							<h3>Link Type</h3>
							<p>{String(this.state.model!.linkTypeIdNavigation!.toDisplay())}</p>
						 </div>
					   						 <div style={{"marginBottom":"10px"}}>
							<h3>Post</h3>
							<p>{String(this.state.model!.postIdNavigation!.toDisplay())}</p>
					   						 ...
					   						 <div style={{"marginBottom":"10px"}}>
							<h3>Related Post</h3>
							<p>{String(this.state.model!.relatedPostIdNavigation!.toDisplay())}</p>
						 </div>
					   		  </div>
          {message}
...
export const WrappedPostLinksDetailComponent = Form.create({ name: 'PostLinks Detail' })(
  PostLinksDetailComponent
);

/*<Codenesium>
    <Hash>4d4819a41f0d621c25da58c08ff3f79e</Hash>
</Codenesium>*/