...
interface Props {
   ...
   const LinkTypeCreateDisplay: React.SFC<FormikProps<LinkTypeViewModel>> = (props: FormikProps<LinkTypeViewModel>) => {
...
const LinkTypeCreate = withFormik<Props, LinkTypeViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.LinkTypes,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.LinkTypeClientRequestModel>;
  ...
  export default class LinkTypeCreateComponent extends React.Component<LinkTypeCreateComponentProps, LinkTypeCreateComponentState> {
...
/*<Codenesium>
    <Hash>f4a4f3c3ad4c151dbcf2bcd7ca9d873a</Hash>
</Codenesium>*/