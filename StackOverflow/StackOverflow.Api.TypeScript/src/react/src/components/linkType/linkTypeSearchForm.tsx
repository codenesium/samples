...
export default class LinkTypeSearchComponent extends React.Component<LinkTypeSearchComponentProps, LinkTypeSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<LinkTypeViewModel>(), filteredRecords:new Array<LinkTypeViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedLinkTypeSearchComponent = Form.create({ name: 'LinkType Search' })(LinkTypeSearchComponent);

/*<Codenesium>
    <Hash>bcbcfad5408e7207d771a074869fdfdb</Hash>
</Codenesium>*/