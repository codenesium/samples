...
export default class LinkTypeSearchComponent extends React.Component<
  LinkTypeSearchComponentProps,
  LinkTypeSearchComponentState
> {
  state = {
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.LinkTypeClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedLinkTypeSearchComponent = Form.create({
  name: 'LinkType Search',
})(LinkTypeSearchComponent);


/*<Codenesium>
    <Hash>0cd81329ab995817ddab7dd17cacad08</Hash>
    <Hello>
