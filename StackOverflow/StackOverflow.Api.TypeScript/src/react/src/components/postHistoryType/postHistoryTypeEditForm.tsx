...
> {
  ...
  submit = (model: PostHistoryTypeViewModel) => {
    let mapper = new PostHistoryTypeMapper();
    axios
      .put<CreateResponse<Api.PostHistoryTypeClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.PostHistoryTypes +
          '/' +
          this.state.model!.id,
...
export const WrappedPostHistoryTypeEditComponent = Form.create({
  name: 'PostHistoryType Edit',
})(PostHistoryTypeEditComponent);
