...
export default class CommentSearchComponent extends React.Component<
  CommentSearchComponentProps,
  CommentSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<CommentViewModel>(),
    filteredRecords: new Array<CommentViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  handleDeleteClick(e: any, row: Api.CommentClientResponseModel) {
    axios
      .delete(Constants.ApiEndpoint + ApiRoutes.Comments + '/' + row.id, {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.Comments + '?limit=100';
    ...
    axios
      .get<Array<Api.CommentClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedCommentSearchComponent = Form.create({
  name: 'Comment Search',
