...
class PostTypeEditComponent extends React.Component<
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new PostTypeMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.PostTypes + '/' + this.state.model!.id,
...
/*<Codenesium>
    <Hash>0afaef693b361f8088b8ffd55525fdec</Hash>
</Codenesium>*/