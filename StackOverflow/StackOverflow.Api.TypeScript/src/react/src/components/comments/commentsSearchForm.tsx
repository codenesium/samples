...
export default class CommentsSearchComponent extends React.Component<
  CommentsSearchComponentProps,
  CommentsSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<CommentsViewModel>(),
    filteredRecords: new Array<CommentsViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.CommentsClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedCommentsSearchComponent = Form.create({
  name: 'Comments Search',
})(CommentsSearchComponent);


/*<Codenesium>
    <Hash>f82fdf0090b5edba871b3204c719f3b8</Hash>
</Codenesium>*/