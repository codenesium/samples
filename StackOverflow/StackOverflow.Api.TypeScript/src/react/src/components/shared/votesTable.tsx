...
import VotesMapper from '../votes/votesMapper';
import VotesViewModel from '../votes/votesViewModel';
import { Form, Input, Button, Spin, Alert } from 'antd';
import { WrappedFormUtils } from 'antd/es/form/Form';
import ReactTable from "react-table";

interface VotesTableComponentProps {
  id:number,
  apiRoute:string;
  history: any;
  match: any;
...
interface VotesTableComponentState {
  loading: boolean;
  loaded: boolean;
...
export class  VotesTableComponent extends React.Component<
VotesTableComponentProps,
VotesTableComponentState
> {
  state = {
    loading: false,
    loaded: true,
    ...
    axios
      ...
      .then(
        resp => {
          ...
          let votes:Array<VotesViewModel> = [];
...
/*<Codenesium>
    <Hash>5aff585a1db107e7fe171a4f50875502</Hash>
</Codenesium>*/