...
interface VoteTypesTableComponentState {
  loading: boolean;
  loaded: boolean;
...
export class VoteTypesTableComponent extends React.Component<
  VoteTypesTableComponentProps,
  VoteTypesTableComponentState
> {
  state = {
    loading: false,
    loaded: true,
  ...
  handleEditClick(e: any, row: VoteTypesViewModel) {
    this.props.history.push(ClientRoutes.VoteTypes + '/edit/' + row.id);
  }

  handleDetailClick(e: any, row: VoteTypesViewModel) {
                        ...
                        <Button
                          ...
                          onClick={(e: any) => {
                            this.handleDetailClick(
                              e,
                              row.original as VoteTypesViewModel
                            );
                          }}
                        >
