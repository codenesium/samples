...
interface TagSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class TagSelectComponent extends React.Component<
  TagSelectComponentProps,
  TagSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
    ...
    axios
      ...
      .then(
        resp => {
          ...
          let devices: Array<TagViewModel> = [];
      ...
      return (
        <div>
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map((x: TagViewModel) => {
                return (
...
/*<Codenesium>
    <Hash>de0002064dd7c6be37c93fba878ab156</Hash>
</Codenesium>*/