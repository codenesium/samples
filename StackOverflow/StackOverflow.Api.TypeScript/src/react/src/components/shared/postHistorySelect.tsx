...
interface PostHistorySelectComponentProps {
...
interface PostHistorySelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class PostHistorySelectComponent extends React.Component<
  PostHistorySelectComponentProps,
  PostHistorySelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
    ...
    axios
      ...
      .then(
        resp => {
          ...
          let devices: Array<PostHistoryViewModel> = [];
...
/*<Codenesium>
    <Hash>04553df803114d910afb83ec17c71ab4</Hash>
</Codenesium>*/