...
export default class VotesSearchComponent extends React.Component<VotesSearchComponentProps, VotesSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<VotesViewModel>(), filteredRecords:new Array<VotesViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		    let response = resp.data as Array<Api.VotesClientResponseModel>;
		   ...
		   console.log(error);
		   this.setState({records:new Array<VotesViewModel>(), filteredRecords:new Array<VotesViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
            ...
            <ReactTable 
                ...
                columns={[{
                    ...
                    columns: [
                      ...
                      accessor: 'voteTypeId',
                      Cell: (props) => {
                        return <a href='' onClick={(e) => { e.preventDefault(); this.props.history.push(ClientRoutes.VoteTypes + '/' + props.original.voteTypeId); }}>
                          {String(
...
export const WrappedVotesSearchComponent = Form.create({ name: 'Votes Search' })(VotesSearchComponent);

/*<Codenesium>
    <Hash>d52d01582e054124bdd2c7593df4c0c6</Hash>
</Codenesium>*/