...
export default class UsersSearchComponent extends React.Component<
  UsersSearchComponentProps,
  UsersSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<UsersViewModel>(),
    filteredRecords: new Array<UsersViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.UsersClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedUsersSearchComponent = Form.create({
  name: 'Users Search',
})(UsersSearchComponent);


/*<Codenesium>
    <Hash>f9c5610ee066b295c07cd3c55c6fd79c</Hash>
</Codenesium>*/