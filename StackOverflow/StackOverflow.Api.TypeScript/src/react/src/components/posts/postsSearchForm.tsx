...
export default class PostsSearchComponent extends React.Component<
  PostsSearchComponentProps,
  PostsSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<PostsViewModel>(),
    filteredRecords: new Array<PostsViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.PostsClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedPostsSearchComponent = Form.create({
  name: 'Posts Search',
})(PostsSearchComponent);


/*<Codenesium>
    <Hash>e99748ae7d21d73111c0bd53e9d0f8b7</Hash>
</Codenesium>*/