...
interface PostsCreateComponentProps {
  form: WrappedFormUtils;
  history: any;
  match: any;
}

interface PostsCreateComponentState {
...
class PostsCreateComponent extends React.Component<
  PostsCreateComponentProps,
  PostsCreateComponentState
> {
  state = {
  ...
  submit = (model: PostsViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.PostsClientRequestModel>>(
...
export const WrappedPostsCreateComponent = Form.create({
  name: 'Posts Create',
})(PostsCreateComponent);


/*<Codenesium>
    <Hash>75af9ec777b904b13b8cc3283880fbbe</Hash>
</Codenesium>*/