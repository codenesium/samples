...
export const WrappedPostHistoryTypesCreateComponent = Form.create({ name: 'PostHistoryTypes Create' })(PostHistoryTypesCreateComponent);

/*<Codenesium>
    <Hash>f20cd6ff631020f58a216e4faf724684</Hash>
</Codenesium>*/