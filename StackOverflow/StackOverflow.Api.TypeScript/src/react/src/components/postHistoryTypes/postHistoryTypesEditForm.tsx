...
> {
  ...
  componentDidMount() {
    ...
    axios
      .get<Api.PostHistoryTypesClientResponseModel>(
  ...
  submit = (model: PostHistoryTypesViewModel) => {
    let mapper = new PostHistoryTypesMapper();
    axios
      .put<CreateResponse<Api.PostHistoryTypesClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.PostHistoryTypes +
          '/' +
          this.state.model!.id,
...
export const WrappedPostHistoryTypesEditComponent = Form.create({
  name: 'PostHistoryTypes Edit',
})(PostHistoryTypesEditComponent);


/*<Codenesium>
    <Hash>5a5d85ee73c6c0ce34bdb6586539b8d8</Hash>
</Codenesium>*/