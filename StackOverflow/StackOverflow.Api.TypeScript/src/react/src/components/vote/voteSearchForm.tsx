...
export default class VoteSearchComponent extends React.Component<
  VoteSearchComponentProps,
  VoteSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<VoteViewModel>(),
    filteredRecords: new Array<VoteViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.VoteClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedVoteSearchComponent = Form.create({ name: 'Vote Search' })(
  VoteSearchComponent
);
