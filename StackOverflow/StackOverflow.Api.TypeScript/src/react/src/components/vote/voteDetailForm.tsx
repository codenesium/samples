...
const VoteDetailDisplay = (model:Props) => {
   ...
   return (
          <form  role="form">
				<button
                  ...
                  onClick={(e) => { model.history.push(ClientRoutes.Votes + '/edit/' + model.model!.id)}}
                >
                  <i className="fas fa-edit" />
                </button>
			 						 <div className="form-group row">
							<label htmlFor="bountyAmount" className={"col-sm-2 col-form-label"}>BountyAmount</label>
							<div className="col-sm-12">
								{String(model.model!.bountyAmount)}
							</div>
						</div>
					   						 <div className="form-group row">
							...
							<div className="col-sm-12">
								{String(model.model!.userId)}
					   						 ...
					   						 <div className="form-group row">
							<label htmlFor="voteTypeId" className={"col-sm-2 col-form-label"}>VoteTypeId</label>
							<div className="col-sm-12">
								{String(model.model!.voteTypeId)}
							</div>
						</div>
					             </form>
  );
  ...
  export default class VoteDetailComponent extends React.Component<VoteDetailComponentProps, VoteDetailComponentState> {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<VoteDetailDisplay history={this.props.history} model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>f539bea5ecb743b094efab71f63aa0c0</Hash>
</Codenesium>*/