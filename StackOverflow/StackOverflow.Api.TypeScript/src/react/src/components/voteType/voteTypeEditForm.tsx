...
class VoteTypeEditComponent extends React.Component<
  VoteTypeEditComponentProps,
  VoteTypeEditComponentState
> {
  state = {
  ...
  submit = (model: VoteTypeViewModel) => {
    let mapper = new VoteTypeMapper();
    axios
      .put<CreateResponse<Api.VoteTypeClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.VoteTypes +
          '/' +
          this.state.model!.id,
...
export const WrappedVoteTypeEditComponent = Form.create({
  name: 'VoteType Edit',
})(VoteTypeEditComponent);
