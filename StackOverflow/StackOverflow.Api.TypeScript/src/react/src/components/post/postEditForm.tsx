...
const PostEdit = withFormik<Props, PostViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Posts + '/' + values.id,
...
export default class PostEditComponent extends React.Component<
...
/*<Codenesium>
    <Hash>3d86649ba91167d8413959697836620a</Hash>
</Codenesium>*/