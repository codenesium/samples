...
namespace PetStoreNS.Api.Web.IntegrationTests
{
	...
	public partial class SpeciesIntegrationTests
	{
		...
		public virtual async void TestBulkInsert()
		{
			...
			var model2 = new ApiSpeciesClientRequestModel();
			model2.SetProperties("C");
			var request = new List<ApiSpeciesClientRequestModel>() {model, model2};
			CreateResponse<List<ApiSpeciesClientResponseModel>> result = await client.SpeciesBulkInsertAsync(request);

			result.Success.Should().BeTrue();
			result.Record.Should().NotBeNull();

			context.Set<Species>().ToList()[1].Name.Should().Be("B");

			context.Set<Species>().ToList()[2].Name.Should().Be("C");
		}
		...
		public virtual async void TestCreate()
		{
			...
			var model = new ApiSpeciesClientRequestModel();
			model.SetProperties("B");
			CreateResponse<ApiSpeciesClientResponseModel> result = await client.SpeciesCreateAsync(model);
		...
		public virtual async void TestGetNotFound()
		{
			...
			var client = new ApiClient(testServer.CreateClient());
			ApiSpeciesClientResponseModel response = await client.SpeciesGetAsync(default(int));
		...
		[Fact]
		public virtual async void TestForeignKeyPetsBySpeciesIdFound()
		{
			var builder = new WebHostBuilder()
			              .UseEnvironment("Production")
			              .UseStartup<TestStartup>();
			...
			var client = new ApiClient(testServer.CreateClient());
			List<ApiPetClientResponseModel> response = await client.PetsBySpeciesId(1);

			response.Should().NotBeEmpty();
		}

		[Fact]
		public virtual async void TestForeignKeyPetsBySpeciesIdNotFound()
		{
			var builder = new WebHostBuilder()
			              .UseEnvironment("Production")
			              .UseStartup<TestStartup>();
			...
			var client = new ApiClient(testServer.CreateClient());
			List<ApiPetClientResponseModel> response = await client.PetsBySpeciesId(default(int));
		...
		public virtual void TestClientCancellationToken()
		{
			Func<Task> testCancellation = async () =>
			{
				...
				tokenSource.Cancel();
				var result = await client.SpeciesAllAsync(token);
			};
...
/*<Codenesium>
    <Hash>67be0f3b7e566218331d4fe68258adec</Hash>
</Codenesium>*/