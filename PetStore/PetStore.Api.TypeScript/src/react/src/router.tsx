	...
	<Security issuer={config.oidc.issuer}
        ...
        <Switch>
		  ...
		  <Route path={ClientRoutes.Breeds + "/create"} component={wrapperHeader(WrappedBreedCreateComponent, "Breeds Create")} />
					...
					<Route path={ClientRoutes.PaymentTypes + "/create"} component={wrapperHeader(WrappedPaymentTypeCreateComponent, "Payment Types Create")} />
                      <Route path={ClientRoutes.PaymentTypes + "/edit/:id"} component={wrapperHeader(WrappedPaymentTypeEditComponent, "Payment Types Edit")} />
                      <Route path={ClientRoutes.PaymentTypes + "/:id"} component={wrapperHeader(WrappedPaymentTypeDetailComponent , "Payment Types Detail")} />
                      <Route path={ClientRoutes.PaymentTypes} component={wrapperHeader(WrappedPaymentTypeSearchComponent, "Payment Types Search")} />
					<Route path={ClientRoutes.Pens + "/create"} component={wrapperHeader(WrappedPenCreateComponent, "Pens Create")} />
                      <Route path={ClientRoutes.Pens + "/edit/:id"} component={wrapperHeader(WrappedPenEditComponent, "Pens Edit")} />
                      <Route path={ClientRoutes.Pens + "/:id"} component={wrapperHeader(WrappedPenDetailComponent , "Pens Detail")} />
                      <Route path={ClientRoutes.Pens} component={wrapperHeader(WrappedPenSearchComponent, "Pens Search")} />
...
/*<Codenesium>
    <Hash>45dc0ca7671c7ceecfe877b2d595235f</Hash>
</Codenesium>*/