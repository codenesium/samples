      ...
      >
        ...
        <Switch>
          ...
          <Route
            ...
            component={wrapperHeader(WrappedPenCreateComponent, 'Pen Create')}
          />
          <Route
            path={ClientRoutes.Pens + '/edit/:id'}
            component={wrapperHeader(WrappedPenEditComponent, 'Pen Edit')}
          />
          <Route
            path={ClientRoutes.Pens + '/:id'}
            component={wrapperHeader(WrappedPenDetailComponent, 'Pen Detail')}
          />
          <Route
            path={ClientRoutes.Pens}
            component={wrapperHeader(WrappedPenSearchComponent, 'Pen Search')}
          />
          <Route
...
/*<Codenesium>
    <Hash>da2b5cf894e57ad1aa992351c67a09e2</Hash>
</Codenesium>*/