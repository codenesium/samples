...
const PaymentTypeDetailDisplay = (model:Props) => {
   ...
   return (
          <form  role="form">
				<button
                  ...
                  onClick={(e) => { model.history.push(ClientRoutes.PaymentTypes + '/edit/' + model.model!.id)}}
                >
  ...
  export default class PaymentTypeDetailComponent extends React.Component<PaymentTypeDetailComponentProps, PaymentTypeDetailComponentState> {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<PaymentTypeDetailDisplay history={this.props.history} model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>1af9fbb6cde329bd9ed22ab40fbba358</Hash>
</Codenesium>*/