...
export const WrappedPaymentTypeCreateComponent = Form.create({ name: 'PaymentType Create' })(PaymentTypeCreateComponent);

/*<Codenesium>
    <Hash>2a0c97f1ad7d76e9b7886aff2182304a</Hash>
</Codenesium>*/