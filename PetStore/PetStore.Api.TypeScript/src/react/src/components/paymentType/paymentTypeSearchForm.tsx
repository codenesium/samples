...
export default class PaymentTypeSearchComponent extends React.Component<PaymentTypeSearchComponentProps, PaymentTypeSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<PaymentTypeViewModel>(), filteredRecords:new Array<PaymentTypeViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
