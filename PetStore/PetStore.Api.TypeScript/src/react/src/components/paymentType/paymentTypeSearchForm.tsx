...
export default class PaymentTypeSearchComponent extends React.Component<PaymentTypeSearchComponentProps, PaymentTypeSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<PaymentTypeViewModel>(), filteredRecords:new Array<PaymentTypeViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.PaymentTypeClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.PaymentTypes + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.PaymentTypes + '?limit=100';
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<PaymentTypeViewModel>(),filteredRecords:new Array<PaymentTypeViewModel>(), loading:false, loaded:false, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>5901b1a0e342f0a66af98bfa2026bc18</Hash>
</Codenesium>*/