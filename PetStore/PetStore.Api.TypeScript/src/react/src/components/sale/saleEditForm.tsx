   ...
   return (
          ...
          <form onSubmit={props.handleSubmit} role="form">
					    ...
					    <div className="col-sm-12">
                             <Field type="textbox" name="amount" className={errorExistForField("amount") ? "form-control is-invalid" : "form-control"} />
					    ...
					    <div className="col-sm-12">
							...
							<div className="form-group row">
                        <label htmlFor="name" className={errorExistForField("paymentTypeId") ? ("col-sm-2 col-form-label is-invalid") : "col-sm-2 col-form-label"}>PaymentTypeId</label>
					    <div className="col-sm-12">
                             <Field type="textbox" name="paymentTypeId" className={errorExistForField("paymentTypeId") ? "form-control is-invalid" : "form-control"} />
                            {errorExistForField("paymentTypeId") && <small className="text-danger">{errorsForField("paymentTypeId")}</small>}
                        </div>
                    </div>
							<div className="form-group row">
                        <label htmlFor="name" className={errorExistForField("petId") ? ("col-sm-2 col-form-label is-invalid") : "col-sm-2 col-form-label"}>PetId</label>
					    <div className="col-sm-12">
                             <Field type="textbox" name="petId" className={errorExistForField("petId") ? "form-control is-invalid" : "form-control"} />
                            {errorExistForField("petId") && <small className="text-danger">{errorsForField("petId")}</small>}
                        </div>
                    </div>
							<div className="form-group row">
					    ...
					    <div className="col-sm-12">
                             <Field type="textbox" name="phone" className={errorExistForField("phone") ? "form-control is-invalid" : "form-control"} />
...
const SaleEdit = withFormik<Props, SaleViewModel>({
    mapPropsToValues: props => {
		...
		response.setProperties(props.model!.amount,props.model!.firstName,props.model!.id,props.model!.lastName,props.model!.paymentTypeId,props.model!.petId,props.model!.phone);	
		return response;
      },
...
/*<Codenesium>
    <Hash>42b2fed60014dd3f112445a8f319a76d</Hash>
</Codenesium>*/