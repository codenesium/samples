...
export default class SpeciesSearchComponent extends React.Component<SpeciesSearchComponentProps, SpeciesSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<SpeciesViewModel>(), filteredRecords:new Array<SpeciesViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>526749410d9eae3899ca04b2b11ccdf8</Hash>
</Codenesium>*/