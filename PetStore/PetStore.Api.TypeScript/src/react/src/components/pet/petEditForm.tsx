   ...
   return (
          ...
          <form onSubmit={props.handleSubmit} role="form">
					    ...
					    <div className="col-sm-12">
                             <Field type="textbox" name="acquiredDate" className={errorExistForField("acquiredDate") ? "form-control is-invalid" : "form-control"} />
					    ...
					    <div className="col-sm-12">
                             <Field type="textbox" name="breedId" className={errorExistForField("breedId") ? "form-control is-invalid" : "form-control"} />
					    ...
					    <div className="col-sm-12">
                             <Field type="textbox" name="penId" className={errorExistForField("penId") ? "form-control is-invalid" : "form-control"} />
					    ...
					    <div className="col-sm-12">
                             <Field type="textbox" name="price" className={errorExistForField("price") ? "form-control is-invalid" : "form-control"} />
...
const PetEdit = withFormik<Props, PetViewModel>({
    mapPropsToValues: props => {
		...
		response.setProperties(props.model!.acquiredDate,props.model!.breedId,props.model!.description,props.model!.id,props.model!.penId,props.model!.price);	
		return response;
      },
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Pets +'/' + values.id,
  ...
  export default class PetEditComponent extends React.Component<PetEditComponentProps, PetEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Pets + '/' + this.props.match.params.id, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
...
/*<Codenesium>
    <Hash>e95b7b392e455587127ad9fbadac95cf</Hash>
</Codenesium>*/