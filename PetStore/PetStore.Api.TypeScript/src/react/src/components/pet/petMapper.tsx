...
import PetViewModel from  './petViewModel';
	...
	mapApiResponseToViewModel(dto: Api.PetClientResponseModel) : PetViewModel 
	{
		...
		response.setProperties(dto.acquiredDate,dto.breedId,dto.description,dto.id,dto.penId,dto.price);
							...
							if(dto.penIdNavigation != null)
				{
				  ...
				  dto.penIdNavigation.id,dto.penIdNavigation.name
				  );
				}
	...
	mapViewModelToApiRequest(model: PetViewModel) : Api.PetClientRequestModel
	{
		...
		response.setProperties(model.acquiredDate,model.breedId,model.description,model.id,model.penId,model.price);
		return response;
	}
};

/*<Codenesium>
    <Hash>84d904ee1f83c3b3a914fa2ba5ab0268</Hash>
</Codenesium>*/