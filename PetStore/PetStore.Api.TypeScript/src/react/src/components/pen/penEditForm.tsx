...
class PenEditComponent extends React.Component<
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new PenMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Pens + '/' + this.state.model!.id,
...
export const WrappedPenEditComponent = Form.create({ name: 'Pen Edit' })(PenEditComponent);

/*<Codenesium>
    <Hash>3b4a0a208682ad2b527617cf09ad1f9e</Hash>
</Codenesium>*/