...
> {
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.PenClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedPenSearchComponent = Form.create({ name: 'Pen Search' })(
  PenSearchComponent
);


/*<Codenesium>
    <Hash>e5aba7a9937d1d8105eaafa3ec13a974</Hash>
</Codenesium>*/