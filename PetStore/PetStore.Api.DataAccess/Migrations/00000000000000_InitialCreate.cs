...
CREATE  INDEX ""IX_Breed_speciesId"" ON ""dbo"".""Breed""
(
""speciesId"" ASC);
ALTER TABLE ""dbo"".""PaymentType""
...
ALTER TABLE ""dbo"".""Pet"" ADD CONSTRAINT ""FK_Pet_penId_Pen_id"" FOREIGN KEY(""penId"")
REFERENCES ""dbo"".""Pen"" (""id"");
ALTER TABLE ""dbo"".""Sale"" ADD CONSTRAINT ""FK_Sale_paymentTypeId_PaymentType_id"" FOREIGN KEY(""paymentTypeId"")
