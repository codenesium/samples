...
namespace PetStoreNS.Api.Web
{
	...
	public class SpeciesController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiSpeciesServerResponseModel> response = await this.SpeciesService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>38fd96fa5ac5ea8a08e1ab45fed377db</Hash>
    <Hello>
