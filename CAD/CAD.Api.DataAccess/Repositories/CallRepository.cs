...
{
	public class CallRepository : AbstractRepository, ICallRepository
	{
		...
		public virtual Task<List<Call>> All(int limit = int.MaxValue, int offset = 0, string query = "")
		{
			...
			else
			{
				return this.Where(x =>
				                  ...
				                  (x.CallString == null?false : x.CallString.StartsWith(query)) ||
...
/*<Codenesium>
    <Hash>b797e85d452bddd7a363b6fd2790e830</Hash>
    <Hello>
