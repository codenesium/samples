...
{
	public class OfficerRepository : AbstractRepository, IOfficerRepository
	{
		...
		public virtual Task<List<Officer>> All(int limit = int.MaxValue, int offset = 0, string query = "")
		{
			...
			{
				return this.Where(x =>
				                  (x.Badge == null?false : x.Badge.StartsWith(query)) ||
...
/*<Codenesium>
    <Hash>2ac988256a817e4b626a3ea8b02b8d55</Hash>
    <Hello>
