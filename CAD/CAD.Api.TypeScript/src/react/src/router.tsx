        ...
        <Switch>
          ...
          <Route
            ...
            component={wrapperHeader(
              ...
              'OfficerCapability Search'
            )}
          />
          <Route
            path={ClientRoutes.OfficerRefCapabilities + '/create'}
            component={wrapperHeader(
              WrappedOfficerRefCapabilityCreateComponent,
              'OfficerRefCapability Create'
            )}
          />
          <Route
            path={ClientRoutes.OfficerRefCapabilities + '/edit/:id'}
            component={wrapperHeader(
              WrappedOfficerRefCapabilityEditComponent,
              'OfficerRefCapability Edit'
            )}
          />
          <Route
            path={ClientRoutes.OfficerRefCapabilities + '/:id'}
            component={wrapperHeader(
              WrappedOfficerRefCapabilityDetailComponent,
              'OfficerRefCapability Detail'
            )}
          />
          <Route
            path={ClientRoutes.OfficerRefCapabilities}
            component={wrapperHeader(
              WrappedOfficerRefCapabilitySearchComponent,
              'OfficerRefCapability Search'
            )}
          />
          <Route
          ...
          <Route
            ...
            component={wrapperHeader(
              WrappedVehicleCapabilityCreateComponent,
              'VehicleCapability Create'
            )}
          />
          <Route
            path={ClientRoutes.VehicleCapabilities + '/edit/:id'}
            component={wrapperHeader(
              WrappedVehicleCapabilityEditComponent,
              'VehicleCapability Edit'
            )}
          />
          <Route
            path={ClientRoutes.VehicleCapabilities + '/:id'}
            component={wrapperHeader(
              WrappedVehicleCapabilityDetailComponent,
              'VehicleCapability Detail'
            )}
          />
          <Route
            path={ClientRoutes.VehicleCapabilities}
            component={wrapperHeader(
              WrappedVehicleCapabilitySearchComponent,
              'VehicleCapability Search'
            )}
          />
          <Route
          ...
          <Route
            ...
            component={wrapperHeader(
              ...
              'VehicleOfficer Search'
            )}
          />
          <Route
            path={ClientRoutes.VehicleRefCapabilities + '/create'}
            component={wrapperHeader(
              WrappedVehicleRefCapabilityCreateComponent,
              'VehicleRefCapability Create'
            )}
          />
          <Route
            path={ClientRoutes.VehicleRefCapabilities + '/edit/:id'}
            component={wrapperHeader(
              WrappedVehicleRefCapabilityEditComponent,
              'VehicleRefCapability Edit'
            )}
          />
          <Route
            path={ClientRoutes.VehicleRefCapabilities + '/:id'}
            component={wrapperHeader(
              WrappedVehicleRefCapabilityDetailComponent,
              'VehicleRefCapability Detail'
            )}
          />
          <Route
            path={ClientRoutes.VehicleRefCapabilities}
            component={wrapperHeader(
              WrappedVehicleRefCapabilitySearchComponent,
              'VehicleRefCapability Search'
            )}
          />
        </Switch>
      </Security>
...
/*<Codenesium>
    <Hash>9393aab869d6211caed639e647ad3191</Hash>
</Codenesium>*/