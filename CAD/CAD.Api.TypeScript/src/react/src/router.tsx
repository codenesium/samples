	...
	<Security issuer={config.oidc.issuer}
        ...
        <Switch>
		  ...
		  <Route path={ClientRoutes.Addresses + "/create"} component={wrapperHeader(WrappedAddressCreateComponent, "Address Create")} />
					...
					<Route path={ClientRoutes.CallStatus + "/create"} component={wrapperHeader(WrappedCallStatuCreateComponent, "CallStatus Create")} />
                      <Route path={ClientRoutes.CallStatus + "/edit/:id"} component={wrapperHeader(WrappedCallStatuEditComponent, "CallStatus Edit")} />
                      <Route path={ClientRoutes.CallStatus + "/:id"} component={wrapperHeader(WrappedCallStatuDetailComponent , "CallStatus Detail")} />
                      <Route path={ClientRoutes.CallStatus} component={wrapperHeader(WrappedCallStatuSearchComponent, "CallStatus Search")} />
					...
					<Route path={ClientRoutes.OfficerCapabilities + "/create"} component={wrapperHeader(WrappedOfficerCapabilitiesCreateComponent, "OfficerCapabilities Create")} />
                      <Route path={ClientRoutes.OfficerCapabilities + "/edit/:id"} component={wrapperHeader(WrappedOfficerCapabilitiesEditComponent, "OfficerCapabilities Edit")} />
                      <Route path={ClientRoutes.OfficerCapabilities + "/:id"} component={wrapperHeader(WrappedOfficerCapabilitiesDetailComponent , "OfficerCapabilities Detail")} />
                      <Route path={ClientRoutes.OfficerCapabilities} component={wrapperHeader(WrappedOfficerCapabilitiesSearchComponent, "OfficerCapabilities Search")} />
					...
					<Route path={ClientRoutes.VehicleCapabilities + "/create"} component={wrapperHeader(WrappedVehicleCapabilitiesCreateComponent, "VehicleCapabilities Create")} />
                      <Route path={ClientRoutes.VehicleCapabilities + "/edit/:id"} component={wrapperHeader(WrappedVehicleCapabilitiesEditComponent, "VehicleCapabilities Edit")} />
                      <Route path={ClientRoutes.VehicleCapabilities + "/:id"} component={wrapperHeader(WrappedVehicleCapabilitiesDetailComponent , "VehicleCapabilities Detail")} />
                      <Route path={ClientRoutes.VehicleCapabilities} component={wrapperHeader(WrappedVehicleCapabilitiesSearchComponent, "VehicleCapabilities Search")} />
					        </Switch>
	  </Security>
    </BrowserRouter>
  );
...
/*<Codenesium>
    <Hash>1d5afca1a3806c981ff0e00b13b3c455</Hash>
</Codenesium>*/