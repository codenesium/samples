...
export default class CallSearchComponent extends React.Component<CallSearchComponentProps, CallSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<CallViewModel>(), filteredRecords:new Array<CallViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.CallClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.Calls + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<CallViewModel>(), filteredRecords:new Array<CallViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedCallSearchComponent = Form.create({ name: 'Call Search' })(CallSearchComponent);

/*<Codenesium>
    <Hash>e10135a1980fcf039071ccd52143575e</Hash>
</Codenesium>*/