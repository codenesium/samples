...
export default class UnitSearchComponent extends React.Component<
  UnitSearchComponentProps,
  UnitSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<UnitViewModel>(),
    filteredRecords: new Array<UnitViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  handleDeleteClick(e: any, row: Api.UnitClientResponseModel) {
    axios
      .delete(Constants.ApiEndpoint + ApiRoutes.Units + '/' + row.id, {
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.UnitClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedUnitSearchComponent = Form.create({ name: 'Unit Search' })(
  UnitSearchComponent
);
