...
> {
  ...
  submit = (model: UnitViewModel) => {
    let mapper = new UnitMapper();
    axios
      .put<CreateResponse<Api.UnitClientRequestModel>>(
...
export const WrappedUnitEditComponent = Form.create({ name: 'Unit Edit' })(
  UnitEditComponent
);


/*<Codenesium>
    <Hash>d8c2612b58272d4128c6a5202ad3de60</Hash>
</Codenesium>*/