...
interface VehicleCapabilittyEditComponentProps {
  form: WrappedFormUtils;
  history: any;
  match: any;
}

interface VehicleCapabilittyEditComponentState {
...
class VehicleCapabilittyEditComponent extends React.Component<
  VehicleCapabilittyEditComponentProps,
  VehicleCapabilittyEditComponentState
> {
  state = {
  ...
  submit = (model: VehicleCapabilittyViewModel) => {
    let mapper = new VehicleCapabilittyMapper();
    axios
      .put<CreateResponse<Api.VehicleCapabilittyClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.VehicleCapabilities +
          '/' +
...
export const WrappedVehicleCapabilittyEditComponent = Form.create({
  name: 'VehicleCapabilitty Edit',
})(VehicleCapabilittyEditComponent);


/*<Codenesium>
    <Hash>bccbc6170ae8c52aadbdf2c3cdf50a5a</Hash>
</Codenesium>*/