...
export const WrappedOfficerCapabilityCreateComponent = Form.create({
  name: 'OfficerCapability Create',
})(OfficerCapabilityCreateComponent);


/*<Codenesium>
    <Hash>18ca0532232db21a6bd0132b6341a078</Hash>
</Codenesium>*/