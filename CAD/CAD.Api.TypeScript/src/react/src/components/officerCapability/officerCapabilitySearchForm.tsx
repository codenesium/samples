...
export default class OfficerCapabilitySearchComponent extends React.Component<
  OfficerCapabilitySearchComponentProps,
  OfficerCapabilitySearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<OfficerCapabilityViewModel>(),
    filteredRecords: new Array<OfficerCapabilityViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.OfficerCapabilityClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedOfficerCapabilitySearchComponent = Form.create({
  name: 'OfficerCapability Search',
})(OfficerCapabilitySearchComponent);


/*<Codenesium>
    <Hash>8de7e4bab078c3c4e1ec25305f7bbd2d</Hash>
</Codenesium>*/