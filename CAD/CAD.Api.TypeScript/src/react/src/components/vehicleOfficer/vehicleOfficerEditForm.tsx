...
> {
  ...
  submit = (model: VehicleOfficerViewModel) => {
    let mapper = new VehicleOfficerMapper();
    axios
      .put<CreateResponse<Api.VehicleOfficerClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.VehicleOfficers +
          '/' +
          this.state.model!.id,
...
export const WrappedVehicleOfficerEditComponent = Form.create({
  name: 'VehicleOfficer Edit',
})(VehicleOfficerEditComponent);


/*<Codenesium>
    <Hash>44282e6a1da6fddaf8921ce553f66e34</Hash>
    <Hello>
