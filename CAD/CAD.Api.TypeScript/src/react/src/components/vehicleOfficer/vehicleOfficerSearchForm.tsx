...
export default class VehicleOfficerSearchComponent extends React.Component<VehicleOfficerSearchComponentProps, VehicleOfficerSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<VehicleOfficerViewModel>(), filteredRecords:new Array<VehicleOfficerViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.VehicleOfficerClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.VehicleOfficers + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.VehicleOfficers + '?limit=100';
	   ...
	   .then(resp => {
		    let response = resp.data as Array<Api.VehicleOfficerClientResponseModel>;
		   ...
		   console.log(error);
		   this.setState({records:new Array<VehicleOfficerViewModel>(), filteredRecords:new Array<VehicleOfficerViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedVehicleOfficerSearchComponent = Form.create({ name: 'VehicleOfficer Search' })(VehicleOfficerSearchComponent);

/*<Codenesium>
    <Hash>f92ce7900069bf13056d278417611c26</Hash>
</Codenesium>*/