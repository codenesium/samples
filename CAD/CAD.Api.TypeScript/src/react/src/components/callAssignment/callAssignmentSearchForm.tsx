...
export default class CallAssignmentSearchComponent extends React.Component<CallAssignmentSearchComponentProps, CallAssignmentSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<CallAssignmentViewModel>(), filteredRecords:new Array<CallAssignmentViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.CallAssignmentClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.CallAssignments + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.CallAssignments + '?limit=100';
	   ...
	   .then(resp => {
		    let response = resp.data as Array<Api.CallAssignmentClientResponseModel>;
		   ...
		   console.log(error);
		   this.setState({records:new Array<CallAssignmentViewModel>(), filteredRecords:new Array<CallAssignmentViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedCallAssignmentSearchComponent = Form.create({ name: 'CallAssignment Search' })(CallAssignmentSearchComponent);

/*<Codenesium>
    <Hash>0c369b49084a67c95f42094486568833</Hash>
</Codenesium>*/