...
> {
  ...
  submit = (model: UnitDispositionViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.UnitDispositionClientRequestModel>>(
...
export const WrappedUnitDispositionCreateComponent = Form.create({
  name: 'UnitDisposition Create',
})(UnitDispositionCreateComponent);


/*<Codenesium>
    <Hash>742faf415f5c891effaa18042558b5c0</Hash>
    <Hello>
