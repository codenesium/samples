...
import NoteViewModel from  './noteViewModel';
	...
	mapApiResponseToViewModel(dto: Api.NoteClientResponseModel) : NoteViewModel 
	{
		...
		response.setProperties(dto.callId,dto.dateCreated,dto.id,dto.noteText,dto.officerId);
	...
	mapViewModelToApiRequest(model: NoteViewModel) : Api.NoteClientRequestModel
	{
		...
		response.setProperties(model.callId,model.dateCreated,model.id,model.noteText,model.officerId);
		return response;
	}
};

/*<Codenesium>
    <Hash>a26b290543d2c6c6261cd45e3fa1d1bb</Hash>
</Codenesium>*/