...
export default class VehicleRefCapabilitySearchComponent extends React.Component<VehicleRefCapabilitySearchComponentProps, VehicleRefCapabilitySearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<VehicleRefCapabilityViewModel>(), filteredRecords:new Array<VehicleRefCapabilityViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.VehicleRefCapabilityClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.VehicleRefCapabilities + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.VehicleRefCapabilities + '?limit=100';
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<VehicleRefCapabilityViewModel>(), filteredRecords:new Array<VehicleRefCapabilityViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedVehicleRefCapabilitySearchComponent = Form.create({ name: 'VehicleRefCapability Search' })(VehicleRefCapabilitySearchComponent);

/*<Codenesium>
    <Hash>28a462075ea12cfece4cd056735d5a26</Hash>
</Codenesium>*/