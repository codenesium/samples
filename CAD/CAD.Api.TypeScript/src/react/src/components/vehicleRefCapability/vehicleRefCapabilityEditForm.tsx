...
export const WrappedVehicleRefCapabilityEditComponent = Form.create({
  name: 'VehicleRefCapability Edit',
})(VehicleRefCapabilityEditComponent);


/*<Codenesium>
    <Hash>0b9353a36c1755362abd39e3c350968c</Hash>
</Codenesium>*/