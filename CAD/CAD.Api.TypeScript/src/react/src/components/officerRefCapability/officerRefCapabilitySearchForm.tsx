...
export default class OfficerRefCapabilitySearchComponent extends React.Component<
  OfficerRefCapabilitySearchComponentProps,
  OfficerRefCapabilitySearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<OfficerRefCapabilityViewModel>(),
    filteredRecords: new Array<OfficerRefCapabilityViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  handleDeleteClick(e: any, row: Api.OfficerRefCapabilityClientResponseModel) {
    axios
      .delete(
        Constants.ApiEndpoint + ApiRoutes.OfficerRefCapabilities + '/' + row.id,
        {
          headers: {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.OfficerRefCapabilities + '?limit=100';
...
export const WrappedOfficerRefCapabilitySearchComponent = Form.create({
  name: 'OfficerRefCapability Search',
})(OfficerRefCapabilitySearchComponent);


/*<Codenesium>
    <Hash>50dbc21f919b53eebc3f5893ee42f53b</Hash>
</Codenesium>*/