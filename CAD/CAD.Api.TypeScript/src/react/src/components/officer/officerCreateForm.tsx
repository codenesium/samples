...
> {
  ...
  submit = (model: OfficerViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.OfficerClientRequestModel>>(
...
export const WrappedOfficerCreateComponent = Form.create({
  name: 'Officer Create',
})(OfficerCreateComponent);


/*<Codenesium>
    <Hash>01504064360c5bb64b0f3fd25f1ed7ff</Hash>
    <Hello>
