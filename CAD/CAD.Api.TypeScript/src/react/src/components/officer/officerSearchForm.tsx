...
export default class OfficerSearchComponent extends React.Component<
  OfficerSearchComponentProps,
  OfficerSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<OfficerViewModel>(),
    filteredRecords: new Array<OfficerViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  handleDeleteClick(e: any, row: Api.OfficerClientResponseModel) {
    axios
      .delete(Constants.ApiEndpoint + ApiRoutes.Officers + '/' + row.id, {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.Officers + '?limit=100';
    ...
    axios
      .get<Array<Api.OfficerClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedOfficerSearchComponent = Form.create({
  name: 'Officer Search',
