...
export default class OfficerCapabilitiesSearchComponent extends React.Component<OfficerCapabilitiesSearchComponentProps, OfficerCapabilitiesSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<OfficerCapabilitiesViewModel>(), filteredRecords:new Array<OfficerCapabilitiesViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleEditClick(e:any, row:OfficerCapabilitiesViewModel) {
         this.props.history.push(ClientRoutes.OfficerCapabilities + '/edit/' + row.capabilityId);
    }

    handleDetailClick(e:any, row:OfficerCapabilitiesViewModel) {
         this.props.history.push(ClientRoutes.OfficerCapabilities + '/' + row.capabilityId);
    }
    ...
    handleDeleteClick(e:any, row:Api.OfficerCapabilitiesClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.OfficerCapabilities + '/' + row.capabilityId,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<OfficerCapabilitiesViewModel>(), filteredRecords:new Array<OfficerCapabilitiesViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedOfficerCapabilitiesSearchComponent = Form.create({ name: 'OfficerCapabilities Search' })(OfficerCapabilitiesSearchComponent);

/*<Codenesium>
    <Hash>7f33514c5449210d4f3af4f715036495</Hash>
</Codenesium>*/