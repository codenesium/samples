...
> {
  ...
  handleDeleteClick(e: any, row: Api.OfficerCapabilitiesClientResponseModel) {
    axios
      .delete(
        Constants.ApiEndpoint + ApiRoutes.OfficerCapabilities + '/' + row.id,
        {
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.OfficerCapabilitiesClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
/*<Codenesium>
    <Hash>b69e1b876e2af404c875e8c1bc9bf5de</Hash>
    <Hello>
