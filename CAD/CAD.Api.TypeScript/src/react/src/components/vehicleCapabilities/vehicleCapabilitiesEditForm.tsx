...
> {
  ...
  componentDidMount() {
    ...
    axios
      .get<Api.VehicleCapabilitiesClientResponseModel>(
  ...
  submit = (model: VehicleCapabilitiesViewModel) => {
    let mapper = new VehicleCapabilitiesMapper();
    axios
      .put<CreateResponse<Api.VehicleCapabilitiesClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.VehicleCapabilities +
          '/' +
          this.state.model!.id,
...
export const WrappedVehicleCapabilitiesEditComponent = Form.create({
  name: 'VehicleCapabilities Edit',
})(VehicleCapabilitiesEditComponent);


/*<Codenesium>
    <Hash>7d4f7600dad7506be7a9341ab70ad96a</Hash>
    <Hello>
