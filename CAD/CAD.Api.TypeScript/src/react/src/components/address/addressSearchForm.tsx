...
export default class AddressSearchComponent extends React.Component<AddressSearchComponentProps, AddressSearchComponentState> {
    ...
    handleDeleteClick(e:any, row:Api.AddressClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.Addresses + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<AddressViewModel>(), filteredRecords:new Array<AddressViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>d4bf3215e1256e611afba9371d39323e</Hash>
</Codenesium>*/