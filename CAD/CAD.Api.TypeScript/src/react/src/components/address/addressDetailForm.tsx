...
> {
  ...
  handleEditClick(e:any) {
    this.props.history.push(ClientRoutes.Addresses + '/edit/' + this.state.model!.id);
  }
      ...
      return (
		...
		<Button 
		 ...
		 <div>
			...
			apiRoute={Constants.ApiEndpoint + ApiRoutes.Addresses + '/' + this.state.model!.id + '/' + ApiRoutes.Calls}
			/>
         </div>
...
/*<Codenesium>
    <Hash>9d8a7db752996deba43fe6f4118b610c</Hash>
</Codenesium>*/