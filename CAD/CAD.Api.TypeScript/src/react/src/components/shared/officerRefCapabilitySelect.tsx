...
interface OfficerRefCapabilitySelectComponentProps {
...
interface OfficerRefCapabilitySelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class OfficerRefCapabilitySelectComponent extends React.Component<
  OfficerRefCapabilitySelectComponentProps,
  OfficerRefCapabilitySelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
    ...
    axios
      ...
      .then(
        resp => {
          ...
          let devices: Array<OfficerRefCapabilityViewModel> = [];
          ...
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map(
                (x: OfficerRefCapabilityViewModel) => {
                  return (
...
/*<Codenesium>
    <Hash>f9311caff4d26874bb0b42fbd1f72087</Hash>
</Codenesium>*/