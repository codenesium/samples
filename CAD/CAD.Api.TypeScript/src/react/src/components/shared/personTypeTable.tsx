...
interface PersonTypeTableComponentState {
  loading: boolean;
  loaded: boolean;
...
> {
  ...
  loadRecords() {
    ...
    axios
      .get<Array<Api.PersonTypeClientResponseModel>>(this.props.apiRoute, {
...
/*<Codenesium>
    <Hash>3ae3839043a5988528743562d8e103f7</Hash>
</Codenesium>*/