    ...
    if (this.state.loading) {
      ...
      return (
        <div>
        {
          ...
          <Select>
          {
            this.state.filteredRecords.map((x:OfficerCapabilitiesViewModel) =>
            {
                return <Select.Option value={x.capabilityId}>{x.toDisplay()}</Select.Option>;
            })
          }
          </Select>
        )
...
/*<Codenesium>
    <Hash>3c28c1d67752f49053618547b6c056ec</Hash>
</Codenesium>*/