...
import CallPersonViewModel from  './callPersonViewModel';
	...
	mapApiResponseToViewModel(dto: Api.CallPersonClientResponseModel) : CallPersonViewModel 
	{
		...
		response.setProperties(dto.id,dto.note,dto.personId,dto.personTypeId);
						...
						if(dto.personIdNavigation != null)
				{
				  ...
				  dto.personIdNavigation.firstName,dto.personIdNavigation.id,dto.personIdNavigation.lastName,dto.personIdNavigation.phone,dto.personIdNavigation.ssn
				  );
				}
							if(dto.personTypeIdNavigation != null)
				{
				  ...
				  dto.personTypeIdNavigation.id,dto.personTypeIdNavigation.name
				  );
				}
	...
	mapViewModelToApiRequest(model: CallPersonViewModel) : Api.CallPersonClientRequestModel
	{
		let response = new Api.CallPersonClientRequestModel();
		response.setProperties(model.id,model.note,model.personId,model.personTypeId);
		return response;
	}
};

/*<Codenesium>
    <Hash>213f7b3bb809af5e0c408e64cbd2712e</Hash>
</Codenesium>*/