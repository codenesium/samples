...
export const WrappedVehicleCapabilityCreateComponent = Form.create({
  name: 'VehicleCapability Create',
})(VehicleCapabilityCreateComponent);


/*<Codenesium>
    <Hash>7274dcf8b50d6eea69c018bc9e08b342</Hash>
</Codenesium>*/