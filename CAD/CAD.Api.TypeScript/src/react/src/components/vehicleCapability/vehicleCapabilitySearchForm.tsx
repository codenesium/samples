...
export default class VehicleCapabilitySearchComponent extends React.Component<
  VehicleCapabilitySearchComponentProps,
  VehicleCapabilitySearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<VehicleCapabilityViewModel>(),
    filteredRecords: new Array<VehicleCapabilityViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
...
export const WrappedVehicleCapabilitySearchComponent = Form.create({
  name: 'VehicleCapability Search',
})(VehicleCapabilitySearchComponent);


/*<Codenesium>
    <Hash>551c900f3111d4832bcffddab743a3fc</Hash>
</Codenesium>*/