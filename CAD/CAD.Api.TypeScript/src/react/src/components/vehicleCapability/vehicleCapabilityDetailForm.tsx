...
> {
  ...
  handleEditClick(e:any) {
    this.props.history.push(ClientRoutes.VehicleCapabilities + '/edit/' + this.state.model!.id);
  }
      ...
      return (
		...
		<Button 
		 ...
		 <div>
			...
			apiRoute={Constants.ApiEndpoint + ApiRoutes.VehicleCapabilities + '/' + this.state.model!.id + '/' + ApiRoutes.VehicleRefCapabilities}
			/>
         </div>
...
export const WrappedVehicleCapabilityDetailComponent = Form.create({ name: 'VehicleCapability Detail' })(
  VehicleCapabilityDetailComponent
);

/*<Codenesium>
    <Hash>95aff8178ab4f8bf8d4083ea03a4c259</Hash>
</Codenesium>*/