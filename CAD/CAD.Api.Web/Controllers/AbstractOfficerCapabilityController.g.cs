...
namespace CADNS.Api.Web
{
	public abstract class AbstractOfficerCapabilityController : AbstractApiController
	{
		...
		[HttpGet]
		[Route("{capabilityId}/OfficerRefCapabilities")]
		[ReadOnly]
		[ProducesResponseType(typeof(List<ApiOfficerRefCapabilityServerResponseModel>), 200)]
		public async virtual Task<IActionResult> OfficerRefCapabilitiesByCapabilityId(int capabilityId, int? limit, int? offset)
		{
			...
			List<ApiOfficerRefCapabilityServerResponseModel> response = await this.OfficerCapabilityService.OfficerRefCapabilitiesByCapabilityId(capabilityId, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>f2ed9cdce4b3f3a980fc319fe16f1536</Hash>
</Codenesium>*/