	...
	public partial class TeacherTeacherSkillIntegrationTests
	{
		...
		public virtual async void TestByTeacherIdFound()
		{
			...
			client.SetBearerToken(jwtHelper.GenerateBearerToken(
									  ...
									  "test@test.com",
									  "Passw0rd$"));
			List<ApiTeacherTeacherSkillClientResponseModel> response = await client.ByTeacherTeacherSkillByTeacherId(1);
		...
		public virtual async void TestByTeacherIdNotFound()
		{
			...
			client.SetBearerToken(jwtHelper.GenerateBearerToken(
									  ...
									  "test@test.com",
									  "Passw0rd$"));
			List<ApiTeacherTeacherSkillClientResponseModel> response = await client.ByTeacherTeacherSkillByTeacherId(default(int));
		...
		public virtual async void TestByTeacherSkillIdFound()
		{
			...
			client.SetBearerToken(jwtHelper.GenerateBearerToken(
									  ...
									  "test@test.com",
									  "Passw0rd$"));
			List<ApiTeacherTeacherSkillClientResponseModel> response = await client.ByTeacherTeacherSkillByTeacherSkillId(1);
		...
		public virtual async void TestByTeacherSkillIdNotFound()
		{
			...
			client.SetBearerToken(jwtHelper.GenerateBearerToken(
									  ...
									  "test@test.com",
									  "Passw0rd$"));
			List<ApiTeacherTeacherSkillClientResponseModel> response = await client.ByTeacherTeacherSkillByTeacherSkillId(default(int));
...
/*<Codenesium>
    <Hash>fb6a264488f3b76d167ced943c293f6a</Hash>
</Codenesium>*/