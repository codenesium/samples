...
namespace StudioResourceManagerNS.Api.Web
{
	public abstract class AbstractEventTeacherController : AbstractApiController
	{
		...
		[ReadOnly]
		[ProducesResponseType(typeof(List<ApiEventTeacherServerResponseModel>), 200)]
		public async virtual Task<IActionResult> ById(int id, int? limit, int? offset)
		{
			...
			List<ApiEventTeacherServerResponseModel> response = await this.EventTeacherService.ById(id, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>0c196ef04ad45edee71a73fe229d5baf</Hash>
</Codenesium>*/