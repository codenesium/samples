...
namespace StudioResourceManagerNS.Api.Web
{
	public abstract class AbstractEventStudentController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> ByEventId(int eventId, int? limit, int? offset)
		{
			...
			List<ApiEventStudentServerResponseModel> response = await this.EventStudentService.ByEventId(eventId, query.Limit, query.Offset);
		...
		public async virtual Task<IActionResult> ByStudentId(int studentId, int? limit, int? offset)
		{
			...
			List<ApiEventStudentServerResponseModel> response = await this.EventStudentService.ByStudentId(studentId, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>e25db3426c4932a3e72cee686b2b7f8c</Hash>
</Codenesium>*/