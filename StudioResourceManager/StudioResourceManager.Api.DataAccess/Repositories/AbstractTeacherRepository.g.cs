...
namespace StudioResourceManagerNS.Api.DataAccess
{
	public abstract class AbstractTeacherRepository : AbstractRepository
	{
		...
		public async Task<List<Teacher>> ByUserId(int userId, int limit = int.MaxValue, int offset = 0)
		{
		...
		public async virtual Task<List<TeacherTeacherSkill>> TeacherTeacherSkills(int teacherId, int limit = int.MaxValue, int offset = 0)
		{
...
/*<Codenesium>
    <Hash>30bda5cb0dbbbf73cae543dc904b01a4</Hash>
</Codenesium>*/