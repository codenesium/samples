...
export const WrappedEventStatusCreateComponent = Form.create({ name: 'EventStatus Create' })(EventStatusCreateComponent);

/*<Codenesium>
    <Hash>fed1ae51636c3ae94658d28dcace5156</Hash>
</Codenesium>*/