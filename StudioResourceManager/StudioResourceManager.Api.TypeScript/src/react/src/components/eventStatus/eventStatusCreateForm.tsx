...
const EventStatusCreateDisplay: React.SFC<FormikProps<EventStatusViewModel>> = (
  props: FormikProps<EventStatusViewModel>
) => {
...
const EventStatusCreate = withFormik<Props, EventStatusViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .post(
        Constants.ApiEndpoint + ApiRoutes.EventStatus,
...
export default class EventStatusCreateComponent extends React.Component<
  EventStatusCreateComponentProps,
  EventStatusCreateComponentState
> {
  state = {
    model: undefined,
    loading: false,
...
/*<Codenesium>
    <Hash>cb61235ed118ed81c4f4d7c8b9222042</Hash>
</Codenesium>*/