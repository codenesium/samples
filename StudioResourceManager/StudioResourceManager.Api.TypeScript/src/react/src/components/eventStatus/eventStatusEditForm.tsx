...
> {
  ...
  submit = (model: EventStatusViewModel) => {
    let mapper = new EventStatusMapper();
    axios
      .put<CreateResponse<Api.EventStatusClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.EventStatus +
          '/' +
          this.state.model!.id,
...
export const WrappedEventStatusEditComponent = Form.create({
  name: 'EventStatus Edit',
})(EventStatusEditComponent);


/*<Codenesium>
    <Hash>588eecc60ff9fedd9d9b6750b4fbb51c</Hash>
</Codenesium>*/