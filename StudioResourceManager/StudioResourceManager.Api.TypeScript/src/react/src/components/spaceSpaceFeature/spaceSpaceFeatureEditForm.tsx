...
interface SpaceSpaceFeatureEditComponentProps {
  form: WrappedFormUtils;
  history: any;
  match: any;
}

interface SpaceSpaceFeatureEditComponentState {
...
class SpaceSpaceFeatureEditComponent extends React.Component<
  SpaceSpaceFeatureEditComponentProps,
  SpaceSpaceFeatureEditComponentState
> {
  state = {
  ...
  submit = (model: SpaceSpaceFeatureViewModel) => {
    let mapper = new SpaceSpaceFeatureMapper();
    axios
      .put<CreateResponse<Api.SpaceSpaceFeatureClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.SpaceSpaceFeatures +
          '/' +
          this.state.model!.id,
...
export const WrappedSpaceSpaceFeatureEditComponent = Form.create({
  name: 'SpaceSpaceFeature Edit',
})(SpaceSpaceFeatureEditComponent);


/*<Codenesium>
    <Hash>2eac75ff44d848e5e9659ae4060b751c</Hash>
</Codenesium>*/