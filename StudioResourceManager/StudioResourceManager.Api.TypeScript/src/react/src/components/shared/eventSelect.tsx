...
interface EventSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class EventSelectComponent extends React.Component<
  EventSelectComponentProps,
  EventSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(response => {
        ...
        let devices: Array<EventViewModel> = [];
  ...
  render() {
    ...
    if (this.state.loading) {
      ...
      return (
        <Form.Item>
          <label htmlFor={this.props.propertyName}>Events</label>
          <br />
...
/*<Codenesium>
    <Hash>d2f27de56c42f63cd45f568edb58bbe7</Hash>
</Codenesium>*/