...
interface SpaceFeatureTableComponentState {
  loading: boolean;
  loaded: boolean;
...
export class  SpaceFeatureTableComponent extends React.Component<
SpaceFeatureTableComponentProps,
SpaceFeatureTableComponentState
> {
  state = {
    loading: false,
    loaded: true,
...
/*<Codenesium>
    <Hash>28aa7532100a3635eb635a90da42d999</Hash>
</Codenesium>*/