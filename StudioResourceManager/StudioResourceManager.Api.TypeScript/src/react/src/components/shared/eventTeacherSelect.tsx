...
interface EventTeacherSelectComponentProps {
...
interface EventTeacherSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class EventTeacherSelectComponent extends React.Component<
  EventTeacherSelectComponentProps,
  EventTeacherSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(response => {
        ...
        let devices: Array<EventTeacherViewModel> = [];
  ...
  render() {
    ...
    if (this.state.loading) {
      ...
      return (
        <Form.Item>
          <label htmlFor={this.props.propertyName}>Event Teacher</label>
          <br />
...
/*<Codenesium>
    <Hash>b34df1278e012616d9d815174f137903</Hash>
</Codenesium>*/