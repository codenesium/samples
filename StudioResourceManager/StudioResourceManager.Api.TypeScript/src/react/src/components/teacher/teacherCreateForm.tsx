...
const TeacherCreate = withFormik<Props, TeacherViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.Teachers,
  ...
  export default class TeacherCreateComponent extends React.Component<TeacherCreateComponentProps, TeacherCreateComponentState> {
...
/*<Codenesium>
    <Hash>ef88722970f7174c3e3d0b8fa3f72cde</Hash>
</Codenesium>*/