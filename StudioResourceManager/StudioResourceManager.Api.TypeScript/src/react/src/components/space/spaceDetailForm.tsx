  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(ClientRoutes.Spaces + '/edit/' + model.model!.id);
        }}
      >
...
export default class SpaceDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>0baf4b0710b54d96a29614f8cae9e2ef</Hash>
</Codenesium>*/