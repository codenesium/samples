...
interface Props {
   ...
   return (<form onSubmit={props.handleSubmit} role="form">            
						...
						<div className="form-group row">
                        <label htmlFor="name" className={errorExistForField("emailRemindersEnabled") ? ("col-sm-2 col-form-label is-invalid") : "col-sm-2 col-form-label"}>Email Reminders Enabled</label>
					    <div className="col-sm-12">
                             <Field type="checkbox" checked={props.values.emailRemindersEnabled} name="emailRemindersEnabled" className={errorExistForField("emailRemindersEnabled") ? "form-control is-invalid" : "form-control"} />
					    ...
					    <div className="col-sm-12">
                             <Field type="number" name="familyId" className={errorExistForField("familyId") ? "form-control is-invalid" : "form-control"} />
                            {errorExistForField("familyId") && <small className="text-danger">{errorsForField("familyId")}</small>}
                        </div>
                    </div>

						<div className="form-group row">
                        <label htmlFor="name" className={errorExistForField("firstName") ? ("col-sm-2 col-form-label is-invalid") : "col-sm-2 col-form-label"}>First Name</label>
					    <div className="col-sm-12">
						...
						<div className="form-group row">
                        <label htmlFor="name" className={errorExistForField("isAdult") ? ("col-sm-2 col-form-label is-invalid") : "col-sm-2 col-form-label"}>Is Adult</label>
					    <div className="col-sm-12">
                             <Field type="checkbox" checked={props.values.isAdult} name="isAdult" className={errorExistForField("isAdult") ? "form-control is-invalid" : "form-control"} />
                            {errorExistForField("isAdult") && <small className="text-danger">{errorsForField("isAdult")}</small>}
                        </div>
                    </div>

						<div className="form-group row">
                        <label htmlFor="name" className={errorExistForField("lastName") ? ("col-sm-2 col-form-label is-invalid") : "col-sm-2 col-form-label"}>Last Name</label>
					    <div className="col-sm-12">
						...
						<div className="form-group row">
                        <label htmlFor="name" className={errorExistForField("smsRemindersEnabled") ? ("col-sm-2 col-form-label is-invalid") : "col-sm-2 col-form-label"}>SMS Reminders Enabled</label>
					    <div className="col-sm-12">
                             <Field type="checkbox" checked={props.values.smsRemindersEnabled} name="smsRemindersEnabled" className={errorExistForField("smsRemindersEnabled") ? "form-control is-invalid" : "form-control"} />
					    ...
					    <div className="col-sm-12">
                             <Field type="number" name="userId" className={errorExistForField("userId") ? "form-control is-invalid" : "form-control"} />
...
const StudentCreate = withFormik<Props, StudentViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.Students,
  ...
  export default class StudentCreateComponent extends React.Component<StudentCreateComponentProps, StudentCreateComponentState> {
...
/*<Codenesium>
    <Hash>855b0f00494100004cd9865c21705086</Hash>
</Codenesium>*/