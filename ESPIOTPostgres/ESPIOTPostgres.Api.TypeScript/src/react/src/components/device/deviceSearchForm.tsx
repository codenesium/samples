...
export default class DeviceSearchComponent extends React.Component<DeviceSearchComponentProps, DeviceSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<DeviceViewModel>(), filteredRecords:new Array<DeviceViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>e129fae8990cc51a5e37e3140ed3288a</Hash>
</Codenesium>*/