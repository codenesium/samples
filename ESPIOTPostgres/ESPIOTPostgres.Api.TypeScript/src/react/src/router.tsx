	...
	<Security issuer={config.oidc.issuer}
        ...
        <Switch>
		  ...
		  <Route path={ClientRoutes.Devices + "/create"} component={wrapperHeader(WrappedDeviceCreateComponent, "Device Create")} />
					...
					<Route path={ClientRoutes.DeviceActions + "/create"} component={wrapperHeader(WrappedDeviceActionCreateComponent, "DeviceAction Create")} />
                      <Route path={ClientRoutes.DeviceActions + "/edit/:id"} component={wrapperHeader(WrappedDeviceActionEditComponent, "DeviceAction Edit")} />
                      <Route path={ClientRoutes.DeviceActions + "/:id"} component={wrapperHeader(WrappedDeviceActionDetailComponent , "DeviceAction Detail")} />
                      <Route path={ClientRoutes.DeviceActions} component={wrapperHeader(WrappedDeviceActionSearchComponent, "DeviceAction Search")} />
					        </Switch>
	  </Security>
    </BrowserRouter>
  );
...
/*<Codenesium>
    <Hash>350217733eae3c3d5b105666bc7673ad</Hash>
</Codenesium>*/