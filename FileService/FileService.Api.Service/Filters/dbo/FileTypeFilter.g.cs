...
namespace FileServiceNS.Api.Service
{
	...
	{
		IFileTypeModelValidator validator { get; set; }

		public FileTypeFilter(IFileTypeModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<FileTypeModel>().ToList();
...
/*<Codenesium>
    <Hash>dcca701d675056d9e8766522a697562e</Hash>
</Codenesium>*/