...
namespace FileServiceNS.Api.Service
{
	...
	{
		IFileModelValidator validator { get; set; }

		public FileFilter(IFileModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<FileModel>().ToList();
...
/*<Codenesium>
    <Hash>9e7fcaa6e4121967658275dffd6537be</Hash>
</Codenesium>*/