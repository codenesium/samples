      ...
      >
        ...
        <Switch>
          ...
          <Route
            ...
            component={wrapperHeader(WrappedBucketEditComponent, 'Bucket Edit')}
          />
          <Route
          ...
          <Route
            ...
            component={wrapperHeader(WrappedFileCreateComponent, 'File Create')}
          />
          <Route
            path={ClientRoutes.Files + '/edit/:id'}
            component={wrapperHeader(WrappedFileEditComponent, 'File Edit')}
          />
          <Route
            path={ClientRoutes.Files + '/:id'}
            component={wrapperHeader(WrappedFileDetailComponent, 'File Detail')}
          />
          <Route
            path={ClientRoutes.Files}
            component={wrapperHeader(WrappedFileSearchComponent, 'File Search')}
          />
          <Route
...
/*<Codenesium>
    <Hash>14bf090beefa49120341fd95a2aadbad</Hash>
</Codenesium>*/