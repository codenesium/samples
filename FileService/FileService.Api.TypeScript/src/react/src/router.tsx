  ...
  return (
	...
	<Security issuer={config.oidc.issuer}
        ...
        <Switch>
		  ...
		  <Route path={ClientRoutes.Buckets + "/create"} component={wrapperHeader(WrappedBucketCreateComponent)} />
                      <Route path={ClientRoutes.Buckets + "/edit/:id"} component={wrapperHeader(WrappedBucketEditComponent)} />
                      <Route path={ClientRoutes.Buckets + "/:id"} component={wrapperHeader(WrappedBucketDetailComponent)} />
                      <Route path={ClientRoutes.Buckets} component={wrapperHeader(WrappedBucketSearchComponent)} />
					<Route path={ClientRoutes.Files + "/create"} component={wrapperHeader(WrappedFileCreateComponent)} />
                      <Route path={ClientRoutes.Files + "/edit/:id"} component={wrapperHeader(WrappedFileEditComponent)} />
                      <Route path={ClientRoutes.Files + "/:id"} component={wrapperHeader(WrappedFileDetailComponent)} />
                      <Route path={ClientRoutes.Files} component={wrapperHeader(WrappedFileSearchComponent)} />
					<Route path={ClientRoutes.FileTypes + "/create"} component={wrapperHeader(WrappedFileTypeCreateComponent)} />
                      <Route path={ClientRoutes.FileTypes + "/edit/:id"} component={wrapperHeader(WrappedFileTypeEditComponent)} />
                      <Route path={ClientRoutes.FileTypes + "/:id"} component={wrapperHeader(WrappedFileTypeDetailComponent)} />
                      <Route path={ClientRoutes.FileTypes} component={wrapperHeader(WrappedFileTypeSearchComponent)} />
					        </Switch>
	  </Security>
    </BrowserRouter>
  );
...
/*<Codenesium>
    <Hash>b9d775de1391c04832d69d591b11837d</Hash>
</Codenesium>*/