...
{
    records:Array<FileTypeViewModel>;
...
export default class FileTypeSearchComponent extends React.Component<FileTypeSearchComponentProps, FileTypeSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<FileTypeViewModel>(), filteredRecords:new Array<FileTypeViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleCreateClick(e:any) {
        this.props.history.push(ClientRoutes.FileTypes + '/create');
    }

    handleDeleteClick(e:any, row:Api.FileTypeClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.FileTypes + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.FileTypes + '?limit=100';
	   ...
	   .then(resp => {
		    ...
		    let viewModels : Array<FileTypeViewModel> = [];
		   ...
		   console.log(error);
		   this.setState({records:new Array<FileTypeViewModel>(), filteredRecords:new Array<FileTypeViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
