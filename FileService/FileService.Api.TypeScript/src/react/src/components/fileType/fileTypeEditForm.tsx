...
const FileTypeEditDisplay = (props: FormikProps<FileTypeViewModel>) => {
  let status = props.status as UpdateResponse<Api.FileTypeClientRequestModel>;
...
const FileTypeEdit = withFormik<Props, FileTypeViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.FileTypes + '/' + values.id,
...
interface FileTypeEditComponentState {
  model?: FileTypeViewModel;
  loading: boolean;
  loaded: boolean;
...
export default class FileTypeEditComponent extends React.Component<
  FileTypeEditComponentProps,
  FileTypeEditComponentState
> {
  state = {
    model: undefined,
    loading: false,
  ...
  render() {
    if (this.state.loading) {
      ...
      return <FileTypeEdit model={this.state.model} />;
    } else {
      return null;
    }
  }
...
/*<Codenesium>
    <Hash>501f6bc3bcca229b73eb1c06a2d09717</Hash>
</Codenesium>*/