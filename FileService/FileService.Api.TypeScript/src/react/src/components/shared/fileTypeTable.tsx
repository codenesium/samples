...
interface FileTypeTableComponentState {
  loading: boolean;
  loaded: boolean;
...
> {
  ...
  loadRecords() {
    ...
    axios
      .get<Array<Api.FileTypeClientResponseModel>>(this.props.apiRoute, {
...
/*<Codenesium>
    <Hash>2e5d85621eac3fee621031055b46eeab</Hash>
</Codenesium>*/