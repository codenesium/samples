...
interface BucketSelectComponentProps {
...
interface BucketSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class BucketSelectComponent extends React.Component<
  BucketSelectComponentProps,
  BucketSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
  ...
  componentDidMount() {
    ...
    axios
      .get<Array<Api.BucketClientResponseModel>>(this.props.apiRoute, {
      ...
      .then(response => {
        ...
        let devices: Array<BucketViewModel> = [];
