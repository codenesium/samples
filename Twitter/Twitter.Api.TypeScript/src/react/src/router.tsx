  ...
  return (
	...
	<Security issuer={config.oidc.issuer}
        ...
        <Switch>
		  ...
		  <Route path={ClientRoutes.DirectTweets + "/create"} component={wrapperHeader(WrappedDirectTweetCreateComponent, "DirectTweet Create")} />
                      <Route path={ClientRoutes.DirectTweets + "/edit/:id"} component={wrapperHeader(WrappedDirectTweetEditComponent, "DirectTweet Edit")} />
                      <Route path={ClientRoutes.DirectTweets + "/:id"} component={wrapperHeader(WrappedDirectTweetDetailComponent , "DirectTweet Detail")} />
                      <Route path={ClientRoutes.DirectTweets} component={wrapperHeader(WrappedDirectTweetSearchComponent, "DirectTweet Search")} />
					<Route path={ClientRoutes.Followers + "/create"} component={wrapperHeader(WrappedFollowerCreateComponent, "Follower Create")} />
                      <Route path={ClientRoutes.Followers + "/edit/:id"} component={wrapperHeader(WrappedFollowerEditComponent, "Follower Edit")} />
                      <Route path={ClientRoutes.Followers + "/:id"} component={wrapperHeader(WrappedFollowerDetailComponent , "Follower Detail")} />
                      <Route path={ClientRoutes.Followers} component={wrapperHeader(WrappedFollowerSearchComponent, "Follower Search")} />
					<Route path={ClientRoutes.Followings + "/create"} component={wrapperHeader(WrappedFollowingCreateComponent, "Following Create")} />
                      <Route path={ClientRoutes.Followings + "/edit/:id"} component={wrapperHeader(WrappedFollowingEditComponent, "Following Edit")} />
                      <Route path={ClientRoutes.Followings + "/:id"} component={wrapperHeader(WrappedFollowingDetailComponent , "Following Detail")} />
                      <Route path={ClientRoutes.Followings} component={wrapperHeader(WrappedFollowingSearchComponent, "Following Search")} />
					...
					<Route path={ClientRoutes.Messages + "/create"} component={wrapperHeader(WrappedMessageCreateComponent, "Message Create")} />
                      <Route path={ClientRoutes.Messages + "/edit/:id"} component={wrapperHeader(WrappedMessageEditComponent, "Message Edit")} />
                      <Route path={ClientRoutes.Messages + "/:id"} component={wrapperHeader(WrappedMessageDetailComponent , "Message Detail")} />
                      <Route path={ClientRoutes.Messages} component={wrapperHeader(WrappedMessageSearchComponent, "Message Search")} />
					<Route path={ClientRoutes.Messengers + "/create"} component={wrapperHeader(WrappedMessengerCreateComponent, "Messenger Create")} />
                      <Route path={ClientRoutes.Messengers + "/edit/:id"} component={wrapperHeader(WrappedMessengerEditComponent, "Messenger Edit")} />
                      <Route path={ClientRoutes.Messengers + "/:id"} component={wrapperHeader(WrappedMessengerDetailComponent , "Messenger Detail")} />
                      <Route path={ClientRoutes.Messengers} component={wrapperHeader(WrappedMessengerSearchComponent, "Messenger Search")} />
					<Route path={ClientRoutes.QuoteTweets + "/create"} component={wrapperHeader(WrappedQuoteTweetCreateComponent, "QuoteTweet Create")} />
                      <Route path={ClientRoutes.QuoteTweets + "/edit/:id"} component={wrapperHeader(WrappedQuoteTweetEditComponent, "QuoteTweet Edit")} />
                      <Route path={ClientRoutes.QuoteTweets + "/:id"} component={wrapperHeader(WrappedQuoteTweetDetailComponent , "QuoteTweet Detail")} />
                      <Route path={ClientRoutes.QuoteTweets} component={wrapperHeader(WrappedQuoteTweetSearchComponent, "QuoteTweet Search")} />
					<Route path={ClientRoutes.Replies + "/create"} component={wrapperHeader(WrappedReplyCreateComponent, "Reply Create")} />
                      <Route path={ClientRoutes.Replies + "/edit/:id"} component={wrapperHeader(WrappedReplyEditComponent, "Reply Edit")} />
                      <Route path={ClientRoutes.Replies + "/:id"} component={wrapperHeader(WrappedReplyDetailComponent , "Reply Detail")} />
                      <Route path={ClientRoutes.Replies} component={wrapperHeader(WrappedReplySearchComponent, "Reply Search")} />
					<Route path={ClientRoutes.Retweets + "/create"} component={wrapperHeader(WrappedRetweetCreateComponent, "Retweet Create")} />
                      <Route path={ClientRoutes.Retweets + "/edit/:id"} component={wrapperHeader(WrappedRetweetEditComponent, "Retweet Edit")} />
                      <Route path={ClientRoutes.Retweets + "/:id"} component={wrapperHeader(WrappedRetweetDetailComponent , "Retweet Detail")} />
                      <Route path={ClientRoutes.Retweets} component={wrapperHeader(WrappedRetweetSearchComponent, "Retweet Search")} />
					<Route path={ClientRoutes.Tweets + "/create"} component={wrapperHeader(WrappedTweetCreateComponent, "Tweet Create")} />
                      <Route path={ClientRoutes.Tweets + "/edit/:id"} component={wrapperHeader(WrappedTweetEditComponent, "Tweet Edit")} />
                      <Route path={ClientRoutes.Tweets + "/:id"} component={wrapperHeader(WrappedTweetDetailComponent , "Tweet Detail")} />
                      <Route path={ClientRoutes.Tweets} component={wrapperHeader(WrappedTweetSearchComponent, "Tweet Search")} />
...
/*<Codenesium>
    <Hash>5dcd7562ac51b3d9c7a3e434c2e84544</Hash>
</Codenesium>*/