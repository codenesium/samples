  ...
  return (
	...
	<Security issuer={config.oidc.issuer}
        ...
        <Switch>
		  ...
		  <Route path={ClientRoutes.DirectTweets + "/create"} component={wrapperHeader(WrappedDirectTweetCreateComponent, "DirectTweets Create")} />
                      <Route path={ClientRoutes.DirectTweets + "/edit/:id"} component={wrapperHeader(WrappedDirectTweetEditComponent, "DirectTweets Edit")} />
                      <Route path={ClientRoutes.DirectTweets + "/:id"} component={wrapperHeader(WrappedDirectTweetDetailComponent , "DirectTweets Detail")} />
                      <Route path={ClientRoutes.DirectTweets} component={wrapperHeader(WrappedDirectTweetSearchComponent, "DirectTweets Search")} />
					<Route path={ClientRoutes.Followers + "/create"} component={wrapperHeader(WrappedFollowerCreateComponent, "Followers Create")} />
                      <Route path={ClientRoutes.Followers + "/edit/:id"} component={wrapperHeader(WrappedFollowerEditComponent, "Followers Edit")} />
                      <Route path={ClientRoutes.Followers + "/:id"} component={wrapperHeader(WrappedFollowerDetailComponent , "Followers Detail")} />
                      <Route path={ClientRoutes.Followers} component={wrapperHeader(WrappedFollowerSearchComponent, "Followers Search")} />
					<Route path={ClientRoutes.Followings + "/create"} component={wrapperHeader(WrappedFollowingCreateComponent, "Followings Create")} />
                      <Route path={ClientRoutes.Followings + "/edit/:id"} component={wrapperHeader(WrappedFollowingEditComponent, "Followings Edit")} />
                      <Route path={ClientRoutes.Followings + "/:id"} component={wrapperHeader(WrappedFollowingDetailComponent , "Followings Detail")} />
                      <Route path={ClientRoutes.Followings} component={wrapperHeader(WrappedFollowingSearchComponent, "Followings Search")} />
					...
					<Route path={ClientRoutes.Messages + "/create"} component={wrapperHeader(WrappedMessageCreateComponent, "Messages Create")} />
                      <Route path={ClientRoutes.Messages + "/edit/:id"} component={wrapperHeader(WrappedMessageEditComponent, "Messages Edit")} />
                      <Route path={ClientRoutes.Messages + "/:id"} component={wrapperHeader(WrappedMessageDetailComponent , "Messages Detail")} />
                      <Route path={ClientRoutes.Messages} component={wrapperHeader(WrappedMessageSearchComponent, "Messages Search")} />
					<Route path={ClientRoutes.Messengers + "/create"} component={wrapperHeader(WrappedMessengerCreateComponent, "Messengers Create")} />
                      <Route path={ClientRoutes.Messengers + "/edit/:id"} component={wrapperHeader(WrappedMessengerEditComponent, "Messengers Edit")} />
                      <Route path={ClientRoutes.Messengers + "/:id"} component={wrapperHeader(WrappedMessengerDetailComponent , "Messengers Detail")} />
                      <Route path={ClientRoutes.Messengers} component={wrapperHeader(WrappedMessengerSearchComponent, "Messengers Search")} />
					<Route path={ClientRoutes.QuoteTweets + "/create"} component={wrapperHeader(WrappedQuoteTweetCreateComponent, "QuoteTweets Create")} />
                      <Route path={ClientRoutes.QuoteTweets + "/edit/:id"} component={wrapperHeader(WrappedQuoteTweetEditComponent, "QuoteTweets Edit")} />
                      <Route path={ClientRoutes.QuoteTweets + "/:id"} component={wrapperHeader(WrappedQuoteTweetDetailComponent , "QuoteTweets Detail")} />
                      <Route path={ClientRoutes.QuoteTweets} component={wrapperHeader(WrappedQuoteTweetSearchComponent, "QuoteTweets Search")} />
					<Route path={ClientRoutes.Replies + "/create"} component={wrapperHeader(WrappedReplyCreateComponent, "Replies Create")} />
                      <Route path={ClientRoutes.Replies + "/edit/:id"} component={wrapperHeader(WrappedReplyEditComponent, "Replies Edit")} />
                      <Route path={ClientRoutes.Replies + "/:id"} component={wrapperHeader(WrappedReplyDetailComponent , "Replies Detail")} />
                      <Route path={ClientRoutes.Replies} component={wrapperHeader(WrappedReplySearchComponent, "Replies Search")} />
					<Route path={ClientRoutes.Retweets + "/create"} component={wrapperHeader(WrappedRetweetCreateComponent, "Retweets Create")} />
                      <Route path={ClientRoutes.Retweets + "/edit/:id"} component={wrapperHeader(WrappedRetweetEditComponent, "Retweets Edit")} />
                      <Route path={ClientRoutes.Retweets + "/:id"} component={wrapperHeader(WrappedRetweetDetailComponent , "Retweets Detail")} />
                      <Route path={ClientRoutes.Retweets} component={wrapperHeader(WrappedRetweetSearchComponent, "Retweets Search")} />
					<Route path={ClientRoutes.Tweets + "/create"} component={wrapperHeader(WrappedTweetCreateComponent, "Tweets Create")} />
                      <Route path={ClientRoutes.Tweets + "/edit/:id"} component={wrapperHeader(WrappedTweetEditComponent, "Tweets Edit")} />
                      <Route path={ClientRoutes.Tweets + "/:id"} component={wrapperHeader(WrappedTweetDetailComponent , "Tweets Detail")} />
                      <Route path={ClientRoutes.Tweets} component={wrapperHeader(WrappedTweetSearchComponent, "Tweets Search")} />
...
/*<Codenesium>
    <Hash>49d5daccc977e5d778fbe7bfd6d5ac6b</Hash>
</Codenesium>*/