 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new ReplyMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Replies + '/' + this.state.model!.replyId,
...
export const WrappedReplyEditComponent = Form.create({ name: 'Reply Edit' })(ReplyEditComponent);

/*<Codenesium>
    <Hash>a2a1648f14ebcaeea95eadeea41b48dc</Hash>
</Codenesium>*/