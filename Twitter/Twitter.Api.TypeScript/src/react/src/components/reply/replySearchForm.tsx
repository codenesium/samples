...
export default class ReplySearchComponent extends React.Component<ReplySearchComponentProps, ReplySearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ReplyViewModel>(), filteredRecords:new Array<ReplyViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedReplySearchComponent = Form.create({ name: 'Reply Search' })(ReplySearchComponent);

/*<Codenesium>
    <Hash>55edf6cbd777b1aac080fa60304c0cb9</Hash>
</Codenesium>*/