...
export default class ReplySearchComponent extends React.Component<
  ReplySearchComponentProps,
  ReplySearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<ReplyViewModel>(),
    filteredRecords: new Array<ReplyViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  handleDeleteClick(e: any, row: Api.ReplyClientResponseModel) {
    axios
      .delete(Constants.ApiEndpoint + ApiRoutes.Replies + '/' + row.replyId, {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.Replies + '?limit=100';
    ...
    axios
      .get<Array<Api.ReplyClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
                  ...
                  },
                  {
                    ...
                    Cell: props => {
                      return (
                        ...
                        >
                          {String(
                            props.original.replierUserIdNavigation &&
...
export const WrappedReplySearchComponent = Form.create({
  name: 'Reply Search',
})(ReplySearchComponent);


/*<Codenesium>
    <Hash>ea367a06d6264657664dcd89f00c2212</Hash>
</Codenesium>*/