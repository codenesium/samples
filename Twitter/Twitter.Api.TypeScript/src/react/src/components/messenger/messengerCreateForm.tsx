...
const MessengerCreateDisplay: React.SFC<FormikProps<MessengerViewModel>> = (
  props: FormikProps<MessengerViewModel>
) => {
  ...
  let errorsForField = (name: string): string => {
    let response = '';
    if (
      props.touched[name as keyof MessengerViewModel] &&
      props.errors[name as keyof MessengerViewModel]
    ) {
    ...
    <form onSubmit={props.handleSubmit} role="form">
      ...
      <div className="form-group row">
        ...
        <div className="col-sm-12">
          ...
          />
          {errorExistForField('messageId') && (
            <small className="text-danger">{errorsForField('messageId')}</small>
          )}
        </div>
      </div>
      ...
      <div className="form-group row">
        ...
        <div className="col-sm-12">
          ...
          />
          {errorExistForField('toUserId') && (
            <small className="text-danger">{errorsForField('toUserId')}</small>
          )}
        </div>
      </div>
  ...
  mapPropsToValues: props => {
    ...
    if (props.model != undefined) {
      response.setProperties(
        props.model!.date,
        props.model!.fromUserId,
        props.model!.id,
        props.model!.messageId,
        props.model!.time,
        props.model!.toUserId,
        props.model!.userId
      );
    }
    return response;
...
export default class MessengerCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>25192eaac6eeb702e14c20820aefd9e7</Hash>
</Codenesium>*/