...
export default class MessengerSearchComponent extends React.Component<MessengerSearchComponentProps, MessengerSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<MessengerViewModel>(), filteredRecords:new Array<MessengerViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedMessengerSearchComponent = Form.create({ name: 'Messenger Search' })(MessengerSearchComponent);

/*<Codenesium>
    <Hash>629e7d9c0d80db68383ac4a5dead738b</Hash>
</Codenesium>*/