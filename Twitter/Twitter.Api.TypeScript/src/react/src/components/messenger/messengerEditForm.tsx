...
const MessengerEdit = withFormik<Props, MessengerViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Messengers + '/' + values.id,
...
export default class MessengerEditComponent extends React.Component<
...
/*<Codenesium>
    <Hash>4ddd7edd4e706231b0956a086de61dc3</Hash>
</Codenesium>*/