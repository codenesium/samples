...
const DirectTweetDetailDisplay = (model:Props) => {
   ...
   return (
          <form  role="form">
				<button
                  ...
                  onClick={(e) => { model.history.push(ClientRoutes.DirectTweets + '/edit/' + model.model!.tweetId)}}
                >
                  <i className="fas fa-edit" />
							...
							<div className="col-sm-12">
								{String(model.model!.date)}
					   						 ...
					   						 <div className="form-group row">
							<label htmlFor="taggedUserId" className={"col-sm-2 col-form-label"}>Tagged_user_id</label>
							<div className="col-sm-12">
  ...
  export default class DirectTweetDetailComponent extends React.Component<DirectTweetDetailComponentProps, DirectTweetDetailComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.DirectTweets + '/' + this.props.match.params.tweetId,
        {
            headers: {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<DirectTweetDetailDisplay history={this.props.history} model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>88d70066a274fbe7e31674b1909d7619</Hash>
</Codenesium>*/