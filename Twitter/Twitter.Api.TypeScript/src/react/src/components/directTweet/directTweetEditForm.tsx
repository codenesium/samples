 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new DirectTweetMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.DirectTweets + '/' + this.state.model!.tweetId,
...
export const WrappedDirectTweetEditComponent = Form.create({ name: 'DirectTweet Edit' })(DirectTweetEditComponent);

/*<Codenesium>
    <Hash>df430a49c8026c34f999e10b1260e269</Hash>
</Codenesium>*/