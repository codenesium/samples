...
interface Props {
  ...
  const DirectTweetEditDisplay = (props: FormikProps<DirectTweetViewModel>) => {
   ...
   let status = props.status as UpdateResponse<Api.DirectTweetClientRequestModel>;
...
const DirectTweetEdit = withFormik<Props, DirectTweetViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.DirectTweets +'/' + values.tweetId,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.DirectTweetClientRequestModel>;
  ...
  export default class DirectTweetEditComponent extends React.Component<DirectTweetEditComponentProps, DirectTweetEditComponentState> {
...
/*<Codenesium>
    <Hash>34ef632aeeeb3dcf86fd7121271fe1e0</Hash>
</Codenesium>*/