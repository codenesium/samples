...
interface Props {
   ...
   const FollowingCreateDisplay: React.SFC<FormikProps<FollowingViewModel>> = (props: FormikProps<FollowingViewModel>) => {
   ...
   {
        let response = '';
        if(props.touched[name as keyof FollowingViewModel]  && props.errors[name as keyof FollowingViewModel]) {
...
const FollowingCreate = withFormik<Props, FollowingViewModel>({
    mapPropsToValues: props => {
		...
		{
			response.setProperties(props.model!.dateFollowed,props.model!.muted,props.model!.userId);	
		}
		return response;
      },
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.Followings,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.FollowingClientRequestModel>;
  ...
  export default class FollowingCreateComponent extends React.Component<FollowingCreateComponentProps, FollowingCreateComponentState> {
...
/*<Codenesium>
    <Hash>838099540139ece7abe80ba763aee562</Hash>
</Codenesium>*/