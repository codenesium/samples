...
export default class FollowingSearchComponent extends React.Component<FollowingSearchComponentProps, FollowingSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<FollowingViewModel>(), filteredRecords:new Array<FollowingViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedFollowingSearchComponent = Form.create({ name: 'Following Search' })(FollowingSearchComponent);

/*<Codenesium>
    <Hash>081b7967fa79b36673ea6cea7eac9b6f</Hash>
</Codenesium>*/