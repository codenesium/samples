  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.Followings + '/edit/' + model.model!.userId
          );
        }}
      >
...
export default class FollowingDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>c903a6faa18cd5ac37c6f3b61ca7b191</Hash>
</Codenesium>*/