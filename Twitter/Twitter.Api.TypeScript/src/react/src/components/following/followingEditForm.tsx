 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new FollowingMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Followings + '/' + this.state.model!.userId,
...
export const WrappedFollowingEditComponent = Form.create({ name: 'Following Edit' })(FollowingEditComponent);

/*<Codenesium>
    <Hash>d5c07605efa08d5255440bc007f3b6eb</Hash>
</Codenesium>*/