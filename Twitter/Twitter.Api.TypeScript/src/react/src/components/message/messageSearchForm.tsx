...
export default class MessageSearchComponent extends React.Component<MessageSearchComponentProps, MessageSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<MessageViewModel>(), filteredRecords:new Array<MessageViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedMessageSearchComponent = Form.create({ name: 'Message Search' })(MessageSearchComponent);

/*<Codenesium>
    <Hash>5e4b8ad4e2a02ee88d23304c814cff58</Hash>
</Codenesium>*/