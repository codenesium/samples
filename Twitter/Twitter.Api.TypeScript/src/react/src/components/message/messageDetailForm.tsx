  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.Messages + '/edit/' + model.model!.messageId
          );
        }}
      >
      ...
      <div className="form-group row">
        <label htmlFor="senderUserId" className={'col-sm-2 col-form-label'}>
          Sender_user_id
        </label>
...
export default class MessageDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>875f03aef6d69a01e83e44e5cf011bc3</Hash>
</Codenesium>*/