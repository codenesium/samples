...
const MessageCreateDisplay: React.SFC<FormikProps<MessageViewModel>> = (
  props: FormikProps<MessageViewModel>
) => {
  ...
  let errorsForField = (name: string): string => {
    let response = '';
    if (
      props.touched[name as keyof MessageViewModel] &&
      props.errors[name as keyof MessageViewModel]
    ) {
    ...
    <form onSubmit={props.handleSubmit} role="form">
      ...
      <div className="form-group row">
        <label
          htmlFor="name"
          className={
            errorExistForField('senderUserId')
              ? 'col-sm-2 col-form-label is-invalid'
              : 'col-sm-2 col-form-label'
          }
        >
...
export default class MessageCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>0ed2798b9eb0fc68fb25c25dbd2ffea5</Hash>
</Codenesium>*/