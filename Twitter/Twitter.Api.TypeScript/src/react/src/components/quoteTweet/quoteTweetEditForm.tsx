...
const QuoteTweetEdit = withFormik<Props, QuoteTweetViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.QuoteTweets +'/' + values.quoteTweetId,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.QuoteTweetClientRequestModel>;
  ...
  export default class QuoteTweetEditComponent extends React.Component<QuoteTweetEditComponentProps, QuoteTweetEditComponentState> {
...
/*<Codenesium>
    <Hash>32e1262e7d6041e9c51242757b0f4563</Hash>
</Codenesium>*/