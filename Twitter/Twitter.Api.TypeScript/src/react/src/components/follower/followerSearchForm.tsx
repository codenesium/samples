...
export default class FollowerSearchComponent extends React.Component<FollowerSearchComponentProps, FollowerSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<FollowerViewModel>(), filteredRecords:new Array<FollowerViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedFollowerSearchComponent = Form.create({ name: 'Follower Search' })(FollowerSearchComponent);

/*<Codenesium>
    <Hash>c617d84da9183915331e592d5332994c</Hash>
</Codenesium>*/