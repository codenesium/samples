...
const FollowerEdit = withFormik<Props, FollowerViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Followers + '/' + values.id,
...
export default class FollowerEditComponent extends React.Component<
...
/*<Codenesium>
    <Hash>20a6ba4ed13ea58a8bb0f95b3b4b523b</Hash>
</Codenesium>*/