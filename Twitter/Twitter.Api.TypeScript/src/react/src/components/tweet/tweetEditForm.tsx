...
const TweetEdit = withFormik<Props, TweetViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Tweets +'/' + values.tweetId,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.TweetClientRequestModel>;
  ...
  export default class TweetEditComponent extends React.Component<TweetEditComponentProps, TweetEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Tweets + '/' + this.props.match.params.tweetId, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
...
/*<Codenesium>
    <Hash>437ef67c99a343456d1c10385042a719</Hash>
</Codenesium>*/