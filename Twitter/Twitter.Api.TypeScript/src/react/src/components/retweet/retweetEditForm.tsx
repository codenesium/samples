...
const RetweetEdit = withFormik<Props, RetweetViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Retweets + '/' + values.id,
...
export default class RetweetEditComponent extends React.Component<
...
/*<Codenesium>
    <Hash>8b3e05f191f6dc84cb07713874abc8c5</Hash>
</Codenesium>*/