  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.Retweets + '/edit/' + model.model!.id
          );
        }}
      >
      ...
      <div className="form-group row">
        <label htmlFor="retwitterUserId" className={'col-sm-2 col-form-label'}>
          Retwitter_user_id
        </label>
      ...
      <div className="form-group row">
        <label htmlFor="tweetTweetId" className={'col-sm-2 col-form-label'}>
          Tweet_tweet_id
        </label>
        <div className="col-sm-12">
...
export default class RetweetDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>cad9457ce049d9f49ac9ba7b18a159c7</Hash>
</Codenesium>*/