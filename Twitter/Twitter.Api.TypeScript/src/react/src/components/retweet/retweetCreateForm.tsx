...
interface Props {
   ...
   const RetweetCreateDisplay: React.SFC<FormikProps<RetweetViewModel>> = (props: FormikProps<RetweetViewModel>) => {
...
const RetweetCreate = withFormik<Props, RetweetViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.Retweets,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.RetweetClientRequestModel>;
  ...
  export default class RetweetCreateComponent extends React.Component<RetweetCreateComponentProps, RetweetCreateComponentState> {
...
/*<Codenesium>
    <Hash>d86938b393686863055cf08e43689492</Hash>
</Codenesium>*/