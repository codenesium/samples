...
class RetweetCreateComponent extends React.Component<
...
export const WrappedRetweetCreateComponent = Form.create({ name: 'Retweet Create' })(RetweetCreateComponent);

/*<Codenesium>
    <Hash>bd58086e4e8655b4b31ac030759f8981</Hash>
</Codenesium>*/