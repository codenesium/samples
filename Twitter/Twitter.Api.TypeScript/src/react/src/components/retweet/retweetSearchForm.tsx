...
export default class RetweetSearchComponent extends React.Component<RetweetSearchComponentProps, RetweetSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<RetweetViewModel>(), filteredRecords:new Array<RetweetViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedRetweetSearchComponent = Form.create({ name: 'Retweet Search' })(RetweetSearchComponent);

/*<Codenesium>
    <Hash>0928a9a023883fdf73861dadc7c1083c</Hash>
</Codenesium>*/