...
export default class LocationSearchComponent extends React.Component<LocationSearchComponentProps, LocationSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<LocationViewModel>(), filteredRecords:new Array<LocationViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>d34f290d18ceb1f4a8ac7e94bc918fba</Hash>
</Codenesium>*/