...
namespace SecureVideoCRMNS.Api.DataAccess
{
	public abstract class AbstractUserRepository : AbstractRepository
	{
		...
		// Non-unique constraint IX_User_subscriptionId.
		public async virtual Task<List<User>> BySubscriptionId(int subscriptionId, int limit = int.MaxValue, int offset = 0)
		{
			return await this.Where(x => x.SubscriptionId == subscriptionId, limit, offset);
		}

		// Foreign key reference to table Subscription via subscriptionId.
		public async virtual Task<Subscription> SubscriptionBySubscriptionId(int subscriptionId)
		{
			...
			Expression<Func<User, dynamic>> orderBy = null)
		{
			...
			return await this.Context.Set<User>()
			       .Include(x => x.SubscriptionIdNavigation)
...
/*<Codenesium>
    <Hash>9827e18cab3af2896e7f428e221d591c</Hash>
</Codenesium>*/