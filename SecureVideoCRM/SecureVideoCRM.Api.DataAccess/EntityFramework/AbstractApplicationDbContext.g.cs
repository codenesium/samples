...
namespace SecureVideoCRMNS.Api.DataAccess
{
	...
	public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
	{
		...
		{
			string settingsDirectory = Path.Combine(Directory.GetParent(Directory.GetCurrentDirectory()).FullName, "SecureVideoCRM.Api.Web");
...
/*<Codenesium>
    <Hash>265b551f97c1be41a3578af33fe54788</Hash>
</Codenesium>*/