...
namespace SecureVideoCRMNS.Api.Services.Tests
{
	...
	public partial class SubscriptionServiceTests
	{
		...
		[Fact]
		public async void UsersBySubscriptionId_Exists()
		{
			var mock = new ServiceMockFacade<ISubscriptionRepository>();
			var records = new List<User>();
			records.Add(new User());
			mock.RepositoryMock.Setup(x => x.UsersBySubscriptionId(default(int), It.IsAny<int>(), It.IsAny<int>())).Returns(Task.FromResult(records));
			var service = new SubscriptionService(mock.LoggerMock.Object,
			                                      mock.MediatorMock.Object,
			                                      mock.RepositoryMock.Object,
			                                      mock.ModelValidatorMockFactory.SubscriptionModelValidatorMock.Object,
			...
			List<ApiUserServerResponseModel> response = await service.UsersBySubscriptionId(default(int));

			response.Should().NotBeEmpty();
			mock.RepositoryMock.Verify(x => x.UsersBySubscriptionId(default(int), It.IsAny<int>(), It.IsAny<int>()));
		}

		[Fact]
		public async void UsersBySubscriptionId_Not_Exists()
		{
			var mock = new ServiceMockFacade<ISubscriptionRepository>();
			mock.RepositoryMock.Setup(x => x.UsersBySubscriptionId(default(int), It.IsAny<int>(), It.IsAny<int>())).Returns(Task.FromResult<List<User>>(new List<User>()));
			var service = new SubscriptionService(mock.LoggerMock.Object,
			                                      mock.MediatorMock.Object,
			                                      mock.RepositoryMock.Object,
			                                      mock.ModelValidatorMockFactory.SubscriptionModelValidatorMock.Object,
...
/*<Codenesium>
    <Hash>2119122eeb4f0b10b47a707f8931dfaf</Hash>
</Codenesium>*/