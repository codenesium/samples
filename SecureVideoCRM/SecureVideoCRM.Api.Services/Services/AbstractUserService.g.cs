...
namespace SecureVideoCRMNS.Api.Services
{
	public abstract class AbstractUserService : AbstractService
	{
		...
		public async virtual Task<List<ApiUserServerResponseModel>> BySubscriptionId(int subscriptionId, int limit = 0, int offset = int.MaxValue)
		{
			List<User> records = await this.UserRepository.BySubscriptionId(subscriptionId, limit, offset);
...
/*<Codenesium>
    <Hash>650caa38d798638082998071777319fc</Hash>
</Codenesium>*/