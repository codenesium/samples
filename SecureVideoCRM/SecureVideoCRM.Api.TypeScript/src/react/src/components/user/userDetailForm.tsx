      ...
      return (
        <div>
          ...
          <div>
            ...
            <div>
              <h3>stripeCustomerId</h3>
              <p>{String(this.state.model!.stripeCustomerId)}</p>
            </div>
            <div>
              <h3>subscriptionTypeId</h3>
              <p>{String(this.state.model!.subscriptionTypeId)}</p>
            </div>
          </div>
          {message}
        </div>
...
/*<Codenesium>
    <Hash>c03a99cf64fb869b4648f02d2aae3b24</Hash>
</Codenesium>*/