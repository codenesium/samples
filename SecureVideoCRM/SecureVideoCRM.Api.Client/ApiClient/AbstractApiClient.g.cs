...
namespace SecureVideoCRMNS.Api.Client
{
	public abstract class AbstractApiClient
	{
		...
		public virtual async Task<List<ApiUserClientResponseModel>> ByUserBySubscriptionId(int subscriptionId, CancellationToken cancellationToken = default(CancellationToken))
		{
			HttpResponseMessage httpResponse = await this.Client.GetAsync($"api/Users/bySubscriptionId/{subscriptionId}", cancellationToken).ConfigureAwait(false);
		...
		public virtual async Task<List<ApiUserClientResponseModel>> UsersBySubscriptionId(int subscriptionId, CancellationToken cancellationToken = default(CancellationToken))
		{
			HttpResponseMessage httpResponse = await this.Client.GetAsync($"api/Subscriptions/{subscriptionId}/Users", cancellationToken).ConfigureAwait(false);
...
/*<Codenesium>
    <Hash>23d0f7fe041cd6bd3eac70f950c805e4</Hash>
</Codenesium>*/