...
namespace SecureVideoCRMNS.Api.Web
{
	public abstract class AbstractSubscriptionController : AbstractApiController
	{
		...
		[HttpGet]
		[Route("{subscriptionId}/Users")]
		[ReadOnly]
		[ProducesResponseType(typeof(List<ApiUserServerResponseModel>), 200)]
		public async virtual Task<IActionResult> UsersBySubscriptionId(int subscriptionId, int? limit, int? offset)
		{
			...
			List<ApiUserServerResponseModel> response = await this.SubscriptionService.UsersBySubscriptionId(subscriptionId, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>0d1dda78be1beb137d6f91550c552871</Hash>
</Codenesium>*/