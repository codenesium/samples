...
namespace AdventureWorksNS.Api.Client
{
	public abstract class AbstractApiClient
	{
		...
		{
			HttpResponseMessage httpResponse = await this.Client.GetAsync($"api/Products/{componentID}/BillOfMaterials", cancellationToken).ConfigureAwait(false);
		...
		{
			HttpResponseMessage httpResponse = await this.Client.GetAsync($"api/Products/{productAssemblyID}/BillOfMaterialsByProductAssemblyID", cancellationToken).ConfigureAwait(false);

			this.HandleResponseCode(httpResponse);
			return JsonConvert.DeserializeObject<List<ApiBillOfMaterialClientResponseModel>>(httpResponse.Content.ContentToString());
		}

		public virtual async Task<List<ApiProductProductPhotoClientResponseModel>> ProductProductPhotoesByProductID(int productID, CancellationToken cancellationToken = default(CancellationToken))
		{
			HttpResponseMessage httpResponse = await this.Client.GetAsync($"api/Products/{productID}/ProductProductPhotoes", cancellationToken).ConfigureAwait(false);

			this.HandleResponseCode(httpResponse);
			return JsonConvert.DeserializeObject<List<ApiProductProductPhotoClientResponseModel>>(httpResponse.Content.ContentToString());
		}
		...
		public virtual async Task<List<ApiProductProductPhotoClientResponseModel>> ProductProductPhotoesByProductPhotoID(int productPhotoID, CancellationToken cancellationToken = default(CancellationToken))
		{
			HttpResponseMessage httpResponse = await this.Client.GetAsync($"api/ProductPhotoes/{productPhotoID}/ProductProductPhotoes", cancellationToken).ConfigureAwait(false);

			this.HandleResponseCode(httpResponse);
			return JsonConvert.DeserializeObject<List<ApiProductProductPhotoClientResponseModel>>(httpResponse.Content.ContentToString());
		}

		public virtual async Task<CreateResponse<List<ApiProductProductPhotoClientResponseModel>>> ProductProductPhotoBulkInsertAsync(List<ApiProductProductPhotoClientRequestModel> items, CancellationToken cancellationToken = default(CancellationToken))
		{
			HttpResponseMessage httpResponse = await this.Client.PostAsJsonAsync($"api/ProductProductPhotoes/BulkInsert", items, cancellationToken).ConfigureAwait(false);

			this.HandleResponseCode(httpResponse);
			return JsonConvert.DeserializeObject<CreateResponse<List<ApiProductProductPhotoClientResponseModel>>>(httpResponse.Content.ContentToString());
		}

		public virtual async Task<CreateResponse<ApiProductProductPhotoClientResponseModel>> ProductProductPhotoCreateAsync(ApiProductProductPhotoClientRequestModel item, CancellationToken cancellationToken = default(CancellationToken))
		{
			HttpResponseMessage httpResponse = await this.Client.PostAsJsonAsync($"api/ProductProductPhotoes", item, cancellationToken).ConfigureAwait(false);

			this.HandleResponseCode(httpResponse);
			return JsonConvert.DeserializeObject<CreateResponse<ApiProductProductPhotoClientResponseModel>>(httpResponse.Content.ContentToString());
		}

		public virtual async Task<UpdateResponse<ApiProductProductPhotoClientResponseModel>> ProductProductPhotoUpdateAsync(int id, ApiProductProductPhotoClientRequestModel item, CancellationToken cancellationToken = default(CancellationToken))
		{
			HttpResponseMessage httpResponse = await this.Client.PutAsJsonAsync($"api/ProductProductPhotoes/{id}", item, cancellationToken).ConfigureAwait(false);

			this.HandleResponseCode(httpResponse);
			return JsonConvert.DeserializeObject<UpdateResponse<ApiProductProductPhotoClientResponseModel>>(httpResponse.Content.ContentToString());
		}

		public virtual async Task<ActionResponse> ProductProductPhotoDeleteAsync(int id, CancellationToken cancellationToken = default(CancellationToken))
		{
			HttpResponseMessage httpResponse = await this.Client.DeleteAsync($"api/ProductProductPhotoes/{id}", cancellationToken).ConfigureAwait(false);

			this.HandleResponseCode(httpResponse);
			return JsonConvert.DeserializeObject<ActionResponse>(httpResponse.Content.ContentToString());
		}

		public virtual async Task<ApiProductProductPhotoClientResponseModel> ProductProductPhotoGetAsync(int id, CancellationToken cancellationToken = default(CancellationToken))
		{
			HttpResponseMessage httpResponse = await this.Client.GetAsync($"api/ProductProductPhotoes/{id}", cancellationToken).ConfigureAwait(false);

			this.HandleResponseCode(httpResponse);
			return JsonConvert.DeserializeObject<ApiProductProductPhotoClientResponseModel>(httpResponse.Content.ContentToString());
		}

		public virtual async Task<List<ApiProductProductPhotoClientResponseModel>> ProductProductPhotoAllAsync(CancellationToken cancellationToken = default(CancellationToken))
		{
			int offset = 0;
			bool moreRecords = true;
			List<ApiProductProductPhotoClientResponseModel> response = new List<ApiProductProductPhotoClientResponseModel>();
			while (moreRecords)
			{
				HttpResponseMessage httpResponse = await this.Client.GetAsync($"api/ProductProductPhotoes?limit={this.MaxLimit}&offset={offset}", cancellationToken).ConfigureAwait(false);

				this.HandleResponseCode(httpResponse);
				List<ApiProductProductPhotoClientResponseModel> records = JsonConvert.DeserializeObject<List<ApiProductProductPhotoClientResponseModel>>(httpResponse.Content.ContentToString());
				response.AddRange(records);
				if (records.Count < this.MaxLimit)
				{
					moreRecords = false;
...
/*<Codenesium>
    <Hash>ef562deb18151e225a28555ad3fa322c</Hash>
</Codenesium>*/