...
namespace AdventureWorksNS.Api.DataAccess
{
	...
	public partial class BusinessEntityRepositoryTests
	{
		...
		public async void Get()
		{
			...
			entity.SetProperties(default(int), DateTime.Parse("1/1/1988 12:00:00 AM"), Guid.Parse("3842cac4-b9a0-8223-0dcc-509a6f75849b"));
		...
		public async void Create()
		{
			...
			var records = await context.Set<BusinessEntity>().ToListAsync();
...
/*<Codenesium>
    <Hash>2ccf5a861c72b3cb32785038828b1d01</Hash>
</Codenesium>*/