...
namespace AdventureWorksNS.Api.DataAccess
{
	...
	public partial class SalesTerritoryRepositoryTests
	{
		...
		public async void Get()
		{
			...
			entity.SetProperties(default(int), 2m, 2m, "B", DateTime.Parse("1/1/1988 12:00:00 AM"), "B", "B", Guid.Parse("3842cac4-b9a0-8223-0dcc-509a6f75849b"), 2m, 2m);
		...
		public async void Create()
		{
			...
			var records = await context.Set<SalesTerritory>().ToListAsync();
...
/*<Codenesium>
    <Hash>2c716d9c26ef0d07421c9c072079da42</Hash>
</Codenesium>*/