...
namespace AdventureWorksNS.Api.DataAccess
{
	...
	public partial class SpecialOfferRepositoryTests
	{
		...
		public async void Get()
		{
			...
			entity.SetProperties(default(int), "B", "B", 2m, DateTime.Parse("1/1/1988 12:00:00 AM"), 2, 2, DateTime.Parse("1/1/1988 12:00:00 AM"), "B", Guid.Parse("3842cac4-b9a0-8223-0dcc-509a6f75849b"), DateTime.Parse("1/1/1988 12:00:00 AM"));
		...
		public async void Create()
		{
			...
			var records = await context.Set<SpecialOffer>().ToListAsync();
...
/*<Codenesium>
    <Hash>b9ed86f8dd55550fb87d81a7de42c338</Hash>
</Codenesium>*/