...
namespace AdventureWorksNS.Api.DataAccess
{
	...
	public partial class CustomerRepositoryTests
	{
		...
		public async void Get()
		{
			...
			entity.SetProperties(default(int), "B", DateTime.Parse("1/1/1988 12:00:00 AM"), 2, Guid.Parse("3842cac4-b9a0-8223-0dcc-509a6f75849b"), 1, 1);
		...
		public async void Create()
		{
			...
			var records = await context.Set<Customer>().ToListAsync();
...
/*<Codenesium>
    <Hash>5b5066645542b7f5e78ea08b2976022e</Hash>
</Codenesium>*/