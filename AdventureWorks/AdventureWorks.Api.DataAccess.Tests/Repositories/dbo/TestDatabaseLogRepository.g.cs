...
namespace AdventureWorksNS.Api.DataAccess
{
	...
	public partial class DatabaseLogRepositoryTests
	{
		...
		public async void Get()
		{
			...
			entity.SetProperties(default(int), "B", DateTime.Parse("1/1/1988 12:00:00 AM"), "B", "B", "B", "B", "B");
		...
		public async void Create()
		{
			...
			var records = await context.Set<DatabaseLog>().ToListAsync();
...
/*<Codenesium>
    <Hash>0449ec84e5b81cc6f7984bf207ece230</Hash>
</Codenesium>*/