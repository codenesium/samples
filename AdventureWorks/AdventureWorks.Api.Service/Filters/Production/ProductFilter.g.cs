...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IProductModelValidator validator { get; set; }

		public ProductFilter(IProductModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ProductModel>().ToList();
...
/*<Codenesium>
    <Hash>0de1ef8b992c5c3a2b16fd14825db451</Hash>
</Codenesium>*/