...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IProductInventoryModelValidator validator { get; set; }

		public ProductInventoryFilter(IProductInventoryModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ProductInventoryModel>().ToList();
...
/*<Codenesium>
    <Hash>4caeda776adf71d196802a2629c9f55a</Hash>
</Codenesium>*/