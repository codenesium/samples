...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IBillOfMaterialsModelValidator validator { get; set; }

		public BillOfMaterialsFilter(IBillOfMaterialsModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<BillOfMaterialsModel>().ToList();
...
/*<Codenesium>
    <Hash>66cb5caa6e1fb0aab9178e8818af4556</Hash>
</Codenesium>*/