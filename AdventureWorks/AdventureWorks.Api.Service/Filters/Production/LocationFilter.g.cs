...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ILocationModelValidator validator { get; set; }

		public LocationFilter(ILocationModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<LocationModel>().ToList();
...
/*<Codenesium>
    <Hash>5d212f9bd428fb47e0b6a413fc88e28c</Hash>
</Codenesium>*/