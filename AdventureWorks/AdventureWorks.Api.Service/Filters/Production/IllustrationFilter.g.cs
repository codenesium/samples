...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IIllustrationModelValidator validator { get; set; }

		public IllustrationFilter(IIllustrationModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<IllustrationModel>().ToList();
...
/*<Codenesium>
    <Hash>a1ab6d8fd40aff397313225362070ff9</Hash>
</Codenesium>*/