...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IProductDocumentModelValidator validator { get; set; }

		public ProductDocumentFilter(IProductDocumentModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ProductDocumentModel>().ToList();
...
/*<Codenesium>
    <Hash>dab31957e1c12ae4b04b765eca115221</Hash>
</Codenesium>*/