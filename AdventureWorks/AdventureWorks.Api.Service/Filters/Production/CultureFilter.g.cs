...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ICultureModelValidator validator { get; set; }

		public CultureFilter(ICultureModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<CultureModel>().ToList();
...
/*<Codenesium>
    <Hash>5a29135f7eafecb2ccdac68a0fa7f408</Hash>
</Codenesium>*/