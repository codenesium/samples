...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ITransactionHistoryArchiveModelValidator validator { get; set; }

		public TransactionHistoryArchiveFilter(ITransactionHistoryArchiveModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<TransactionHistoryArchiveModel>().ToList();
...
/*<Codenesium>
    <Hash>ce2b772300535ed3c1e0f7fde326cb32</Hash>
</Codenesium>*/