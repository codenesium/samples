...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IProductCostHistoryModelValidator validator { get; set; }

		public ProductCostHistoryFilter(IProductCostHistoryModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ProductCostHistoryModel>().ToList();
...
/*<Codenesium>
    <Hash>0b799a011d876aa909267df9c5aeb5fb</Hash>
</Codenesium>*/