...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ITransactionHistoryModelValidator validator { get; set; }

		public TransactionHistoryFilter(ITransactionHistoryModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<TransactionHistoryModel>().ToList();
...
/*<Codenesium>
    <Hash>103bc827e71b04980f6d44f2b9bb3cac</Hash>
</Codenesium>*/