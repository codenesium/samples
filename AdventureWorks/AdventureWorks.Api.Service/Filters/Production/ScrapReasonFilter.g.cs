...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IScrapReasonModelValidator validator { get; set; }

		public ScrapReasonFilter(IScrapReasonModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ScrapReasonModel>().ToList();
...
/*<Codenesium>
    <Hash>eeea0e66a4b7566c28e847f1446a1836</Hash>
</Codenesium>*/