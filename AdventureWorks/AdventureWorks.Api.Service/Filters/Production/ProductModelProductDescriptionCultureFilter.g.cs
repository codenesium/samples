...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IProductModelProductDescriptionCultureModelValidator validator { get; set; }

		public ProductModelProductDescriptionCultureFilter(IProductModelProductDescriptionCultureModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ProductModelProductDescriptionCultureModel>().ToList();
...
/*<Codenesium>
    <Hash>5b8ca2131b7e48e58fefc96f59d9494d</Hash>
</Codenesium>*/