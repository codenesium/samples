...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IWorkOrderRoutingModelValidator validator { get; set; }

		public WorkOrderRoutingFilter(IWorkOrderRoutingModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<WorkOrderRoutingModel>().ToList();
...
/*<Codenesium>
    <Hash>f3b26761ca3b13e33fda66196afc9a19</Hash>
</Codenesium>*/