...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IProductReviewModelValidator validator { get; set; }

		public ProductReviewFilter(IProductReviewModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ProductReviewModel>().ToList();
...
/*<Codenesium>
    <Hash>9d6e16c5e53df4daff4e07815ef12931</Hash>
</Codenesium>*/