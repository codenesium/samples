...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IWorkOrderModelValidator validator { get; set; }

		public WorkOrderFilter(IWorkOrderModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<WorkOrderModel>().ToList();
...
/*<Codenesium>
    <Hash>fb03706b1257bffffcbbf8ca86c891b3</Hash>
</Codenesium>*/