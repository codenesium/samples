...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IPasswordModelValidator validator { get; set; }

		public PasswordFilter(IPasswordModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<PasswordModel>().ToList();
...
/*<Codenesium>
    <Hash>3171fa14d9afacf7696b2cd8bdfee83f</Hash>
</Codenesium>*/