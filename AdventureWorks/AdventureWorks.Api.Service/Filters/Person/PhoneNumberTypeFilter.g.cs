...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IPhoneNumberTypeModelValidator validator { get; set; }

		public PhoneNumberTypeFilter(IPhoneNumberTypeModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<PhoneNumberTypeModel>().ToList();
...
/*<Codenesium>
    <Hash>67dcbf0552562782eda818334d3ae249</Hash>
</Codenesium>*/