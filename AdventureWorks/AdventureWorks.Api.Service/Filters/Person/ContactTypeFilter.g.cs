...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IContactTypeModelValidator validator { get; set; }

		public ContactTypeFilter(IContactTypeModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ContactTypeModel>().ToList();
...
/*<Codenesium>
    <Hash>24ef6b94bf98053cd3bd3d723f297052</Hash>
</Codenesium>*/