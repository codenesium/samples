...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ICountryRegionModelValidator validator { get; set; }

		public CountryRegionFilter(ICountryRegionModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<CountryRegionModel>().ToList();
...
/*<Codenesium>
    <Hash>74bef062b058e3284de947e2bf89c171</Hash>
</Codenesium>*/