...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IBusinessEntityModelValidator validator { get; set; }

		public BusinessEntityFilter(IBusinessEntityModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<BusinessEntityModel>().ToList();
...
/*<Codenesium>
    <Hash>fe970252a03fba297ff34dbcac5940bd</Hash>
</Codenesium>*/