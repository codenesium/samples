...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IEmailAddressModelValidator validator { get; set; }

		public EmailAddressFilter(IEmailAddressModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<EmailAddressModel>().ToList();
...
/*<Codenesium>
    <Hash>c86fbcfc1fb3d92bf37ecd8a9428a527</Hash>
</Codenesium>*/