...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IAddressModelValidator validator { get; set; }

		public AddressFilter(IAddressModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<AddressModel>().ToList();
...
/*<Codenesium>
    <Hash>611e176dec808244fd4cb8362565e6d0</Hash>
</Codenesium>*/