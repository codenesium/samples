...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IEmployeePayHistoryModelValidator validator { get; set; }

		public EmployeePayHistoryFilter(IEmployeePayHistoryModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<EmployeePayHistoryModel>().ToList();
...
/*<Codenesium>
    <Hash>ff846d5e537de6b8db0ae46562295a60</Hash>
</Codenesium>*/