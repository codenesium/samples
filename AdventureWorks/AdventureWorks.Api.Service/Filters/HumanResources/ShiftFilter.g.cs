...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IShiftModelValidator validator { get; set; }

		public ShiftFilter(IShiftModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ShiftModel>().ToList();
...
/*<Codenesium>
    <Hash>9a22ac58370eca7eeacf5a273608200f</Hash>
</Codenesium>*/