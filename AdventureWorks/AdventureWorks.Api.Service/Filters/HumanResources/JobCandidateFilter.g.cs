...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IJobCandidateModelValidator validator { get; set; }

		public JobCandidateFilter(IJobCandidateModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<JobCandidateModel>().ToList();
...
/*<Codenesium>
    <Hash>f12815f25e18ef076c31abb5e042a9ce</Hash>
</Codenesium>*/