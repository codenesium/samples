...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IDepartmentModelValidator validator { get; set; }

		public DepartmentFilter(IDepartmentModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<DepartmentModel>().ToList();
...
/*<Codenesium>
    <Hash>870d6dc81660169a513954be60db471a</Hash>
</Codenesium>*/