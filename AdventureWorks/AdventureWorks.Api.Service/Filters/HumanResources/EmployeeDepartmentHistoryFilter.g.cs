...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IEmployeeDepartmentHistoryModelValidator validator { get; set; }

		public EmployeeDepartmentHistoryFilter(IEmployeeDepartmentHistoryModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<EmployeeDepartmentHistoryModel>().ToList();
...
/*<Codenesium>
    <Hash>0f289396b8b790cd7dc0d73dac2fd180</Hash>
</Codenesium>*/