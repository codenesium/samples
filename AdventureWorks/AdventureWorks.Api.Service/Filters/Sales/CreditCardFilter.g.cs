...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ICreditCardModelValidator validator { get; set; }

		public CreditCardFilter(ICreditCardModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<CreditCardModel>().ToList();
...
/*<Codenesium>
    <Hash>607671895010d1c30f1389061bdebb0b</Hash>
</Codenesium>*/