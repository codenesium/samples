...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ISpecialOfferProductModelValidator validator { get; set; }

		public SpecialOfferProductFilter(ISpecialOfferProductModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SpecialOfferProductModel>().ToList();
...
/*<Codenesium>
    <Hash>13a39134d8b34f044e35d4fde9450ab3</Hash>
</Codenesium>*/