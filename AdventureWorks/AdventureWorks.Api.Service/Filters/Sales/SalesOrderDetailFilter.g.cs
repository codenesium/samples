...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ISalesOrderDetailModelValidator validator { get; set; }

		public SalesOrderDetailFilter(ISalesOrderDetailModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SalesOrderDetailModel>().ToList();
...
/*<Codenesium>
    <Hash>4474de3c859704e133749c7c0815dca4</Hash>
</Codenesium>*/