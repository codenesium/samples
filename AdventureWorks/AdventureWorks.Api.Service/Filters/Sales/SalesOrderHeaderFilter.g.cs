...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ISalesOrderHeaderModelValidator validator { get; set; }

		public SalesOrderHeaderFilter(ISalesOrderHeaderModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SalesOrderHeaderModel>().ToList();
...
/*<Codenesium>
    <Hash>3d51d81026ed6c372bf33bada78bada9</Hash>
</Codenesium>*/