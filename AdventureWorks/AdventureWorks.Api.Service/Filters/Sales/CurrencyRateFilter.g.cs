...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ICurrencyRateModelValidator validator { get; set; }

		public CurrencyRateFilter(ICurrencyRateModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<CurrencyRateModel>().ToList();
...
/*<Codenesium>
    <Hash>aff4d6c3c331c44d6495a427c11084c4</Hash>
</Codenesium>*/