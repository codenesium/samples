...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ISalesOrderHeaderSalesReasonModelValidator validator { get; set; }

		public SalesOrderHeaderSalesReasonFilter(ISalesOrderHeaderSalesReasonModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SalesOrderHeaderSalesReasonModel>().ToList();
...
/*<Codenesium>
    <Hash>cb146592a728a36e4765f6c17fd5feeb</Hash>
</Codenesium>*/