...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ICurrencyModelValidator validator { get; set; }

		public CurrencyFilter(ICurrencyModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<CurrencyModel>().ToList();
...
/*<Codenesium>
    <Hash>4986ff635def1f7ebaa937bf3a777305</Hash>
</Codenesium>*/