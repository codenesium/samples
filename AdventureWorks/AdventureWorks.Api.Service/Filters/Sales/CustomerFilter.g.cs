...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ICustomerModelValidator validator { get; set; }

		public CustomerFilter(ICustomerModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<CustomerModel>().ToList();
...
/*<Codenesium>
    <Hash>07d6ef9421ce81a11e4e053fd505d34f</Hash>
</Codenesium>*/