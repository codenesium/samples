...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IPersonCreditCardModelValidator validator { get; set; }

		public PersonCreditCardFilter(IPersonCreditCardModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<PersonCreditCardModel>().ToList();
...
/*<Codenesium>
    <Hash>bca1a32702626deb03264aaf13e8caa7</Hash>
</Codenesium>*/