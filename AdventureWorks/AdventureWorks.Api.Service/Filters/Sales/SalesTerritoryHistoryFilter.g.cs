...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ISalesTerritoryHistoryModelValidator validator { get; set; }

		public SalesTerritoryHistoryFilter(ISalesTerritoryHistoryModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SalesTerritoryHistoryModel>().ToList();
...
/*<Codenesium>
    <Hash>be64ce34da6c80cdbb19c8fe86c31cac</Hash>
</Codenesium>*/