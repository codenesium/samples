...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IStoreModelValidator validator { get; set; }

		public StoreFilter(IStoreModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<StoreModel>().ToList();
...
/*<Codenesium>
    <Hash>af2e55260c5a9aaad90ffeac522667c8</Hash>
</Codenesium>*/