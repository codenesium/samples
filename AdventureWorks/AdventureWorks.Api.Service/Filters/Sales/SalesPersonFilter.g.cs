...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ISalesPersonModelValidator validator { get; set; }

		public SalesPersonFilter(ISalesPersonModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SalesPersonModel>().ToList();
...
/*<Codenesium>
    <Hash>392656b6c19c2957e338b55a06cb2e3f</Hash>
</Codenesium>*/