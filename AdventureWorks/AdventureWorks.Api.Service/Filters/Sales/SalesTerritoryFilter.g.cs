...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ISalesTerritoryModelValidator validator { get; set; }

		public SalesTerritoryFilter(ISalesTerritoryModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SalesTerritoryModel>().ToList();
...
/*<Codenesium>
    <Hash>595ee0b882f1c87689946d013829c947</Hash>
</Codenesium>*/