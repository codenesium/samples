...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IShoppingCartItemModelValidator validator { get; set; }

		public ShoppingCartItemFilter(IShoppingCartItemModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ShoppingCartItemModel>().ToList();
...
/*<Codenesium>
    <Hash>155325954fe03a40b557638a0221e8d6</Hash>
</Codenesium>*/