...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		ISalesTaxRateModelValidator validator { get; set; }

		public SalesTaxRateFilter(ISalesTaxRateModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SalesTaxRateModel>().ToList();
...
/*<Codenesium>
    <Hash>31e9990b52f4feee5437cc02a5ebaae0</Hash>
</Codenesium>*/