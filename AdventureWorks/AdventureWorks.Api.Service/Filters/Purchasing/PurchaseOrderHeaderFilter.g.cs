...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IPurchaseOrderHeaderModelValidator validator { get; set; }

		public PurchaseOrderHeaderFilter(IPurchaseOrderHeaderModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<PurchaseOrderHeaderModel>().ToList();
...
/*<Codenesium>
    <Hash>b4ca6102ec1df78641761237cdd2c583</Hash>
</Codenesium>*/