...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IProductVendorModelValidator validator { get; set; }

		public ProductVendorFilter(IProductVendorModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ProductVendorModel>().ToList();
...
/*<Codenesium>
    <Hash>2b8228f4d68d5c8ce5853879cf903595</Hash>
</Codenesium>*/