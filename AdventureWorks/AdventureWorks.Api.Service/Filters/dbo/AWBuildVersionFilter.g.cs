...
namespace AdventureWorksNS.Api.Service
{
	...
	{
		IAWBuildVersionModelValidator validator { get; set; }

		public AWBuildVersionFilter(IAWBuildVersionModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<AWBuildVersionModel>().ToList();
...
/*<Codenesium>
    <Hash>4595d6f7948749c5aac53854558d10fc</Hash>
</Codenesium>*/