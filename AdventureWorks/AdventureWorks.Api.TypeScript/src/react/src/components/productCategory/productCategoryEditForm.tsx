...
> {
  ...
  submit = (model: ProductCategoryViewModel) => {
    let mapper = new ProductCategoryMapper();
    axios
      .put<CreateResponse<Api.ProductCategoryClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.ProductCategories +
          '/' +
...
export const WrappedProductCategoryEditComponent = Form.create({
  name: 'ProductCategory Edit',
})(ProductCategoryEditComponent);


/*<Codenesium>
    <Hash>5a277deff657310e598d9ca73d77503b</Hash>
</Codenesium>*/