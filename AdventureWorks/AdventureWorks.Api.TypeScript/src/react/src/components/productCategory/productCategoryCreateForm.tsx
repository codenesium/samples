...
export const WrappedProductCategoryCreateComponent = Form.create({ name: 'ProductCategory Create' })(ProductCategoryCreateComponent);

/*<Codenesium>
    <Hash>4a9b4ab4c595fe92703a7b9141f81771</Hash>
</Codenesium>*/