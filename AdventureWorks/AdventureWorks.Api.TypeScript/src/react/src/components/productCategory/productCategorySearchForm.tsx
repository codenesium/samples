...
> {
  ...
  handleEditClick(e: any, row: ProductCategoryViewModel) {
    this.props.history.push(
      ClientRoutes.ProductCategories + '/edit/' + row.productCategoryID
    );
  }

  handleDetailClick(e: any, row: ProductCategoryViewModel) {
    this.props.history.push(
      ClientRoutes.ProductCategories + '/' + row.productCategoryID
    );
  }
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.ProductCategories + '?limit=100';
...
export const WrappedProductCategorySearchComponent = Form.create({
  name: 'ProductCategory Search',
})(ProductCategorySearchComponent);


/*<Codenesium>
    <Hash>6aaeee3543b0c6e22bbe059893c162f5</Hash>
</Codenesium>*/