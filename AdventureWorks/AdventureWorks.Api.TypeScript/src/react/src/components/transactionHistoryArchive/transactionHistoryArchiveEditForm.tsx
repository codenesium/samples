 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new TransactionHistoryArchiveMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.TransactionHistoryArchives + '/' + this.state.model!.transactionID,
...
export const WrappedTransactionHistoryArchiveEditComponent = Form.create({ name: 'TransactionHistoryArchive Edit' })(TransactionHistoryArchiveEditComponent);

/*<Codenesium>
    <Hash>cd680b44fa160ebf68e484263e4f71a8</Hash>
</Codenesium>*/