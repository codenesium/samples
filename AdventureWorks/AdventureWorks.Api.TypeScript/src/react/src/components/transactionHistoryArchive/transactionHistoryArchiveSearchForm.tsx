...
export default class TransactionHistoryArchiveSearchComponent extends React.Component<TransactionHistoryArchiveSearchComponentProps, TransactionHistoryArchiveSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<TransactionHistoryArchiveViewModel>(), filteredRecords:new Array<TransactionHistoryArchiveViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedTransactionHistoryArchiveSearchComponent = Form.create({ name: 'TransactionHistoryArchive Search' })(TransactionHistoryArchiveSearchComponent);

/*<Codenesium>
    <Hash>5a806a760c98edd93e34481ae782944d</Hash>
</Codenesium>*/