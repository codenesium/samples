...
import TransactionHistoryViewModel from  './transactionHistoryViewModel';
	...
	mapApiResponseToViewModel(dto: Api.TransactionHistoryClientResponseModel) : TransactionHistoryViewModel 
	{
	...
	mapViewModelToApiRequest(model: TransactionHistoryViewModel) : Api.TransactionHistoryClientRequestModel
	{
...
/*<Codenesium>
    <Hash>4ceac83d41756ad4b4ac32b93f6b45c4</Hash>
</Codenesium>*/