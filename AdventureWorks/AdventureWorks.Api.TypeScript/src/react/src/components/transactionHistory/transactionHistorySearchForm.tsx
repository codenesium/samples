...
> {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.TransactionHistories + '?limit=100';
    ...
    axios
      .get<Array<Api.TransactionHistoryClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedTransactionHistorySearchComponent = Form.create({
  name: 'TransactionHistory Search',
})(TransactionHistorySearchComponent);


/*<Codenesium>
    <Hash>91d4ef76a96941ecfcea94a8b09eaca1</Hash>
</Codenesium>*/