 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new TransactionHistoryMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.TransactionHistories + '/' + this.state.model!.transactionID,
...
export const WrappedTransactionHistoryEditComponent = Form.create({ name: 'TransactionHistory Edit' })(TransactionHistoryEditComponent);

/*<Codenesium>
    <Hash>5fc1ad1a74a8df5bb4dcdd0947b08fdd</Hash>
</Codenesium>*/