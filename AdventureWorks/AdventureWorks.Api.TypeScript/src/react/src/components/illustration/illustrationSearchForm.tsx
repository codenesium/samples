...
> {
  ...
  handleEditClick(e: any, row: IllustrationViewModel) {
    this.props.history.push(
      ClientRoutes.Illustrations + '/edit/' + row.illustrationID
    );
  }

  handleDetailClick(e: any, row: IllustrationViewModel) {
    this.props.history.push(
      ClientRoutes.Illustrations + '/' + row.illustrationID
    );
  }
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.Illustrations + '?limit=100';
    ...
    axios
      .get<Array<Api.IllustrationClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedIllustrationSearchComponent = Form.create({
  name: 'Illustration Search',
})(IllustrationSearchComponent);


/*<Codenesium>
    <Hash>bc997ba42a76a8f96bc80048f0b6e8b6</Hash>
</Codenesium>*/