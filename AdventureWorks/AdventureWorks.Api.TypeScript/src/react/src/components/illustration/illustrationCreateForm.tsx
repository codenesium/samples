      ...
      return <Spin size="large" />;
        ...
        return ( 
         <Form onSubmit={this.handleSubmit}>
              ...
              ( <DatePicker format={'YYYY-MM-DD'} placeholder={"Diagram"} /> )}
              </Form.Item>
...
export const WrappedIllustrationCreateComponent = Form.create({ name: 'Illustration Create' })(IllustrationCreateComponent);

/*<Codenesium>
    <Hash>60fdefc5f903ac5731843add78aa90ff</Hash>
</Codenesium>*/