...
export default class WorkOrderSearchComponent extends React.Component<WorkOrderSearchComponentProps, WorkOrderSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<WorkOrderViewModel>(), filteredRecords:new Array<WorkOrderViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedWorkOrderSearchComponent = Form.create({ name: 'WorkOrder Search' })(WorkOrderSearchComponent);

/*<Codenesium>
    <Hash>24a7352394bf5c6c145578744cf3a138</Hash>
</Codenesium>*/