...
> {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.ScrapReasons + '?limit=100';
    ...
    axios
      .get<Array<Api.ScrapReasonClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedScrapReasonSearchComponent = Form.create({
  name: 'ScrapReason Search',
})(ScrapReasonSearchComponent);


/*<Codenesium>
    <Hash>8b0511934d439bca51000242374ada82</Hash>
</Codenesium>*/