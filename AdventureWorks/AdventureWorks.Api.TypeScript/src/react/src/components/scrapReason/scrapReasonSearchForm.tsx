...
export default class ScrapReasonSearchComponent extends React.Component<ScrapReasonSearchComponentProps, ScrapReasonSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ScrapReasonViewModel>(), filteredRecords:new Array<ScrapReasonViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
