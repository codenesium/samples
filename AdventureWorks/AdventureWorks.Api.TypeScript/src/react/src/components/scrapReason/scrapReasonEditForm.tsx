...
interface Props {
  ...
  const ScrapReasonEditDisplay = (props: FormikProps<ScrapReasonViewModel>) => {
   ...
   let status = props.status as UpdateResponse<Api.ScrapReasonClientRequestModel>;
...
const ScrapReasonEdit = withFormik<Props, ScrapReasonViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.ScrapReasons +'/' + values.scrapReasonID,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.ScrapReasonClientRequestModel>;
  ...
  export default class ScrapReasonEditComponent extends React.Component<ScrapReasonEditComponentProps, ScrapReasonEditComponentState> {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<ScrapReasonEdit model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>a5c08b1a98766762a3e457d92c9cfed2</Hash>
</Codenesium>*/