...
export const WrappedScrapReasonCreateComponent = Form.create({ name: 'ScrapReason Create' })(ScrapReasonCreateComponent);

/*<Codenesium>
    <Hash>26c74caa899be5b64fb9a1c8c265a5ba</Hash>
</Codenesium>*/