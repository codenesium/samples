...
> {
  ...
  submit = (model: UnitMeasureViewModel) => {
    let mapper = new UnitMeasureMapper();
    axios
      .put<CreateResponse<Api.UnitMeasureClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.UnitMeasures +
          '/' +
...
export const WrappedUnitMeasureEditComponent = Form.create({
  name: 'UnitMeasure Edit',
})(UnitMeasureEditComponent);


/*<Codenesium>
    <Hash>4632ef9f55ffaff4bda71a3760d8bf64</Hash>
</Codenesium>*/