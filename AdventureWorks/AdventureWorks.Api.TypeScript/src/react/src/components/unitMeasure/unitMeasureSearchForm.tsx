...
> {
  ...
  handleEditClick(e: any, row: UnitMeasureViewModel) {
    this.props.history.push(
      ClientRoutes.UnitMeasures + '/edit/' + row.unitMeasureCode
    );
  }

  handleDetailClick(e: any, row: UnitMeasureViewModel) {
    this.props.history.push(
      ClientRoutes.UnitMeasures + '/' + row.unitMeasureCode
    );
  }
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.UnitMeasures + '?limit=100';
...
export const WrappedUnitMeasureSearchComponent = Form.create({
  name: 'UnitMeasure Search',
})(UnitMeasureSearchComponent);


/*<Codenesium>
    <Hash>1e587f31b8aac7b0d1d13a1cc3ad549d</Hash>
</Codenesium>*/