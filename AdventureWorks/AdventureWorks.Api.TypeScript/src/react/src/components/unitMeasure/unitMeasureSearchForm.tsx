...
export default class UnitMeasureSearchComponent extends React.Component<UnitMeasureSearchComponentProps, UnitMeasureSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<UnitMeasureViewModel>(), filteredRecords:new Array<UnitMeasureViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedUnitMeasureSearchComponent = Form.create({ name: 'UnitMeasure Search' })(UnitMeasureSearchComponent);

/*<Codenesium>
    <Hash>d3d6653211af85b5c796f78b7b474b87</Hash>
</Codenesium>*/