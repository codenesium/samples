...
export const WrappedPhoneNumberTypeCreateComponent = Form.create({
  name: 'PhoneNumberType Create',
})(PhoneNumberTypeCreateComponent);


/*<Codenesium>
    <Hash>b43834e030a1d4b19680e77ce38b9ad8</Hash>
</Codenesium>*/