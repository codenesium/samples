...
export default class CurrencySearchComponent extends React.Component<CurrencySearchComponentProps, CurrencySearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<CurrencyViewModel>(), filteredRecords:new Array<CurrencyViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
