...
export default class StateProvinceSearchComponent extends React.Component<StateProvinceSearchComponentProps, StateProvinceSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<StateProvinceViewModel>(), filteredRecords:new Array<StateProvinceViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
