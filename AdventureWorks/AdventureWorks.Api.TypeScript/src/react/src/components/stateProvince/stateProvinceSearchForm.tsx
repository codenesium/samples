...
> {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.StateProvinces + '?limit=100';
    ...
    axios
      .get<Array<Api.StateProvinceClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedStateProvinceSearchComponent = Form.create({
  name: 'StateProvince Search',
})(StateProvinceSearchComponent);


/*<Codenesium>
    <Hash>f76e95253e43b351db858ca6cc05e613</Hash>
</Codenesium>*/