...
class AddressTypeCreateComponent extends React.Component<
...
> {
  ...
  submit = (model: AddressTypeViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.AddressTypeClientRequestModel>>(
...
export const WrappedAddressTypeCreateComponent = Form.create({
  name: 'AddressType Create',
})(AddressTypeCreateComponent);


/*<Codenesium>
    <Hash>b91956159dfdde6bc0263e5dfe702144</Hash>
</Codenesium>*/