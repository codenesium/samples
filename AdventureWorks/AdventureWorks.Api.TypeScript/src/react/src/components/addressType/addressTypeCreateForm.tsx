...
export const WrappedAddressTypeCreateComponent = Form.create({ name: 'AddressType Create' })(AddressTypeCreateComponent);

/*<Codenesium>
    <Hash>c403bd4222d7b4745f222296dd0bc1c1</Hash>
</Codenesium>*/