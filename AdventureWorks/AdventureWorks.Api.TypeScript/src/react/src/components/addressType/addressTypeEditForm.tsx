...
> {
  ...
  submit = (model: AddressTypeViewModel) => {
    let mapper = new AddressTypeMapper();
    axios
      .put<CreateResponse<Api.AddressTypeClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.AddressTypes +
          '/' +
...
export const WrappedAddressTypeEditComponent = Form.create({
  name: 'AddressType Edit',
})(AddressTypeEditComponent);


/*<Codenesium>
    <Hash>29ac9e8bf7950feee3b29f646e30305d</Hash>
</Codenesium>*/