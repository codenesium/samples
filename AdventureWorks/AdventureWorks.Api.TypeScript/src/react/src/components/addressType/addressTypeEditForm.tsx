...
class AddressTypeEditComponent extends React.Component<
...
> {
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
     ...
     this.props.form.validateFields((err:any, values:any) => {
      if (!err) {
        let model = values as AddressTypeViewModel;
  ...
  submit = (model:AddressTypeViewModel) =>
  {  
    let mapper = new AddressTypeMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.AddressTypes + '/' + this.state.model!.addressTypeID,
...
export const WrappedAddressTypeEditComponent = Form.create({ name: 'AddressType Edit' })(AddressTypeEditComponent);

/*<Codenesium>
    <Hash>c576abde541687d5bd9ea33fc1fc3307</Hash>
</Codenesium>*/