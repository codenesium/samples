...
> {
  ...
  submit = (model: SalesTaxRateViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.SalesTaxRateClientRequestModel>>(
...
export const WrappedSalesTaxRateCreateComponent = Form.create({
  name: 'SalesTaxRate Create',
})(SalesTaxRateCreateComponent);


/*<Codenesium>
    <Hash>f4c49b0146c1384990112e098725cd24</Hash>
</Codenesium>*/