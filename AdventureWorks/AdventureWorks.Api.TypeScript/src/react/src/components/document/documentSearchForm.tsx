...
export default class DocumentSearchComponent extends React.Component<DocumentSearchComponentProps, DocumentSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<DocumentViewModel>(), filteredRecords:new Array<DocumentViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
