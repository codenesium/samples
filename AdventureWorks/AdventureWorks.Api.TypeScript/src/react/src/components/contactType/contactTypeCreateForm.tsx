...
class ContactTypeCreateComponent extends React.Component<
...
> {
  ...
  handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    this.props.form.validateFields((err: any, values: any) => {
      if (!err) {
        let model = values as ContactTypeViewModel;
        this.submit(model);
      } else {
  ...
  submit = (model: ContactTypeViewModel) => {
    let mapper = new ContactTypeMapper();
    axios
      .post<CreateResponse<Api.ContactTypeClientRequestModel>>(
        Constants.ApiEndpoint + ApiRoutes.ContactTypes,
...
export const WrappedContactTypeCreateComponent = Form.create({
  name: 'ContactType Create',
})(ContactTypeCreateComponent);


/*<Codenesium>
    <Hash>dd3258170abd6922a988318e8e752ec6</Hash>
</Codenesium>*/