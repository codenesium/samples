...
interface Props {
   ...
   const ContactTypeCreateDisplay: React.SFC<FormikProps<ContactTypeViewModel>> = (props: FormikProps<ContactTypeViewModel>) => {

   let status = props.status as CreateResponse<Api.ContactTypeClientRequestModel>;
...
const ContactTypeCreate = withFormik<Props, ContactTypeViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.ContactTypes,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.ContactTypeClientRequestModel>;
  ...
  export default class ContactTypeCreateComponent extends React.Component<ContactTypeCreateComponentProps, ContactTypeCreateComponentState> {
...
/*<Codenesium>
    <Hash>2dee74b64994f95cf576c685f6689688</Hash>
</Codenesium>*/