...
export const WrappedContactTypeCreateComponent = Form.create({ name: 'ContactType Create' })(ContactTypeCreateComponent);

/*<Codenesium>
    <Hash>5fe293344b54bf93ed4d1988dca2e47b</Hash>
</Codenesium>*/