...
class ContactTypeEditComponent extends React.Component<
...
> {
  ...
  submit = (model: ContactTypeViewModel) => {
    let mapper = new ContactTypeMapper();
    axios
      .put<CreateResponse<Api.ContactTypeClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.ContactTypes +
          '/' +
...
export const WrappedContactTypeEditComponent = Form.create({
  name: 'ContactType Edit',
})(ContactTypeEditComponent);


/*<Codenesium>
    <Hash>b5f60b7c837e90b053ff7420fe6d8b01</Hash>
</Codenesium>*/