...
> {
  ...
  handleEditClick(e:any) {
    this.props.history.push(ClientRoutes.ContactTypes + '/edit/' + this.state.model!.contactTypeID);
  }
      ...
      return (
		...
		<Button 
		 ...
		 <div>
			...
			apiRoute={Constants.ApiEndpoint + ApiRoutes.ContactTypes + '/' + this.state.model!.contactTypeID + '/' + ApiRoutes.BusinessEntityContacts}
			/>
         </div>
...
export const WrappedContactTypeDetailComponent = Form.create({ name: 'ContactType Detail' })(
  ContactTypeDetailComponent
);

/*<Codenesium>
    <Hash>82f97346302a9ce7e460241e9a49e48b</Hash>
</Codenesium>*/