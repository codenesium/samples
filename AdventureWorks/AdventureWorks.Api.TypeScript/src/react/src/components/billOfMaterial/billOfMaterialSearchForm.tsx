...
export default class BillOfMaterialSearchComponent extends React.Component<BillOfMaterialSearchComponentProps, BillOfMaterialSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<BillOfMaterialViewModel>(), filteredRecords:new Array<BillOfMaterialViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedBillOfMaterialSearchComponent = Form.create({ name: 'BillOfMaterial Search' })(BillOfMaterialSearchComponent);

/*<Codenesium>
    <Hash>50007702eb137608de8b9ecc94751703</Hash>
</Codenesium>*/