...
> {
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.SalesPersonClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedSalesPersonSearchComponent = Form.create({
  name: 'SalesPerson Search',
})(SalesPersonSearchComponent);


/*<Codenesium>
    <Hash>42e2ad0def58e854c2e9b2442c36026a</Hash>
</Codenesium>*/