...
export default class SalesPersonSearchComponent extends React.Component<SalesPersonSearchComponentProps, SalesPersonSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<SalesPersonViewModel>(),filteredRecords:new Array<SalesPersonViewModel>(), loading:false, loaded:false, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>8e55830061ea554dff0cdff580e42d5a</Hash>
</Codenesium>*/