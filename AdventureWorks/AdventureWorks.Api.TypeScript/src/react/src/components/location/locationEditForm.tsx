...
> {
  ...
  submit = (model: LocationViewModel) => {
    let mapper = new LocationMapper();
    axios
      .put<CreateResponse<Api.LocationClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.Locations +
          '/' +
      ...
      return (
        <Form onSubmit={this.handleSubmit}>
          <Form.Item>
            ...
            })(<InputNumber placeholder={'Availability'} />)}
          </Form.Item>
          ...
          <Form.Item>
            ...
            {getFieldDecorator('costRate', {
              rules: [{ required: true, message: 'Required' }],
            })(<InputNumber placeholder={'Cost Rate'} />)}
          </Form.Item>
...
/*<Codenesium>
    <Hash>487cfadd6070fe6a3e4240e6e3a45a26</Hash>
</Codenesium>*/