 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new SalesTerritoryMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.SalesTerritories + '/' + this.state.model!.territoryID,
...
export const WrappedSalesTerritoryEditComponent = Form.create({ name: 'SalesTerritory Edit' })(SalesTerritoryEditComponent);

/*<Codenesium>
    <Hash>3d2500d790aa6070f896ea6723f57f18</Hash>
</Codenesium>*/