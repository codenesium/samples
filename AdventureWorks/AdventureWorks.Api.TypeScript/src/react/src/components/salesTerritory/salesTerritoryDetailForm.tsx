...
> {
  ...
  handleEditClick(e:any) {
    this.props.history.push(ClientRoutes.SalesTerritories + '/edit/' + this.state.model!.territoryID);
  }
      ...
      return (
		...
		<Button 
		 ...
		 <div>
			...
			apiRoute={Constants.ApiEndpoint + ApiRoutes.SalesTerritories + '/' + this.state.model!.territoryID + '/' + ApiRoutes.Customers}
			/>
         </div>
			 <div>
			...
			history={this.props.history} 
			match={this.props.match} 
			apiRoute={Constants.ApiEndpoint + ApiRoutes.SalesTerritories + '/' + this.state.model!.territoryID + '/' + ApiRoutes.SalesOrderHeaders}
			/>
         </div>
			 <div>
            <h3>SalesPersons</h3>
			...
			history={this.props.history} 
			match={this.props.match} 
			apiRoute={Constants.ApiEndpoint + ApiRoutes.SalesTerritories + '/' + this.state.model!.territoryID + '/' + ApiRoutes.SalesPersons}
			/>
         </div>
			 <div>
			...
			history={this.props.history} 
			match={this.props.match} 
			apiRoute={Constants.ApiEndpoint + ApiRoutes.SalesTerritories + '/' + this.state.model!.territoryID + '/' + ApiRoutes.SalesTerritoryHistories}
			/>
         </div>
...
export const WrappedSalesTerritoryDetailComponent = Form.create({ name: 'SalesTerritory Detail' })(
  SalesTerritoryDetailComponent
);

/*<Codenesium>
    <Hash>d8bf841b2c09399f5f2096c901512da6</Hash>
</Codenesium>*/