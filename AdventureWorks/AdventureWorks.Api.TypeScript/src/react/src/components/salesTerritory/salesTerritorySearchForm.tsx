...
export default class SalesTerritorySearchComponent extends React.Component<SalesTerritorySearchComponentProps, SalesTerritorySearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<SalesTerritoryViewModel>(),filteredRecords:new Array<SalesTerritoryViewModel>(), loading:false, loaded:false, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>82b1dee667810d1a9ba669ea558d7374</Hash>
</Codenesium>*/