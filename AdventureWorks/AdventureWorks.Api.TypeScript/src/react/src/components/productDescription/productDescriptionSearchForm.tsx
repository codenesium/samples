...
export default class ProductDescriptionSearchComponent extends React.Component<ProductDescriptionSearchComponentProps, ProductDescriptionSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ProductDescriptionViewModel>(), filteredRecords:new Array<ProductDescriptionViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
