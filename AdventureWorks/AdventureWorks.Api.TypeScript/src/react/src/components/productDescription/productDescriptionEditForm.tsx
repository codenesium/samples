 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new ProductDescriptionMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.ProductDescriptions + '/' + this.state.model!.productDescriptionID,
...
export const WrappedProductDescriptionEditComponent = Form.create({ name: 'ProductDescription Edit' })(ProductDescriptionEditComponent);

/*<Codenesium>
    <Hash>04a6f72885dacec83f18e1eb30b43d03</Hash>
</Codenesium>*/