...
export const WrappedProductDescriptionCreateComponent = Form.create({ name: 'ProductDescription Create' })(ProductDescriptionCreateComponent);

/*<Codenesium>
    <Hash>4019324da0a74339507760cea6efcae4</Hash>
</Codenesium>*/