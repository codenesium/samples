...
> {
  ...
  render() {
    ...
    if (this.state.loading) {
      ...
      return (
        <Form.Item>
          <label htmlFor={this.props.propertyName}>Database Log</label>
          <br />
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map((x: DatabaseLogViewModel) => {
                return (
                  <Select.Option key={x.databaseLogID} value={x.databaseLogID}>
                    {x.toDisplay()}
                  </Select.Option>
                );
              })}
...
/*<Codenesium>
    <Hash>9c2a72a5a4b5c4f5bc6fbc45c52dc80a</Hash>
</Codenesium>*/