...
> {
  ...
  componentDidMount() {
    ...
    axios
      .get<Array<Api.SalesReasonClientResponseModel>>(this.props.apiRoute, {
  ...
  render() {
    ...
    if (this.state.loading) {
      ...
      return (
        <Form.Item>
          <label htmlFor={this.props.propertyName}>Sales Reason</label>
          <br />
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map((x: SalesReasonViewModel) => {
                return (
                  <Select.Option key={x.salesReasonID} value={x.salesReasonID}>
                    {x.toDisplay()}
                  </Select.Option>
                );
              })}
...
/*<Codenesium>
    <Hash>ec62fdae33c78a71c6ae3338e3bbe711</Hash>
</Codenesium>*/