...
> {
  ...
  componentDidMount() {
    ...
    axios
      .get<Array<Api.PhoneNumberTypeClientResponseModel>>(this.props.apiRoute, {
  ...
  render() {
    ...
    if (this.state.loading) {
      ...
      return (
        <Form.Item>
          <label htmlFor={this.props.propertyName}>Phone Number Type</label>
          <br />
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map((x: PhoneNumberTypeViewModel) => {
                return (
                  <Select.Option
                    key={x.phoneNumberTypeID}
                    value={x.phoneNumberTypeID}
                  >
                    {x.toDisplay()}
                  </Select.Option>
                );
...
/*<Codenesium>
    <Hash>c3eb726bca1da0e3dda8cae704b2004f</Hash>
</Codenesium>*/