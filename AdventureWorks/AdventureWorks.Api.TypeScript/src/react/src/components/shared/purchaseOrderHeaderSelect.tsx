    ...
    if (this.state.loading) {
      ...
      return (
        <div>
        {
          ...
          <Select>
          {
            this.state.filteredRecords.map((x:PurchaseOrderHeaderViewModel) =>
            {
                return <Select.Option value={x.purchaseOrderID}>{x.toDisplay()}</Select.Option>;
            })
          }
          </Select>
        )
...
/*<Codenesium>
    <Hash>d7f9d5e6cd92b65bdbaf4df1935a6879</Hash>
</Codenesium>*/