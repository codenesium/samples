    ...
    if (this.state.loading) {
      ...
      return (
        <div>
        {
          ...
          <Select>
          {
            this.state.filteredRecords.map((x:ShoppingCartItemViewModel) =>
            {
                return <Select.Option value={x.shoppingCartItemID}>{x.toDisplay()}</Select.Option>;
            })
          }
          </Select>
        )
...
/*<Codenesium>
    <Hash>ae3116a525381f9b055cb559af979fec</Hash>
</Codenesium>*/