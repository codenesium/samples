...
> {
  ...
  componentDidMount() {
    ...
    axios
      .get<Array<Api.AddressTypeClientResponseModel>>(this.props.apiRoute, {
  ...
  render() {
    ...
    if (this.state.loading) {
      ...
      return (
        <Form.Item>
          <label htmlFor={this.props.propertyName}>Address Type</label>
          <br />
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map((x: AddressTypeViewModel) => {
                return (
                  <Select.Option key={x.addressTypeID} value={x.addressTypeID}>
                    {x.toDisplay()}
                  </Select.Option>
                );
              })}
...
/*<Codenesium>
    <Hash>b27f31d6dea003b912fb18bcd91ecef2</Hash>
</Codenesium>*/