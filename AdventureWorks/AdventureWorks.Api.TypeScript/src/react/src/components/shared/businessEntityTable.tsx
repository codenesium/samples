...
interface BusinessEntityTableComponentState {
  loading: boolean;
  loaded: boolean;
...
> {
  ...
  loadRecords() {
    ...
    axios
      .get<Array<Api.BusinessEntityClientResponseModel>>(this.props.apiRoute, {
      ...
      .then(response => {
        ...
        this.setState({
          ...this.state,
          filteredRecords: businessEntities,
          loading: false,
          loaded: true,
          errorOccurred: false,
          errorMessage: '',
...
/*<Codenesium>
    <Hash>67812b8b506da3ef39753ab92060870b</Hash>
</Codenesium>*/