...
> {
  ...
  componentDidMount() {
    ...
    axios
      .get<Array<Api.CultureClientResponseModel>>(this.props.apiRoute, {
  ...
  render() {
    ...
    if (this.state.loading) {
      ...
      return (
        <Form.Item>
          <label htmlFor={this.props.propertyName}>Culture</label>
          <br />
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map((x: CultureViewModel) => {
                return (
                  <Select.Option key={x.cultureID} value={x.cultureID}>
                    {x.toDisplay()}
                  </Select.Option>
                );
              })}
...
/*<Codenesium>
    <Hash>95eb64246f68fe384e67b19438e23f08</Hash>
</Codenesium>*/