...
> {
  ...
  componentDidMount() {
    ...
    axios
      .get<Array<Api.DepartmentClientResponseModel>>(this.props.apiRoute, {
  ...
  render() {
    ...
    if (this.state.loading) {
      ...
      return (
        <Form.Item>
          <label htmlFor={this.props.propertyName}>Department</label>
          <br />
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map((x: DepartmentViewModel) => {
                return (
                  <Select.Option key={x.departmentID} value={x.departmentID}>
                    {x.toDisplay()}
                  </Select.Option>
                );
              })}
...
/*<Codenesium>
    <Hash>be79b3dc91c55c023d0090c493f33f14</Hash>
</Codenesium>*/