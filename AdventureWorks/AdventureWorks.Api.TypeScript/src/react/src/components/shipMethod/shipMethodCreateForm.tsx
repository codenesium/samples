...
> {
  ...
  submit = (model: ShipMethodViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.ShipMethodClientRequestModel>>(
    ...
    if (this.state.loading) {
      ...
      return (
        <Form onSubmit={this.handleSubmit}>
          ...
          <Form.Item>
            <label htmlFor="shipBase">Ship Base</label>
            <br />
            {getFieldDecorator('shipBase', {
              rules: [{ required: true, message: 'Required' }],
            })(<InputNumber placeholder={'Ship Base'} />)}
          </Form.Item>

          <Form.Item>
            <label htmlFor="shipRate">Ship Rate</label>
            <br />
            {getFieldDecorator('shipRate', {
              rules: [{ required: true, message: 'Required' }],
            })(<InputNumber placeholder={'Ship Rate'} />)}
          </Form.Item>
...
/*<Codenesium>
    <Hash>06e847a0ecbd858e30a38eaf38694a1e</Hash>
</Codenesium>*/