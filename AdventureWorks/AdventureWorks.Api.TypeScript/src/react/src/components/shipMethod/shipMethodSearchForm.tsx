...
export default class ShipMethodSearchComponent extends React.Component<ShipMethodSearchComponentProps, ShipMethodSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ShipMethodViewModel>(), filteredRecords:new Array<ShipMethodViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>74b01cf650d3e6637dfaec8312ce263d</Hash>
</Codenesium>*/