...
export default class ShipMethodSearchComponent extends React.Component<ShipMethodSearchComponentProps, ShipMethodSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<ShipMethodViewModel>(), filteredRecords:new Array<ShipMethodViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleEditClick(e:any, row:Api.ShipMethodClientResponseModel) {
         this.props.history.push(ClientRoutes.ShipMethods + '/edit/' + row.shipMethodID);
    }
    ...
    handleDeleteClick(e:any, row:Api.ShipMethodClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.ShipMethods + '/' + row.shipMethodID,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.ShipMethods + '?limit=100';
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ShipMethodViewModel>(),filteredRecords:new Array<ShipMethodViewModel>(), loading:false, loaded:false, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedShipMethodSearchComponent = Form.create({ name: 'ShipMethod Search' })(ShipMethodSearchComponent);

/*<Codenesium>
    <Hash>4ff0269b0f6150198af92420d0df6950</Hash>
</Codenesium>*/