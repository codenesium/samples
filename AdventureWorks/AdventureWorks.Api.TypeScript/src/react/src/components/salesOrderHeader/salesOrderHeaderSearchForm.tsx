...
> {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.SalesOrderHeaders + '?limit=100';
    ...
    axios
      .get<Array<Api.SalesOrderHeaderClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedSalesOrderHeaderSearchComponent = Form.create({
  name: 'SalesOrderHeader Search',
})(SalesOrderHeaderSearchComponent);


/*<Codenesium>
    <Hash>bf5b3bb882b824ce30c91e89d005ec9c</Hash>
</Codenesium>*/