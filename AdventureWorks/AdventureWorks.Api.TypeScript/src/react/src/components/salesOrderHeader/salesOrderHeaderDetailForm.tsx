...
> {
  ...
  handleEditClick(e:any) {
    this.props.history.push(ClientRoutes.SalesOrderHeaders + '/edit/' + this.state.model!.salesOrderID);
  }
      ...
      return (
		...
		<Button 
		  ...
		  <div>
							...
							<h3>CreditCardID</h3>
							<p>{String(this.state.model!.creditCardIDNavigation!.toDisplay())}</p>
						 </div>
					   						 <div style={{"marginBottom":"10px"}}>
							<h3>CurrencyRateID</h3>
							<p>{String(this.state.model!.currencyRateIDNavigation!.toDisplay())}</p>
						 </div>
					   						 <div style={{"marginBottom":"10px"}}>
							<h3>CustomerID</h3>
		 ...
		 <div>
			...
			apiRoute={Constants.ApiEndpoint + ApiRoutes.SalesOrderHeaders + '/' + this.state.model!.salesOrderID + '/' + ApiRoutes.SalesOrderDetails}
			/>
         </div>
			 <div>
			...
			history={this.props.history} 
			match={this.props.match} 
			apiRoute={Constants.ApiEndpoint + ApiRoutes.SalesOrderHeaders + '/' + this.state.model!.salesOrderID + '/' + ApiRoutes.SalesOrderHeaderSalesReasons}
			/>
         </div>
...
export const WrappedSalesOrderHeaderDetailComponent = Form.create({ name: 'SalesOrderHeader Detail' })(
  SalesOrderHeaderDetailComponent
);

/*<Codenesium>
    <Hash>199eb6954c047d932f14f0b7417a7700</Hash>
</Codenesium>*/