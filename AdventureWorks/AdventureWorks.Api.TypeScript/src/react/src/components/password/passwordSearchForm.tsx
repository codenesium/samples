...
> {
  ...
  handleEditClick(e: any, row: PasswordViewModel) {
    this.props.history.push(
      ClientRoutes.Passwords + '/edit/' + row.businessEntityID
    );
  }

  handleDetailClick(e: any, row: PasswordViewModel) {
    this.props.history.push(
      ClientRoutes.Passwords + '/' + row.businessEntityID
    );
  }
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.Passwords + '?limit=100';
    ...
    axios
      .get<Array<Api.PasswordClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedPasswordSearchComponent = Form.create({
  name: 'Password Search',
})(PasswordSearchComponent);


/*<Codenesium>
    <Hash>9bfd3b1d1eb5acee561411e3bad13d12</Hash>
</Codenesium>*/