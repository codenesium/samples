  ...
  mapApiResponseToViewModel(
    ...
    if (dto.stateProvinceIDNavigation != null) {
      ...
      response.stateProvinceIDNavigation.setProperties(
        dto.stateProvinceIDNavigation.countryRegionCode,
        dto.stateProvinceIDNavigation.isOnlyStateProvinceFlag,
        dto.stateProvinceIDNavigation.modifiedDate,
        dto.stateProvinceIDNavigation.name,
        dto.stateProvinceIDNavigation.rowguid,
        dto.stateProvinceIDNavigation.stateProvinceCode,
        dto.stateProvinceIDNavigation.stateProvinceID,
        dto.stateProvinceIDNavigation.territoryID
      );
    }
...
/*<Codenesium>
    <Hash>7bfe21dfe93e2e20236241d87d37c92f</Hash>
</Codenesium>*/