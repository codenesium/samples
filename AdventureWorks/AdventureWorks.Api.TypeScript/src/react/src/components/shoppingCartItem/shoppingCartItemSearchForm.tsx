...
export default class ShoppingCartItemSearchComponent extends React.Component<ShoppingCartItemSearchComponentProps, ShoppingCartItemSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ShoppingCartItemViewModel>(), filteredRecords:new Array<ShoppingCartItemViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
