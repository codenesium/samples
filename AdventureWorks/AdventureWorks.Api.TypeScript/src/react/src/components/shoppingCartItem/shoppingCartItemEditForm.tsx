...
> {
  ...
  submit = (model: ShoppingCartItemViewModel) => {
    let mapper = new ShoppingCartItemMapper();
    axios
      .put<CreateResponse<Api.ShoppingCartItemClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.ShoppingCartItems +
          '/' +
    ...
    if (this.state.loading) {
      ...
      return (
        <Form onSubmit={this.handleSubmit}>
          ...
          <Form.Item>
            <label htmlFor="shoppingCartID">Shopping Cart I D</label>
            <br />
            ...
            })(<Input placeholder={'Shopping Cart I D'} />)}
          </Form.Item>
...
export const WrappedShoppingCartItemEditComponent = Form.create({
  name: 'ShoppingCartItem Edit',
})(ShoppingCartItemEditComponent);


/*<Codenesium>
    <Hash>a4607232723bd07d63fada5f00f69d87</Hash>
</Codenesium>*/