...
> {
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.BusinessEntityClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedBusinessEntitySearchComponent = Form.create({
  name: 'BusinessEntity Search',
})(BusinessEntitySearchComponent);


/*<Codenesium>
    <Hash>30258b0ef4dde3c8d32d4dfced011784</Hash>
</Codenesium>*/