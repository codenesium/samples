...
> {
  ...
  handleEditClick(e:any) {
    this.props.history.push(ClientRoutes.Departments + '/edit/' + this.state.model!.departmentID);
  }
      ...
      return (
		...
		<Button 
		 ...
		 <div>
			...
			apiRoute={Constants.ApiEndpoint + ApiRoutes.Departments + '/' + this.state.model!.departmentID + '/' + ApiRoutes.EmployeeDepartmentHistories}
			/>
         </div>
...
export const WrappedDepartmentDetailComponent = Form.create({ name: 'Department Detail' })(
  DepartmentDetailComponent
);

/*<Codenesium>
    <Hash>c98ba8e7bbd4eba0603faafe34f9dc73</Hash>
</Codenesium>*/