 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new DepartmentMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Departments + '/' + this.state.model!.departmentID,
...
export const WrappedDepartmentEditComponent = Form.create({ name: 'Department Edit' })(DepartmentEditComponent);

/*<Codenesium>
    <Hash>57967adf19e3c321e8b6ace0d1f612c9</Hash>
</Codenesium>*/