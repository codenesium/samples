...
> {
  ...
  submit = (model: DepartmentViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.DepartmentClientRequestModel>>(
        Constants.ApiEndpoint + ApiRoutes.Departments,
...
export const WrappedDepartmentCreateComponent = Form.create({
  name: 'Department Create',
})(DepartmentCreateComponent);


/*<Codenesium>
    <Hash>25e128253d7671f5781212626606bad3</Hash>
</Codenesium>*/