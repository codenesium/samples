...
interface Props {
   ...
   const DepartmentCreateDisplay: React.SFC<FormikProps<DepartmentViewModel>> = (props: FormikProps<DepartmentViewModel>) => {
...
const DepartmentCreate = withFormik<Props, DepartmentViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.Departments,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.DepartmentClientRequestModel>;
  ...
  export default class DepartmentCreateComponent extends React.Component<DepartmentCreateComponentProps, DepartmentCreateComponentState> {
...
/*<Codenesium>
    <Hash>99cb98d3b0ae10056b6e2c3533b070a5</Hash>
</Codenesium>*/