...
> {
  ...
  handleEditClick(e: any, row: DepartmentViewModel) {
    this.props.history.push(
      ClientRoutes.Departments + '/edit/' + row.departmentID
    );
  }
  ...
  handleDeleteClick(e: any, row: Api.DepartmentClientResponseModel) {
    axios
      .delete(
        Constants.ApiEndpoint + ApiRoutes.Departments + '/' + row.departmentID,
        {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.Departments + '?limit=100';
    ...
    axios
      .get<Array<Api.DepartmentClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedDepartmentSearchComponent = Form.create({
  name: 'Department Search',
})(DepartmentSearchComponent);


/*<Codenesium>
    <Hash>1dbeb3ffc255125793c0e1767f98ec7e</Hash>
</Codenesium>*/