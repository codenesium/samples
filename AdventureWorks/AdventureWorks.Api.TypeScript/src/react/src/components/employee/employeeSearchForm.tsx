...
export default class EmployeeSearchComponent extends React.Component<EmployeeSearchComponentProps, EmployeeSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<EmployeeViewModel>(), filteredRecords:new Array<EmployeeViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleEditClick(e:any, row:Api.EmployeeClientResponseModel) {
         this.props.history.push(ClientRoutes.Employees + '/edit/' + row.businessEntityID);
    }

    handleDetailClick(e:any, row:Api.EmployeeClientResponseModel) {
         this.props.history.push(ClientRoutes.Employees + '/' + row.businessEntityID);
    }
    ...
    handleDeleteClick(e:any, row:Api.EmployeeClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.Employees + '/' + row.businessEntityID,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.Employees + '?limit=100';
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<EmployeeViewModel>(),filteredRecords:new Array<EmployeeViewModel>(), loading:false, loaded:false, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedEmployeeSearchComponent = Form.create({ name: 'Employee Search' })(EmployeeSearchComponent);

/*<Codenesium>
    <Hash>c044e74e15f8b27be3c10ff79f96d657</Hash>
</Codenesium>*/