...
export default class EmployeeSearchComponent extends React.Component<EmployeeSearchComponentProps, EmployeeSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<EmployeeViewModel>(), filteredRecords:new Array<EmployeeViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>8d0a9a403ebaf8f073a740d7e0d7808c</Hash>
</Codenesium>*/