...
const ProductEdit = withFormik<Props, ProductViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Products +'/' + values.productID,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.ProductClientRequestModel>;
  ...
  export default class ProductEditComponent extends React.Component<ProductEditComponentProps, ProductEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Products + '/' + this.props.match.params.productID, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<ProductEdit model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>de829774bfd07c69e2b348f122abf3c3</Hash>
</Codenesium>*/