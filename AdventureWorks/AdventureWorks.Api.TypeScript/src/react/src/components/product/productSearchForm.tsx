...
export default class ProductSearchComponent extends React.Component<ProductSearchComponentProps, ProductSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ProductViewModel>(), filteredRecords:new Array<ProductViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedProductSearchComponent = Form.create({ name: 'Product Search' })(ProductSearchComponent);

/*<Codenesium>
    <Hash>ccf6e9eae2931abfd8bbeda1f8924635</Hash>
</Codenesium>*/