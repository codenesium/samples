...
> {
  ...
  submit = (model: AWBuildVersionViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.AWBuildVersionClientRequestModel>>(
      ...
      return (
        <Form onSubmit={this.handleSubmit}>
          <Form.Item>
            ...
            })(<Input placeholder={'Database  Version'} />)}
          </Form.Item>
          ...
          <Form.Item>
            ...
            {getFieldDecorator('versionDate', {
              ...
              <DatePicker format={'YYYY-MM-DD'} placeholder={'Version Date'} />
            )}
          </Form.Item>
...
/*<Codenesium>
    <Hash>6cf47873a2716aaad0ec59e9da270c24</Hash>
</Codenesium>*/