...
export const WrappedDatabaseLogCreateComponent = Form.create({ name: 'DatabaseLog Create' })(DatabaseLogCreateComponent);

/*<Codenesium>
    <Hash>13841ffb5b87bc84ed954dd43f6eaa46</Hash>
</Codenesium>*/