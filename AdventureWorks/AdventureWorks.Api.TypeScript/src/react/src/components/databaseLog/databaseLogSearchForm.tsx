...
export const WrappedDatabaseLogSearchComponent = Form.create({ name: 'DatabaseLog Search' })(DatabaseLogSearchComponent);

/*<Codenesium>
    <Hash>bd55edc625415fc5a48a9333a1b6b0e4</Hash>
</Codenesium>*/