...
export default class ProductModelSearchComponent extends React.Component<ProductModelSearchComponentProps, ProductModelSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<ProductModelViewModel>(), filteredRecords:new Array<ProductModelViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleEditClick(e:any, row:ProductModelViewModel) {
         this.props.history.push(ClientRoutes.ProductModels + '/edit/' + row.productModelID);
    }

    handleDetailClick(e:any, row:ProductModelViewModel) {
         this.props.history.push(ClientRoutes.ProductModels + '/' + row.productModelID);
    }
    ...
    handleDeleteClick(e:any, row:Api.ProductModelClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.ProductModels + '/' + row.productModelID,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.ProductModels + '?limit=100';
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ProductModelViewModel>(), filteredRecords:new Array<ProductModelViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
