...
export default class ProductReviewSearchComponent extends React.Component<ProductReviewSearchComponentProps, ProductReviewSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ProductReviewViewModel>(), filteredRecords:new Array<ProductReviewViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedProductReviewSearchComponent = Form.create({ name: 'ProductReview Search' })(ProductReviewSearchComponent);

/*<Codenesium>
    <Hash>6aae5472fee4b4c86f23f948ab5515ea</Hash>
</Codenesium>*/