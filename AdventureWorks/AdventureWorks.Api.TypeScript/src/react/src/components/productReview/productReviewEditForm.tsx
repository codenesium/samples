 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new ProductReviewMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.ProductReviews + '/' + this.state.model!.productReviewID,
...
export const WrappedProductReviewEditComponent = Form.create({ name: 'ProductReview Edit' })(ProductReviewEditComponent);

/*<Codenesium>
    <Hash>b6ae8b82e2787c6d4be61ac9a99bdacf</Hash>
</Codenesium>*/