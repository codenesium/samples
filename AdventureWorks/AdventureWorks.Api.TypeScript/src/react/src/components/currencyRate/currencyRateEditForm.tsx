...
interface Props {
  ...
  const CurrencyRateEditDisplay = (props: FormikProps<CurrencyRateViewModel>) => {
   ...
   let status = props.status as UpdateResponse<Api.CurrencyRateClientRequestModel>;
...
const CurrencyRateEdit = withFormik<Props, CurrencyRateViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.CurrencyRates +'/' + values.currencyRateID,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.CurrencyRateClientRequestModel>;
  ...
  export default class CurrencyRateEditComponent extends React.Component<CurrencyRateEditComponentProps, CurrencyRateEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.CurrencyRates + '/' + this.props.match.params.currencyRateID, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<CurrencyRateEdit model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>7476a6fe17e8bf51d9c87939189ecfd4</Hash>
</Codenesium>*/