...
export const WrappedPurchaseOrderHeaderCreateComponent = Form.create({ name: 'PurchaseOrderHeader Create' })(PurchaseOrderHeaderCreateComponent);

/*<Codenesium>
    <Hash>966075b64ff4a41ffba16093b5fed7d9</Hash>
</Codenesium>*/