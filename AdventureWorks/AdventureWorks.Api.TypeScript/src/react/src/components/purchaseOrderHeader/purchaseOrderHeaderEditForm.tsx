 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new PurchaseOrderHeaderMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.PurchaseOrderHeaders + '/' + this.state.model!.purchaseOrderID,
      ...
      return <Spin size="large" />;
        ...
        return ( 
         <Form onSubmit={this.handleSubmit}>
              ...
              ( <DatePicker format={'YYYY-MM-DD'} placeholder={"EmployeeID"} id={"employeeID"} /> )}
              </Form.Item>
              ...
              ( <DatePicker format={'YYYY-MM-DD'} placeholder={"VendorID"} id={"vendorID"} /> )}
              </Form.Item>
...
/*<Codenesium>
    <Hash>d0ddd5d7cf76dc554a749c22f848e55b</Hash>
</Codenesium>*/