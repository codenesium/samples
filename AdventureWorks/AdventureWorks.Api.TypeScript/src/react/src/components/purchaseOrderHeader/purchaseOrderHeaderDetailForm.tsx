      ...
      return (
		...
		<Button 
		  ...
		  <div>
							...
							<h3>ShipMethodID</h3>
							<p>{String(this.state.model!.shipMethodIDNavigation!.toDisplay())}</p>
						 </div>
					   						 <div>
							<h3>Status</h3>
		 ...
		 <div>
			...
			apiRoute={Constants.ApiEndpoint + ApiRoutes.PurchaseOrderHeaders + '/' + this.state.model!.purchaseOrderID + '/' + ApiRoutes.PurchaseOrderDetails}
			/>
         </div>
...
/*<Codenesium>
    <Hash>9c866cad4b409fdd5fd41410b9728b43</Hash>
</Codenesium>*/