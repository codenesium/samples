...
class CountryRegionEditComponent extends React.Component<
...
> {
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
     ...
     this.props.form.validateFields((err:any, values:any) => {
      if (!err) {
        let model = values as CountryRegionViewModel;
  ...
  submit = (model:CountryRegionViewModel) =>
  {  
    let mapper = new CountryRegionMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.CountryRegions + '/' + this.state.model!.countryRegionCode,
...
export const WrappedCountryRegionEditComponent = Form.create({ name: 'CountryRegion Edit' })(CountryRegionEditComponent);

/*<Codenesium>
    <Hash>d20966a8c5a0cebef1b72c43b71f81a5</Hash>
</Codenesium>*/