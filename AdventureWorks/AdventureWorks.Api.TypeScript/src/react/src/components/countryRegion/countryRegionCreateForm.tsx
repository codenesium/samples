...
class CountryRegionCreateComponent extends React.Component<
...
> {
  ...
  submit = (model: CountryRegionViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.CountryRegionClientRequestModel>>(
...
export const WrappedCountryRegionCreateComponent = Form.create({
  name: 'CountryRegion Create',
})(CountryRegionCreateComponent);


/*<Codenesium>
    <Hash>fa0843d1797345e174861e6411cd1a4d</Hash>
</Codenesium>*/