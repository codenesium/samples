...
> {
  ...
  handleEditClick(e: any, row: CountryRegionViewModel) {
    this.props.history.push(
      ClientRoutes.CountryRegions + '/edit/' + row.countryRegionCode
    );
  }

  handleDetailClick(e: any, row: CountryRegionViewModel) {
    this.props.history.push(
      ClientRoutes.CountryRegions + '/' + row.countryRegionCode
    );
  }
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.CountryRegions + '?limit=100';
...
export const WrappedCountryRegionSearchComponent = Form.create({
  name: 'CountryRegion Search',
})(CountryRegionSearchComponent);


/*<Codenesium>
    <Hash>bd82b8dedc4b217ea7ffdb94bc4b903d</Hash>
</Codenesium>*/