 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new StoreMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Stores + '/' + this.state.model!.businessEntityID,
...
export const WrappedStoreEditComponent = Form.create({ name: 'Store Edit' })(StoreEditComponent);

/*<Codenesium>
    <Hash>ec189f15878e34ef46978126768d32f1</Hash>
</Codenesium>*/