...
const StoreEdit = withFormik<Props, StoreViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Stores +'/' + values.businessEntityID,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.StoreClientRequestModel>;
  ...
  export default class StoreEditComponent extends React.Component<StoreEditComponentProps, StoreEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Stores + '/' + this.props.match.params.businessEntityID, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<StoreEdit model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>242e3f4d04dbbdcd1f18b93b3df6748a</Hash>
</Codenesium>*/