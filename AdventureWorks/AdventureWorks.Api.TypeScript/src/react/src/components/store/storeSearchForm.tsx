...
export default class StoreSearchComponent extends React.Component<StoreSearchComponentProps, StoreSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<StoreViewModel>(),filteredRecords:new Array<StoreViewModel>(), loading:false, loaded:false, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>aa6d99a45a5d882dd4d4e5741f8bc85c</Hash>
</Codenesium>*/