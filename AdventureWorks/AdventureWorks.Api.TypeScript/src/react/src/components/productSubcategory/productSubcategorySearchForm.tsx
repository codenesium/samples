...
> {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.ProductSubcategories + '?limit=100';
    ...
    axios
      .get<Array<Api.ProductSubcategoryClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedProductSubcategorySearchComponent = Form.create({
  name: 'ProductSubcategory Search',
})(ProductSubcategorySearchComponent);


/*<Codenesium>
    <Hash>a0776a7ad0c5a57ad4cb0ceece11c0bf</Hash>
</Codenesium>*/