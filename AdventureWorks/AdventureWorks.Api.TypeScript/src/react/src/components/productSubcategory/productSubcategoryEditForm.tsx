...
> {
  ...
  submit = (model: ProductSubcategoryViewModel) => {
    let mapper = new ProductSubcategoryMapper();
    axios
      .put<CreateResponse<Api.ProductSubcategoryClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.ProductSubcategories +
          '/' +
      ...
      return (
        <Form onSubmit={this.handleSubmit}>
          ...
          <ProductCategorySelectComponent
            apiRoute={Constants.ApiEndpoint + ApiRoutes.ProductCategories}
            getFieldDecorator={this.props.form.getFieldDecorator}
            propertyName="productCategoryID"
            required={true}
            selectedValue={this.state.model!.productCategoryID}
          />
...
export const WrappedProductSubcategoryEditComponent = Form.create({
  name: 'ProductSubcategory Edit',
})(ProductSubcategoryEditComponent);


/*<Codenesium>
    <Hash>32558351bbeb1cc2ce573444f3a78823</Hash>
</Codenesium>*/