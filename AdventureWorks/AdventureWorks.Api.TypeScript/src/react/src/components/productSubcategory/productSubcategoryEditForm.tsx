...
class ProductSubcategoryEditComponent extends React.Component<
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new ProductSubcategoryMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.ProductSubcategories + '/' + this.state.model!.productSubcategoryID,
...
{ max: 50, message: 'Exceeds max length of 50' },
              ...
              ( <DatePicker format={'YYYY-MM-DD'} placeholder={"ProductCategoryID"} /> )}
              </Form.Item>
...
export const WrappedProductSubcategoryEditComponent = Form.create({ name: 'ProductSubcategory Edit' })(ProductSubcategoryEditComponent);

/*<Codenesium>
    <Hash>7f7e576d39ca113e3f2f811caa75fffc</Hash>
</Codenesium>*/