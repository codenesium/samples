...
interface Props {
   ...
   const ProductPhotoCreateDisplay: React.SFC<FormikProps<ProductPhotoViewModel>> = (props: FormikProps<ProductPhotoViewModel>) => {

   let status = props.status as CreateResponse<Api.ProductPhotoClientRequestModel>;
...
const ProductPhotoCreate = withFormik<Props, ProductPhotoViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.ProductPhotoes,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.ProductPhotoClientRequestModel>;
  ...
  export default class ProductPhotoCreateComponent extends React.Component<ProductPhotoCreateComponentProps, ProductPhotoCreateComponentState> {
...
/*<Codenesium>
    <Hash>308424a405d6145234fc08bd1194bc11</Hash>
</Codenesium>*/