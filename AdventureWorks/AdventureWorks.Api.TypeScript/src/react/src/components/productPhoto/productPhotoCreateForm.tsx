...
export const WrappedProductPhotoCreateComponent = Form.create({ name: 'ProductPhoto Create' })(ProductPhotoCreateComponent);

/*<Codenesium>
    <Hash>c8e415a327ec7dcf75c9c0c709006577</Hash>
</Codenesium>*/