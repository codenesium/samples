...
export default class ShiftSearchComponent extends React.Component<ShiftSearchComponentProps, ShiftSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<ShiftViewModel>(), filteredRecords:new Array<ShiftViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.ShiftClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.Shifts + '/' + row.shiftID,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.Shifts + '?limit=100';
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ShiftViewModel>(),filteredRecords:new Array<ShiftViewModel>(), loading:false, loaded:false, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>b72639f1bdb64e82831ded7a9812279d</Hash>
</Codenesium>*/