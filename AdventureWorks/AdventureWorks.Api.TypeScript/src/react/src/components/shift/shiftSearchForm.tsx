...
export default class ShiftSearchComponent extends React.Component<ShiftSearchComponentProps, ShiftSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ShiftViewModel>(), filteredRecords:new Array<ShiftViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
