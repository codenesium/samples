...
export default class ErrorLogSearchComponent extends React.Component<ErrorLogSearchComponentProps, ErrorLogSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ErrorLogViewModel>(), filteredRecords:new Array<ErrorLogViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
