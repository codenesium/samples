 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new ErrorLogMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.ErrorLogs + '/' + this.state.model!.errorLogID,
...
export const WrappedErrorLogEditComponent = Form.create({ name: 'ErrorLog Edit' })(ErrorLogEditComponent);

/*<Codenesium>
    <Hash>cb463332108c45399807eb02c202cb6e</Hash>
</Codenesium>*/