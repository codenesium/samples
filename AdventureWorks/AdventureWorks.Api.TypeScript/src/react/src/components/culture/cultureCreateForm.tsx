...
class CultureCreateComponent extends React.Component<
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new CultureMapper();
     axios
      .post(
        Constants.ApiEndpoint + ApiRoutes.Cultures,
...
export const WrappedCultureCreateComponent = Form.create({ name: 'Culture Create' })(CultureCreateComponent);

/*<Codenesium>
    <Hash>8146d9547a9a0aebf0e8778b2b648d73</Hash>
</Codenesium>*/