...
> {
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.CultureClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedCultureSearchComponent = Form.create({
  name: 'Culture Search',
})(CultureSearchComponent);


/*<Codenesium>
    <Hash>bd80a515812e5d6ceb34cb981b32c4ad</Hash>
</Codenesium>*/