...
export default class CultureSearchComponent extends React.Component<CultureSearchComponentProps, CultureSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<CultureViewModel>(), filteredRecords:new Array<CultureViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.CultureClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.Cultures + '/' + row.cultureID,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.Cultures + '?limit=100';
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<CultureViewModel>(),filteredRecords:new Array<CultureViewModel>(), loading:false, loaded:false, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>174a9f0833fa22ee9f3b72cd4048b612</Hash>
</Codenesium>*/