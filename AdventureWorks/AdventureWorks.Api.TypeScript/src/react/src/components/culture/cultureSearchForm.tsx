...
export default class CultureSearchComponent extends React.Component<CultureSearchComponentProps, CultureSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<CultureViewModel>(), filteredRecords:new Array<CultureViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
