...
> {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.SpecialOffers + '?limit=100';
    ...
    axios
      .get<Array<Api.SpecialOfferClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedSpecialOfferSearchComponent = Form.create({
  name: 'SpecialOffer Search',
})(SpecialOfferSearchComponent);


/*<Codenesium>
    <Hash>a6679e3548a95578e2d9b968dde2e955</Hash>
</Codenesium>*/