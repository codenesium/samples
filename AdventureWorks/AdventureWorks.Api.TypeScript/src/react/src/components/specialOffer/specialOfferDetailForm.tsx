...
> {
  ...
  handleEditClick(e:any) {
    this.props.history.push(ClientRoutes.SpecialOffers + '/edit/' + this.state.model!.specialOfferID);
  }
      ...
      return (
		...
		<Button 
		 ...
		 <div>
			...
			apiRoute={Constants.ApiEndpoint + ApiRoutes.SpecialOffers + '/' + this.state.model!.specialOfferID + '/' + ApiRoutes.SpecialOfferProducts}
			/>
         </div>
...
export const WrappedSpecialOfferDetailComponent = Form.create({ name: 'SpecialOffer Detail' })(
  SpecialOfferDetailComponent
);

/*<Codenesium>
    <Hash>f07ba3736783fcecde080256b03688b5</Hash>
</Codenesium>*/