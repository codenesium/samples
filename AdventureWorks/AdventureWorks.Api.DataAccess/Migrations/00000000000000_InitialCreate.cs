...
WITH(PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
GO
ALTER TABLE[Person].[vStateProvinceCountryRegion]
ADD CONSTRAINT[IX_vStateProvinceCountryRegion] PRIMARY KEY CLUSTERED
(
[StateProvinceID] ASC
,[CountryRegionCode] ASC
)WITH(PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF,  ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
...
GO
ALTER TABLE[Production].[BillOfMaterials]
ADD CONSTRAINT[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] PRIMARY KEY CLUSTERED
(
...
WITH(PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
GO
ALTER TABLE[Production].[vProductAndDescription]
ADD CONSTRAINT[IX_vProductAndDescription] PRIMARY KEY CLUSTERED
(
[CultureID] ASC
,[ProductID] ASC
)WITH(PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF,  IGNORE_DUP_KEY = OFF,  ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
...
REFERENCES[Person].[Person]([BusinessEntityID]) on delete no action on update no action
GO
...
REFERENCES[HumanResources].[Employee]([BusinessEntityID]) on delete no action on update no action
GO
...
REFERENCES[HumanResources].[Shift]([ShiftID]) on delete no action on update no action
GO
...
REFERENCES[HumanResources].[Department]([DepartmentID]) on delete no action on update no action
GO
...
REFERENCES[Person].[StateProvince]([StateProvinceID]) on delete no action on update no action
GO
...
REFERENCES[Person].[Address]([AddressID]) on delete no action on update no action
GO
...
REFERENCES[Person].[AddressType]([AddressTypeID]) on delete no action on update no action
GO
...
REFERENCES[Person].[BusinessEntity]([BusinessEntityID]) on delete no action on update no action
GO
...
REFERENCES[Person].[ContactType]([ContactTypeID]) on delete no action on update no action
GO
...
REFERENCES[Person].[PhoneNumberType]([PhoneNumberTypeID]) on delete no action on update no action
GO
...
REFERENCES[Person].[CountryRegion]([CountryRegionCode]) on delete no action on update no action
GO
...
REFERENCES[Sales].[SalesTerritory]([TerritoryID]) on delete no action on update no action
GO
...
REFERENCES[Production].[Product]([ProductID]) on delete no action on update no action
GO
...
REFERENCES[Production].[UnitMeasure]([UnitMeasureCode]) on delete no action on update no action
GO
...
REFERENCES[Production].[ProductModel]([ProductModelID]) on delete no action on update no action
GO
...
REFERENCES[Production].[ProductSubcategory]([ProductSubcategoryID]) on delete no action on update no action
GO
...
REFERENCES[Production].[Document]([DocumentNode]) on delete no action on update no action
GO
...
REFERENCES[Production].[Location]([LocationID]) on delete no action on update no action
GO
...
REFERENCES[Production].[Illustration]([IllustrationID]) on delete no action on update no action
GO
...
REFERENCES[Production].[Culture]([CultureID]) on delete no action on update no action
GO
...
REFERENCES[Production].[ProductDescription]([ProductDescriptionID]) on delete no action on update no action
GO
...
REFERENCES[Production].[ProductPhoto]([ProductPhotoID]) on delete no action on update no action
GO
...
REFERENCES[Production].[ProductCategory]([ProductCategoryID]) on delete no action on update no action
GO
...
REFERENCES[Production].[ScrapReason]([ScrapReasonID]) on delete no action on update no action
GO
...
REFERENCES[Production].[WorkOrder]([WorkOrderID]) on delete no action on update no action
GO
...
REFERENCES[Purchasing].[Vendor]([BusinessEntityID]) on delete no action on update no action
GO
...
REFERENCES[Purchasing].[PurchaseOrderHeader]([PurchaseOrderID]) on delete no action on update no action
GO
...
REFERENCES[Purchasing].[ShipMethod]([ShipMethodID]) on delete no action on update no action
GO
...
REFERENCES[Sales].[Currency]([CurrencyCode]) on delete no action on update no action
GO
...
REFERENCES[Sales].[Store]([BusinessEntityID]) on delete no action on update no action
GO
...
REFERENCES[Sales].[CreditCard]([CreditCardID]) on delete no action on update no action
GO
...
REFERENCES[Sales].[SpecialOfferProduct]([SpecialOfferID],[ProductID]) on delete no action on update no action
GO
ALTER TABLE[Sales].[SalesOrderDetail] CHECK CONSTRAINT[FK_SalesOrderDetail_SpecialOfferProduct_SpecialOfferIDProductID]
GO
ALTER TABLE[Sales].[SalesOrderDetail]  WITH CHECK ADD  CONSTRAINT[FK_SalesOrderDetail_SalesOrderHeader_SalesOrderID] FOREIGN KEY([SalesOrderID])
REFERENCES[Sales].[SalesOrderHeader]([SalesOrderID]) on delete no action on update no action
GO
...
REFERENCES[Sales].[SalesPerson]([BusinessEntityID]) on delete no action on update no action
GO
...
REFERENCES[Sales].[CurrencyRate]([CurrencyRateID]) on delete no action on update no action
GO
...
REFERENCES[Sales].[Customer]([CustomerID]) on delete no action on update no action
GO
...
REFERENCES[Sales].[SalesReason]([SalesReasonID]) on delete no action on update no action
GO
...
REFERENCES[Sales].[SpecialOffer]([SpecialOfferID]) on delete no action on update no action
GO
