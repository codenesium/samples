...
IF (OBJECT_ID('FK_Employee_Person_BusinessEntityID', 'F') IS NOT NULL)
BEGIN
ALTER TABLE [HumanResources].[Employee] DROP CONSTRAINT [FK_Employee_Person_BusinessEntityID]
END
GO
IF (OBJECT_ID('FK_EmployeeDepartmentHistory_Department_DepartmentID', 'F') IS NOT NULL)
BEGIN
...
END
GO
IF (OBJECT_ID('FK_EmployeeDepartmentHistory_Employee_BusinessEntityID', 'F') IS NOT NULL)
BEGIN
...
END
GO
IF (OBJECT_ID('FK_ProductModelProductDescriptionCulture_ProductDescription_ProductDescriptionID', 'F') IS NOT NULL)
BEGIN
...
END
GO
IF (OBJECT_ID('FK_ProductModelProductDescriptionCulture_ProductModel_ProductModelID', 'F') IS NOT NULL)
BEGIN
