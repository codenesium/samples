...
namespace AdventureWorksNS.Api.DataAccess
{
	public abstract class AbstractIntegrationTestMigration
	{
		...
		public virtual async void Migrate()
		{
			...
			databaseLogItem1.SetProperties("A", "A", 1, "A", DateTime.Parse("1/1/1987 12:00:00 AM"), "A", "A", "A");
			...
			shiftItem1.SetProperties(TimeSpan.Parse("01:00:00"), DateTime.Parse("1/1/1987 12:00:00 AM"), "A", 1, TimeSpan.Parse("01:00:00"));
			...
			salesTerritoryItem1.SetProperties("A", 1m, 1m, "A", DateTime.Parse("1/1/1987 12:00:00 AM"), "A", Guid.Parse("8420cdcf-d595-ef65-66e7-dff9f98764da"), 1m, 1m, 1);
