...
namespace AdventureWorksNS.Api.DataAccess
{
	public abstract class AbstractIntegrationTestMigration
	{
		...
		public virtual async Task Migrate()
		{
			...
			databaseLogItem1.SetProperties(1, "A", DateTime.Parse("1/1/1987 12:00:00 AM"), "A", "A", "A", "A", "A");
			...
			productItem1.SetProperties(1, "A", 1, DateTime.Parse("1/1/1987 12:00:00 AM"), true, 1m, true, DateTime.Parse("1/1/1987 12:00:00 AM"), "A", "A", 1, "A", 1, 1, "A", Guid.Parse("8420cdcf-d595-ef65-66e7-dff9f98764da"), 1, DateTime.Parse("1/1/1987 12:00:00 AM"), DateTime.Parse("1/1/1987 12:00:00 AM"), "A", "A", 1m, "A", 1, "A");
			...
			productProductPhotoItem1.SetProperties(1, DateTime.Parse("1/1/1987 12:00:00 AM"), true, 1);
			...
			salesTerritoryItem1.SetProperties(1, 1m, 1m, "A", DateTime.Parse("1/1/1987 12:00:00 AM"), "A", "A", Guid.Parse("8420cdcf-d595-ef65-66e7-dff9f98764da"), 1m, 1m);
			...
			specialOfferItem1.SetProperties(1, "A", "A", 1m, DateTime.Parse("1/1/1987 12:00:00 AM"), 1, 1, DateTime.Parse("1/1/1987 12:00:00 AM"), "A", Guid.Parse("8420cdcf-d595-ef65-66e7-dff9f98764da"), DateTime.Parse("1/1/1987 12:00:00 AM"));
...
/*<Codenesium>
    <Hash>35b0bea849ec7b872656efcb022d88f5</Hash>
</Codenesium>*/