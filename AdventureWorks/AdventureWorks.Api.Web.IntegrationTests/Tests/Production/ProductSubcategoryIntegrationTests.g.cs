...
namespace AdventureWorksNS.Api.Web.IntegrationTests
{
	...
	public partial class ProductSubcategoryIntegrationTests
	{
		...
		public virtual async void TestBulkInsert()
		{
			...
			model2.SetProperties(DateTime.Parse("1/1/1989 12:00:00 AM"), "C", 3, Guid.Parse("8d721ec8-4c9d-632f-6f06-7f89cc14862c"));
			...
			context.Set<ProductSubcategory>().ToList()[1].ProductCategoryID.Should().Be(2);
			...
			context.Set<ProductSubcategory>().ToList()[2].ProductCategoryID.Should().Be(3);
		...
		public virtual async void TestCreate()
		{
			...
			result.Record.ProductCategoryID.Should().Be(2);
		...
		public virtual async void TestUpdate()
		{
			...
			request.SetProperties(DateTime.Parse("1/1/1988 12:00:00 AM"), "B", 2, Guid.Parse("3842cac4-b9a0-8223-0dcc-509a6f75849b"));
			...
			context.Set<ProductSubcategory>().ToList()[0].ProductCategoryID.Should().Be(2);
			...
			updateResponse.Record.ProductCategoryID.Should().Be(2);
...
/*<Codenesium>
    <Hash>7da2c52ba8c79a2c6b9c63e984639725</Hash>
</Codenesium>*/