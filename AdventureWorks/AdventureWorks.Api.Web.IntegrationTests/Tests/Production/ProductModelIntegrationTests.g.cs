...
namespace AdventureWorksNS.Api.Web.IntegrationTests
{
	...
	public class ProductModelIntegrationTests
	{
		...
		public async void TestCreate()
		{
			...
			await client.ProductModelDeleteAsync(1);
		...
		public async void TestDelete()
		{
			...
			ApiProductModelResponseModel response = await client.ProductModelGetAsync(1);

			response.Should().NotBeNull();

			ActionResponse result = await client.ProductModelDeleteAsync(1);

			result.Success.Should().BeTrue();

			response = await client.ProductModelGetAsync(1);
		...
		public async void TestAll()
		{
			...
			List<ApiProductModelResponseModel> response = await client.ProductModelAllAsync();

			response.Count.Should().BeGreaterThan(0);
		}

		private async Task<ApiProductModelResponseModel> CreateRecord(ApiClient client)
		{
			...
			CreateResponse<ApiProductModelResponseModel> result = await client.ProductModelCreateAsync(model);
...
/*<Codenesium>
    <Hash>9a82ab95519319e2f17d60527b4f3dad</Hash>
</Codenesium>*/