...
namespace AdventureWorksNS.Api.Web.IntegrationTests
{
	...
	public partial class SalesTerritoryIntegrationTests
	{
		...
		public virtual async void TestBulkInsert()
		{
			...
			model.SetProperties(2m, 2m, "B", DateTime.Parse("1/1/1988 12:00:00 AM"), "B", "B", Guid.Parse("3842cac4-b9a0-8223-0dcc-509a6f75849b"), 2m, 2m);
			var model2 = new ApiSalesTerritoryClientRequestModel();
			model2.SetProperties(3m, 3m, "C", DateTime.Parse("1/1/1989 12:00:00 AM"), "C", "C", Guid.Parse("8d721ec8-4c9d-632f-6f06-7f89cc14862c"), 3m, 3m);
			...
			context.Set<SalesTerritory>().ToList()[1].ReservedGroup.Should().Be("B");
			...
			context.Set<SalesTerritory>().ToList()[2].ReservedGroup.Should().Be("C");
		...
		public virtual async void TestCreate()
		{
			...
			result.Record.ReservedGroup.Should().Be("B");
		...
		public virtual async void TestUpdate()
		{
			...
			request.SetProperties(2m, 2m, "B", DateTime.Parse("1/1/1988 12:00:00 AM"), "B", "B", Guid.Parse("3842cac4-b9a0-8223-0dcc-509a6f75849b"), 2m, 2m);
			...
			context.Set<SalesTerritory>().ToList()[0].ReservedGroup.Should().Be("B");
			...
			updateResponse.Record.ReservedGroup.Should().Be("B");
		...
		public virtual async void TestAll()
		{
			...
			response[0].ReservedGroup.Should().Be("A");
...
/*<Codenesium>
    <Hash>4a59ca9b658ea38ebb340b98ae61deac</Hash>
</Codenesium>*/