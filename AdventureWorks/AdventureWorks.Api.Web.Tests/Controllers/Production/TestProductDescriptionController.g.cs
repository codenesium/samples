...
namespace AdventureWorksNS.Api.Web.Tests
{
	...
	public partial class ProductDescriptionControllerTests
	{
		...
		public async void Create_No_Errors()
		{
			...
			var createResponse = (response as CreatedResult).Value as CreateResponse<ApiProductDescriptionResponseModel>;
		...
		{
			ProductDescriptionControllerMockFacade mock = new ProductDescriptionControllerMockFacade();
			var mockResult = new Mock<UpdateResponse<ApiProductDescriptionResponseModel>>();
			...
			.Returns(Task.FromResult<UpdateResponse<ApiProductDescriptionResponseModel>>(mockResult.Object));
		...
		public async void Update_No_Errors()
		{
			...
			var mockResult = new Mock<UpdateResponse<ApiProductDescriptionResponseModel>>();
			mockResult.SetupGet(x => x.Success).Returns(true);
			mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiProductDescriptionRequestModel>())).Returns(Task.FromResult<UpdateResponse<ApiProductDescriptionResponseModel>>(mockResult.Object));
			mock.ServiceMock.Setup(x => x.Get(It.IsAny<int>())).Returns(Task.FromResult(new ApiProductDescriptionResponseModel()));
			ProductDescriptionController controller = new ProductDescriptionController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiProductDescriptionModelMapper());
			controller.ControllerContext = new ControllerContext();
			controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>b16949d876ebbd77370430ea7de465d1</Hash>
</Codenesium>*/