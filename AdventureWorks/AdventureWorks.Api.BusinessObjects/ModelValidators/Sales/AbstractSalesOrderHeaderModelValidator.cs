...
{
	public abstract class AbstractApiSalesOrderHeaderModelValidator: AbstractValidator<ApiSalesOrderHeaderModel>
	{
		public new ValidationResult Validate(ApiSalesOrderHeaderModel model)
		{
			return base.Validate(model);
		}

		public async Task<ValidationResult> ValidateAsync(ApiSalesOrderHeaderModel model)
		{
