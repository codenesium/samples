...
namespace AdventureWorksNS.Api.Services.Tests
{
	...
	public partial class ApiSpecialOfferServerRequestModelValidatorTest
	{
		...
		[Fact]
		public async void ReservedType_Create_null()
		{
			Mock<ISpecialOfferRepository> specialOfferRepository = new Mock<ISpecialOfferRepository>();
			specialOfferRepository.Setup(x => x.Get(It.IsAny<int>())).Returns(Task.FromResult(new SpecialOffer()));
			...
			validator.ShouldHaveValidationErrorFor(x => x.ReservedType, null as string);
		}

		[Fact]
		public async void ReservedType_Update_null()
		{
			Mock<ISpecialOfferRepository> specialOfferRepository = new Mock<ISpecialOfferRepository>();
			specialOfferRepository.Setup(x => x.Get(It.IsAny<int>())).Returns(Task.FromResult(new SpecialOffer()));
		...
		[Fact]
		public async void ReservedType_Create_length()
		{
			Mock<ISpecialOfferRepository> specialOfferRepository = new Mock<ISpecialOfferRepository>();
			specialOfferRepository.Setup(x => x.Get(It.IsAny<int>())).Returns(Task.FromResult(new SpecialOffer()));
			...
			validator.ShouldHaveValidationErrorFor(x => x.ReservedType, new string('A', 51));
		}

		[Fact]
		public async void ReservedType_Update_length()
		{
			Mock<ISpecialOfferRepository> specialOfferRepository = new Mock<ISpecialOfferRepository>();
			specialOfferRepository.Setup(x => x.Get(It.IsAny<int>())).Returns(Task.FromResult(new SpecialOffer()));
...
/*<Codenesium>
    <Hash>a5cb83ee9d28dd103112c33ad0d5dbc6</Hash>
</Codenesium>*/