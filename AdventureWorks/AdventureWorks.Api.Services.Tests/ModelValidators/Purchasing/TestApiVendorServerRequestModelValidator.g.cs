...
namespace AdventureWorksNS.Api.Services.Tests
{
	...
	public partial class ApiVendorServerRequestModelValidatorTest
	{
		public ApiVendorServerRequestModelValidatorTest()
		{
		}
		...
		public async void AccountNumber_Create_null()
		{
			...
			var validator = new ApiVendorServerRequestModelValidator(vendorRepository.Object);
			await validator.ValidateCreateAsync(new ApiVendorServerRequestModel());
		...
		public async void AccountNumber_Update_null()
		{
			...
			var validator = new ApiVendorServerRequestModelValidator(vendorRepository.Object);
			await validator.ValidateUpdateAsync(default(int), new ApiVendorServerRequestModel());
...
/*<Codenesium>
    <Hash>9aed97cc5f3ad3b1baac515874ee0a65</Hash>
</Codenesium>*/