...
namespace AdventureWorksNS.Api.Services.Tests
{
	...
	public partial class ApiProductServerRequestModelValidatorTest
	{
		...
		[Fact]
		public async void ReservedClass_Create_length()
		{
			...
			validator.ShouldHaveValidationErrorFor(x => x.ReservedClass, new string('A', 3));
		}

		[Fact]
		public async void ReservedClass_Update_length()
		{
			Mock<IProductRepository> productRepository = new Mock<IProductRepository>();
			productRepository.Setup(x => x.Get(It.IsAny<int>())).Returns(Task.FromResult(new Product()));
...
/*<Codenesium>
    <Hash>d204a794fb7d15de3ee3da875d6e9df0</Hash>
</Codenesium>*/