...
namespace AdventureWorksNS.Api.Services
{
	public abstract class AbstractApiSalesTerritoryServerRequestModelValidator : AbstractValidator<ApiSalesTerritoryServerRequestModel>
	{
		...
		public virtual void ReservedGroupRules()
		{
			this.RuleFor(x => x.ReservedGroup).NotNull().WithErrorCode(ValidationErrorCodes.ViolatesShouldNotBeNullRule);
			this.RuleFor(x => x.ReservedGroup).Length(0, 50).WithErrorCode(ValidationErrorCodes.ViolatesLengthRule);
		}
...
/*<Codenesium>
    <Hash>166c8bc035f7f46c3e59c7498cd049fb</Hash>
</Codenesium>*/