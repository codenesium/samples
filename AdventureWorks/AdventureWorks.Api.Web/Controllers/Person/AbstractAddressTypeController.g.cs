...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractAddressTypeController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiAddressTypeServerResponseModel> response = await this.AddressTypeService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>c53f01c1ecb73febbc0d2b3cda045648</Hash>
</Codenesium>*/