...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractBusinessEntityController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiBusinessEntityServerResponseModel> response = await this.BusinessEntityService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>1117ab6cf68526b195da247bb240f9dd</Hash>
</Codenesium>*/