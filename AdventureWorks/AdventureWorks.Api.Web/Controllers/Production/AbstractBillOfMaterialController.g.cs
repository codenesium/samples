...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractBillOfMaterialController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiBillOfMaterialServerResponseModel> response = await this.BillOfMaterialService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>bc0826bb46c6d41e99e35db5035613e1</Hash>
</Codenesium>*/