...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractProductDescriptionController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiProductDescriptionServerResponseModel> response = await this.ProductDescriptionService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>13f2988e4cdb1575ff0b3557ee6344d0</Hash>
</Codenesium>*/