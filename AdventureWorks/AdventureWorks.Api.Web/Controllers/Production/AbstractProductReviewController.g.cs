...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractProductReviewController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiProductReviewServerResponseModel> response = await this.ProductReviewService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>4c7d29219bbb37158c5faf79b0750a02</Hash>
</Codenesium>*/