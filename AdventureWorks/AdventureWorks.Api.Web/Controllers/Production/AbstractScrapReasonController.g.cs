...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractScrapReasonController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiScrapReasonServerResponseModel> response = await this.ScrapReasonService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>f34bc433505a63576d32f1b634525527</Hash>
</Codenesium>*/