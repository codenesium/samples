...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractProductModelController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiProductModelServerResponseModel> response = await this.ProductModelService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>8dc4524507a7dd1041a5df109d0b228a</Hash>
</Codenesium>*/