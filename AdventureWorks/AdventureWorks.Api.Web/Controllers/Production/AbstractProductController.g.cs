...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractProductController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> ProductProductPhotoesByProductID(int productID, int? limit, int? offset)
		{
			...
			List<ApiProductProductPhotoServerResponseModel> response = await this.ProductService.ProductProductPhotoesByProductID(productID, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>d3e5e2f18f0d179b29b4061b32bfa71b</Hash>
</Codenesium>*/