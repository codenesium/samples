...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractProductPhotoController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiProductPhotoServerResponseModel> response = await this.ProductPhotoService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
		...
		public async virtual Task<IActionResult> ProductProductPhotoesByProductPhotoID(int productPhotoID, int? limit, int? offset)
		{
			...
			List<ApiProductProductPhotoServerResponseModel> response = await this.ProductPhotoService.ProductProductPhotoesByProductPhotoID(productPhotoID, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>538c1150795015250aa4d797442830da</Hash>
</Codenesium>*/