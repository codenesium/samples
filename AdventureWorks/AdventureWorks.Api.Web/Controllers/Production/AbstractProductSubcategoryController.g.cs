...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractProductSubcategoryController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiProductSubcategoryServerResponseModel> response = await this.ProductSubcategoryService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>9337a1670a6f6307716f81345ac02bdf</Hash>
</Codenesium>*/