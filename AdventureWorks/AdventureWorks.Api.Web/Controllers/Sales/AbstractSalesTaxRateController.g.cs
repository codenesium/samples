...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractSalesTaxRateController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiSalesTaxRateServerResponseModel> response = await this.SalesTaxRateService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>641d7dcb911d8352bbc3c6d8ac9fea66</Hash>
</Codenesium>*/