...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractCustomerController : AbstractApiController
	{
		...
		{
			ApiCustomerServerResponseModel response = await this.CustomerService.ByAccountNumber(accountNumber);
		...
		{
			ApiCustomerServerResponseModel response = await this.CustomerService.ByRowguid(rowguid);
		...
		public async virtual Task<IActionResult> ByTerritoryID(int? territoryID, int? limit, int? offset)
		{
			...
			List<ApiCustomerServerResponseModel> response = await this.CustomerService.ByTerritoryID(territoryID, query.Limit, query.Offset);
		...
		public async virtual Task<IActionResult> SalesOrderHeadersByCustomerID(int customerID, int? limit, int? offset)
		{
			...
			List<ApiSalesOrderHeaderServerResponseModel> response = await this.CustomerService.SalesOrderHeadersByCustomerID(customerID, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>dbd3a0f98d88600601fe79ae70a52aa9</Hash>
</Codenesium>*/