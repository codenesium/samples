...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractSalesOrderHeaderController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiSalesOrderHeaderServerResponseModel> response = await this.SalesOrderHeaderService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>bdc1a9efd380004365edb3fa9b17f6c2</Hash>
</Codenesium>*/