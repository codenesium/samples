...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractCurrencyController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiCurrencyServerResponseModel> response = await this.CurrencyService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>2b8e724d13465ce598734cfb47dd4910</Hash>
</Codenesium>*/