...
namespace AdventureWorksNS.Api.Web
{
	public abstract class AbstractSalesTerritoryController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiSalesTerritoryServerResponseModel> response = await this.SalesTerritoryService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>f08980eb16556cd75ab93134468a0107</Hash>
</Codenesium>*/