...
namespace NebulaNS.Api.DataAccess
{
	public abstract class AbstractLinkRepository
	{
		...
		public virtual Response GetWhere(Expression<Func<EFLink, bool>> predicate, int skip = 0, int take = int.MaxValue, string orderClause = "")
		{
			var response = new Response();
		...
		private void SearchLinqPOCO(Expression<Func<EFLink, bool>> predicate, Response response, int skip = 0, int take = int.MaxValue, string orderClause = "")
		{
...
/*<Codenesium>
    <Hash>17116ca3eb29ad30ea93d883aa6acdca</Hash>
</Codenesium>*/