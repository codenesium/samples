...
ALTER TABLE[dbo].[Chain]
ADD CONSTRAINT[DF_Chain_externalId]  DEFAULT('00000000-0000-0000-0000-000000000000') FOR[externalId]
GO

ALTER TABLE[dbo].[Link]
ADD CONSTRAINT[DF_Link_externalId]  DEFAULT('00000000-0000-0000-0000-000000000000') FOR[externalId]
GO

ALTER TABLE[dbo].[Link]
ADD CONSTRAINT[DF_Link_timeoutInSeconds]  DEFAULT((0)) FOR[timeoutInSeconds]
GO
