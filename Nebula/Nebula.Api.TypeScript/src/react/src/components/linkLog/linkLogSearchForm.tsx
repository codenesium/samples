...
export default class LinkLogSearchComponent extends React.Component<LinkLogSearchComponentProps, LinkLogSearchComponentState> {
    ...
    handleEditClick(e:any, row:Api.LinkLogClientResponseModel) {
         this.props.history.push(ClientRoutes.LinkLogs + '/edit/' + row.id);
    }

    handleDetailClick(e:any, row:Api.LinkLogClientResponseModel) {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<LinkLogViewModel>(),filteredRecords:new Array<LinkLogViewModel>(), loading:false, loaded:false, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
        ...
        if(this.state.loading) {
            ...
            <ReactTable 
                ...
                columns={[{
                    ...
                    {
                        Header: 'Actions',
                        Cell: row => (<div><button className="btn btn-sm" onClick={e => {this.handleDetailClick(e, row.original as Api.LinkLogClientResponseModel)}} ><i className="fas fa-search"></i></button>
                        &nbsp;<button className="btn btn-primary btn-sm" onClick={e => {this.handleEditClick(e, row.original as Api.LinkLogClientResponseModel)}} ><i className="fas fa-edit"></i></button>
                        &nbsp;<button className="btn btn-danger btn-sm" onClick={e => {this.handleDeleteClick(e, row.original as Api.LinkLogClientResponseModel)}} ><i className="far fa-trash-alt"></i></button>
                        </div>)
                    }],
...
/*<Codenesium>
    <Hash>835bbd1f788887bea65edebd1839c781</Hash>
</Codenesium>*/