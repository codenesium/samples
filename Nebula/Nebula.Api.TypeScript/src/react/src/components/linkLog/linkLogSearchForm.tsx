...
export default class LinkLogSearchComponent extends React.Component<
  LinkLogSearchComponentProps,
  LinkLogSearchComponentState
> {
  state = {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.LinkLogs + '?limit=100';
...
export const WrappedLinkLogSearchComponent = Form.create({
  name: 'LinkLog Search',
})(LinkLogSearchComponent);


/*<Codenesium>
    <Hash>75253e14fcaba538e63b729aeb0f8e88</Hash>
</Codenesium>*/