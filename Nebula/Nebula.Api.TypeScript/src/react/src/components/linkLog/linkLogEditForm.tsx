...
const LinkLogEdit = withFormik<Props, LinkLogViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.LinkLogs +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.LinkLogClientRequestModel>;
  ...
  export default class LinkLogEditComponent extends React.Component<LinkLogEditComponentProps, LinkLogEditComponentState> {
...
/*<Codenesium>
    <Hash>05f7fc8893a40ff1d9e7795ed614a637</Hash>
</Codenesium>*/