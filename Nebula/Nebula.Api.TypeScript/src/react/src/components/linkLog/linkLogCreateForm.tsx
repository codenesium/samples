...
const LinkLogCreateDisplay: React.SFC<FormikProps<LinkLogViewModel>> = (
  props: FormikProps<LinkLogViewModel>
) => {
...
export default class LinkLogCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>54ee6021287ee999ff757db694a570a8</Hash>
</Codenesium>*/