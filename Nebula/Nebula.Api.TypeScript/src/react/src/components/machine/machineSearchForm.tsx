...
export default class MachineSearchComponent extends React.Component<MachineSearchComponentProps, MachineSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<MachineViewModel>(), filteredRecords:new Array<MachineViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedMachineSearchComponent = Form.create({ name: 'Machine Search' })(MachineSearchComponent);

/*<Codenesium>
    <Hash>3c1bcde863b1f7a06b3dec88b7b244de</Hash>
</Codenesium>*/