...
const TeamEdit = withFormik<Props, TeamViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Teams +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.TeamClientRequestModel>;
  ...
  export default class TeamEditComponent extends React.Component<TeamEditComponentProps, TeamEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Teams + '/' + this.props.match.params.id, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
