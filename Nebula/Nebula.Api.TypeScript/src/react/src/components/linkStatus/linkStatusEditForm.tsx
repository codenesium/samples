...
class LinkStatusEditComponent extends React.Component<
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new LinkStatusMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.LinkStatuses + '/' + this.state.model!.id,
...
export const WrappedLinkStatusEditComponent = Form.create({ name: 'LinkStatus Edit' })(LinkStatusEditComponent);

/*<Codenesium>
    <Hash>0ff21a81caa47dffbea0a73f37b88fad</Hash>
</Codenesium>*/