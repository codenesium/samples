...
> {
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.LinkStatusClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedLinkStatusSearchComponent = Form.create({
  name: 'LinkStatus Search',
})(LinkStatusSearchComponent);
