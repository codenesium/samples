...
export default class LinkStatusSearchComponent extends React.Component<
  LinkStatusSearchComponentProps,
  LinkStatusSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<LinkStatusViewModel>(),
    filteredRecords: new Array<LinkStatusViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
                        ...
                        <button
                          ...
                          onClick={e => {
                            this.handleDetailClick(
                              e,
                              row.original as Api.LinkStatusClientResponseModel
                            );
                          }}
                        >
...
/*<Codenesium>
    <Hash>8e56379790c7036e4f5cb949a8381384</Hash>
</Codenesium>*/