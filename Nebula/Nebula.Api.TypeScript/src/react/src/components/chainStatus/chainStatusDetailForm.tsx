  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.ChainStatuses + '/edit/' + model.model!.id
          );
        }}
      >
...
export default class ChainStatusDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>cf3ba6706e243d64e6215911f4832e1e</Hash>
</Codenesium>*/