...
export default class ChainStatusSearchComponent extends React.Component<
  ChainStatusSearchComponentProps,
  ChainStatusSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<ChainStatusViewModel>(),
    filteredRecords: new Array<ChainStatusViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  handleEditClick(e: any, row: Api.ChainStatusClientResponseModel) {
    this.props.history.push(ClientRoutes.ChainStatuses + '/edit/' + row.id);
  }

  handleDetailClick(e: any, row: Api.ChainStatusClientResponseModel) {
                        ...
                        <button
                          ...
                          onClick={e => {
                            this.handleDetailClick(
                              e,
                              row.original as Api.ChainStatusClientResponseModel
                            );
                          }}
                        >
...
/*<Codenesium>
    <Hash>ceea1bb8c0a2590c91fc8179b77c9c7e</Hash>
</Codenesium>*/