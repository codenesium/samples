...
> {
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.ChainStatusClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedChainStatusSearchComponent = Form.create({
  name: 'ChainStatus Search',
})(ChainStatusSearchComponent);
