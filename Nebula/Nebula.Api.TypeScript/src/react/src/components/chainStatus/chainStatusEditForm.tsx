...
class ChainStatusEditComponent extends React.Component<
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new ChainStatusMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.ChainStatuses + '/' + this.state.model!.id,
...
export const WrappedChainStatusEditComponent = Form.create({ name: 'ChainStatus Edit' })(ChainStatusEditComponent);

/*<Codenesium>
    <Hash>afa42e1194514d922ec285ac853e79ba</Hash>
</Codenesium>*/