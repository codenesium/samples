...
interface TeamSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class  TeamSelectComponent extends React.Component<
TeamSelectComponentProps,
TeamSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
    ...
    axios
      ...
      .then(
        resp => {
          ...
          let devices:Array<TeamViewModel> = [];
...
/*<Codenesium>
    <Hash>f77996c3f6bb678609d61651696b8026</Hash>
</Codenesium>*/