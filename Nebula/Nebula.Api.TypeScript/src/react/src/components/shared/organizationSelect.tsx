...
interface OrganizationSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class OrganizationSelectComponent extends React.Component<
  OrganizationSelectComponentProps,
  OrganizationSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
    ...
    axios
      ...
      .then(
        resp => {
          ...
          let devices: Array<OrganizationViewModel> = [];
...
/*<Codenesium>
    <Hash>bae0cd9fa23788246f2ca44228135e1c</Hash>
</Codenesium>*/