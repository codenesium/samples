...
interface LinkLogSelectComponentProps {
...
interface LinkLogSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class LinkLogSelectComponent extends React.Component<
  LinkLogSelectComponentProps,
  LinkLogSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
    ...
    axios
      ...
      .then(
        resp => {
          ...
          let devices: Array<LinkLogViewModel> = [];
...
/*<Codenesium>
    <Hash>7143d5d8bac4aff54a5a85e7c892efcd</Hash>
</Codenesium>*/