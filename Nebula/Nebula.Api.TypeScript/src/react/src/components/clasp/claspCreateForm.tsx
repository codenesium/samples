...
> {
  ...
  submit = (model: ClaspViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.ClaspClientRequestModel>>(
...
export const WrappedClaspCreateComponent = Form.create({
  name: 'Clasp Create',
})(ClaspCreateComponent);


/*<Codenesium>
    <Hash>95a71973708d7d05667d39bb586bda8d</Hash>
</Codenesium>*/