...
> {
  ...
  submit = (model: ChainViewModel) => {
    let mapper = new ChainMapper();
    axios
      .put<CreateResponse<Api.ChainClientRequestModel>>(
...
export const WrappedChainEditComponent = Form.create({ name: 'Chain Edit' })(
  ChainEditComponent
);


/*<Codenesium>
    <Hash>c2b96feebb1239e17dddecfa53ef491f</Hash>
</Codenesium>*/