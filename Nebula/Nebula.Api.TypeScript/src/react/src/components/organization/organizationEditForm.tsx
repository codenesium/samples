...
class OrganizationEditComponent extends React.Component<
...
> {
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
     ...
     this.props.form.validateFields((err:any, values:any) => {
      if (!err) {
        let model = values as OrganizationViewModel;
  ...
  submit = (model:OrganizationViewModel) =>
  {  
    let mapper = new OrganizationMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Organizations + '/' + this.state.model!.id,
...
export const WrappedOrganizationEditComponent = Form.create({ name: 'Organization Edit' })(OrganizationEditComponent);

/*<Codenesium>
    <Hash>4a0dad5a42f7d972e6ee3a2cb2beb98b</Hash>
</Codenesium>*/