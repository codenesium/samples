...
interface Props {
  ...
  const OrganizationEditDisplay = (props: FormikProps<OrganizationViewModel>) => {
   ...
   let status = props.status as UpdateResponse<Api.OrganizationClientRequestModel>;
...
const OrganizationEdit = withFormik<Props, OrganizationViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Organizations +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.OrganizationClientRequestModel>;
  ...
  export default class OrganizationEditComponent extends React.Component<OrganizationEditComponentProps, OrganizationEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Organizations + '/' + this.props.match.params.id, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
