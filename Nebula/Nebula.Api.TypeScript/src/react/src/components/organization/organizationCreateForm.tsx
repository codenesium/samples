...
class OrganizationCreateComponent extends React.Component<
...
> {
  ...
  submit = (model: OrganizationViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.OrganizationClientRequestModel>>(
...
export const WrappedOrganizationCreateComponent = Form.create({
  name: 'Organization Create',
})(OrganizationCreateComponent);


/*<Codenesium>
    <Hash>d60b3b1f0d5c5a9ab97d07f2790e14b2</Hash>
</Codenesium>*/