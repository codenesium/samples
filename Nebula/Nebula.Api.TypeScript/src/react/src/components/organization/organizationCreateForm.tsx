...
export const WrappedOrganizationCreateComponent = Form.create({ name: 'Organization Create' })(OrganizationCreateComponent);

/*<Codenesium>
    <Hash>90066d784f04648c8686081df3bca861</Hash>
</Codenesium>*/