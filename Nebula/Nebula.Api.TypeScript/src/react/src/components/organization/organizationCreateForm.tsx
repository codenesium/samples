...
interface Props {
   ...
   const OrganizationCreateDisplay: React.SFC<FormikProps<OrganizationViewModel>> = (props: FormikProps<OrganizationViewModel>) => {

   let status = props.status as CreateResponse<Api.OrganizationClientRequestModel>;
   
   let errorsForField = (name:string) : string =>
   {
        let response = '';
        if(props.touched[name as keyof OrganizationViewModel]  && props.errors[name as keyof OrganizationViewModel]) {
...
const OrganizationCreate = withFormik<Props, OrganizationViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.Organizations,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.OrganizationClientRequestModel>;
  ...
  export default class OrganizationCreateComponent extends React.Component<OrganizationCreateComponentProps, OrganizationCreateComponentState> {
...
/*<Codenesium>
    <Hash>c25351a8e08ac475bbd6817023d24c45</Hash>
</Codenesium>*/