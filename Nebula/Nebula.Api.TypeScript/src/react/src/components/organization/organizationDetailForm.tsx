  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.Organizations + '/edit/' + model.model!.id
          );
        }}
      >
...
export default class OrganizationDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>61c5034fbb7663036374e3711654f7ef</Hash>
</Codenesium>*/