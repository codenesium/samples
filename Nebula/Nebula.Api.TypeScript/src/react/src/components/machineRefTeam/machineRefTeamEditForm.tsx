...
interface MachineRefTeamEditComponentProps {
  form: WrappedFormUtils;
  history: any;
  match: any;
}

interface MachineRefTeamEditComponentState {
...
class MachineRefTeamEditComponent extends React.Component<
  MachineRefTeamEditComponentProps,
  MachineRefTeamEditComponentState
> {
  state = {
  ...
  submit = (model: MachineRefTeamViewModel) => {
    let mapper = new MachineRefTeamMapper();
    axios
      .put<CreateResponse<Api.MachineRefTeamClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.MachineRefTeams +
          '/' +
          this.state.model!.id,
...
export const WrappedMachineRefTeamEditComponent = Form.create({
  name: 'MachineRefTeam Edit',
})(MachineRefTeamEditComponent);


/*<Codenesium>
    <Hash>747cb24563926403240abe6c1b9e43f6</Hash>
</Codenesium>*/