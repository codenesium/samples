...
namespace NebulaNS.Api.Service
{
	...
	{
		IClaspModelValidator validator { get; set; }

		public ClaspFilter(IClaspModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<ClaspModel>().ToList();
...
/*<Codenesium>
    <Hash>f886beda9d5e0ef8052b1b9a4dca6daf</Hash>
</Codenesium>*/