...
namespace NebulaNS.Api.Service
{
	...
	{
		IMachineRefTeamModelValidator validator { get; set; }

		public MachineRefTeamFilter(IMachineRefTeamModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<MachineRefTeamModel>().ToList();
...
/*<Codenesium>
    <Hash>cb5eebf05ac49f47097cf39123dc1e4b</Hash>
</Codenesium>*/