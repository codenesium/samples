...
namespace NebulaNS.Api.Service
{
	...
	{
		ILinkLogModelValidator validator { get; set; }

		public LinkLogFilter(ILinkLogModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<LinkLogModel>().ToList();
...
/*<Codenesium>
    <Hash>768658a6f4d4ad08087ebf03b0654422</Hash>
</Codenesium>*/