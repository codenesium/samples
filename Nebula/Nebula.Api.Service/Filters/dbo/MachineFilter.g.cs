...
namespace NebulaNS.Api.Service
{
	...
	{
		IMachineModelValidator validator { get; set; }

		public MachineFilter(IMachineModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<MachineModel>().ToList();
...
/*<Codenesium>
    <Hash>627bd2d424997d06aaec36d3240bb5e3</Hash>
</Codenesium>*/