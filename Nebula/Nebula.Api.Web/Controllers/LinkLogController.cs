...
namespace NebulaNS.Api.Web
{
	...
	public class LinkLogController : AbstractApiController
	{
		...
		public virtual async Task<IActionResult> Create([FromBody] ApiLinkLogServerRequestModel model)
		{
			...
			if (result.Success)
			{
				return this.Created($"{this.Settings.ExternalBaseUrl}/api/LinkLogs/{result.Record.Id}", result);
			}
			else
			{
				return this.StatusCode(StatusCodes.Status422UnprocessableEntity, result);
...
/*<Codenesium>
    <Hash>9de7e114e18b5660b3b0a121ca8d848a</Hash>
    <Hello>
