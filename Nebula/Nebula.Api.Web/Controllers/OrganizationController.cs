...
namespace NebulaNS.Api.Web
{
	...
	public class OrganizationController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiOrganizationServerResponseModel> response = await this.OrganizationService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>1ddef66673724469e4f4795b4edc26fc</Hash>
    <Hello>
