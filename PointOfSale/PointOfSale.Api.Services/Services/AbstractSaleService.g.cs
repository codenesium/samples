...
namespace PointOfSaleNS.Api.Services
{
	public abstract class AbstractSaleService : AbstractService
	{
		...
		public async virtual Task<List<ApiSaleServerResponseModel>> ByCustomerId(int customerId, int limit = 0, int offset = int.MaxValue)
		{
			List<Sale> records = await this.SaleRepository.ByCustomerId(customerId, limit, offset);
...
/*<Codenesium>
    <Hash>f0fe037e178f603077a280f2de5567ca</Hash>
</Codenesium>*/