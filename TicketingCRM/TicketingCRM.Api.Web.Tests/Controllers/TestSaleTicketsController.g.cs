...
namespace TicketingCRMNS.Api.Web.Tests
{
        ...
        public partial class SaleTicketsControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        SaleTicketsController controller = new SaleTicketsController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiSaleTicketsResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiSaleTicketsRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiSaleTicketsRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        SaleTicketsController controller = new SaleTicketsController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>8cf6a88a32d985a94399cb24f0d888a4</Hash>
</Codenesium>*/