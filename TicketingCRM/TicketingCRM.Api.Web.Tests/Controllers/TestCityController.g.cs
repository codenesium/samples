...
namespace TicketingCRMNS.Api.Web.Tests
{
        ...
        public partial class CityControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        CityController controller = new CityController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiCityResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiCityRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiCityRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        CityController controller = new CityController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>c3d5c1b57a8da3d2b0ffebb3eca24deb</Hash>
</Codenesium>*/