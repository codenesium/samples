...
namespace TicketingCRMNS.Api.Web.Tests
{
        ...
        public partial class TicketStatusControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        TicketStatusController controller = new TicketStatusController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiTicketStatusResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiTicketStatusRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiTicketStatusRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        TicketStatusController controller = new TicketStatusController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>a40d78df2e821fc952f01c4fbfebb6bb</Hash>
</Codenesium>*/