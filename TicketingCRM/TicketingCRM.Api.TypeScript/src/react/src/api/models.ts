...
this.website = '';
				...
				setProperties(address1 : string,address2 : string,cityId : number,date : any,description : string,endDate : any,facebook : string,id : number,name : string,startDate : any,website : string) : void
				{
...
ticketStatusIdNavigation? : TicketStatuClientResponseModel;
...
this.ticketStatusId = ticketStatusId;
			...
			export class TicketStatuClientRequestModel {
				id:number;
name:string;
...
this.name = name;
			...
			export class TicketStatuClientResponseModel {
				id:number;
name:string;
...
transactionStatusIdNavigation? : TransactionStatuClientResponseModel;
...
this.transactionStatusId = transactionStatusId;
			...
			export class TransactionStatuClientRequestModel {
				id:number;
name:string;
...
this.name = name;
			...
			export class TransactionStatuClientResponseModel {
				id:number;
name:string;
...
/*<Codenesium>
    <Hash>ece0501d0a57897f81a7d0f8160853c4</Hash>
</Codenesium>*/