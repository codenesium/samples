	...
	<Security issuer={config.oidc.issuer}
        ...
        <Switch>
		  ...
		  <Route path={ClientRoutes.Admins + "/create"} component={wrapperHeader(WrappedAdminCreateComponent, "Admins Create")} />
					...
					<Route path={ClientRoutes.SaleTickets + "/create"} component={wrapperHeader(WrappedSaleTicketCreateComponent, "Sale Tickets Create")} />
                      <Route path={ClientRoutes.SaleTickets + "/edit/:id"} component={wrapperHeader(WrappedSaleTicketEditComponent, "Sale Tickets Edit")} />
                      <Route path={ClientRoutes.SaleTickets + "/:id"} component={wrapperHeader(WrappedSaleTicketDetailComponent , "Sale Tickets Detail")} />
                      <Route path={ClientRoutes.SaleTickets} component={wrapperHeader(WrappedSaleTicketSearchComponent, "Sale Tickets Search")} />
					...
					<Route path={ClientRoutes.TicketStatus + "/create"} component={wrapperHeader(WrappedTicketStatusCreateComponent, "Ticket Status Create")} />
                      <Route path={ClientRoutes.TicketStatus + "/edit/:id"} component={wrapperHeader(WrappedTicketStatusEditComponent, "Ticket Status Edit")} />
                      <Route path={ClientRoutes.TicketStatus + "/:id"} component={wrapperHeader(WrappedTicketStatusDetailComponent , "Ticket Status Detail")} />
                      <Route path={ClientRoutes.TicketStatus} component={wrapperHeader(WrappedTicketStatusSearchComponent, "Ticket Status Search")} />
					...
					<Route path={ClientRoutes.TransactionStatus + "/create"} component={wrapperHeader(WrappedTransactionStatusCreateComponent, "Transaction Status Create")} />
                      <Route path={ClientRoutes.TransactionStatus + "/edit/:id"} component={wrapperHeader(WrappedTransactionStatusEditComponent, "Transaction Status Edit")} />
                      <Route path={ClientRoutes.TransactionStatus + "/:id"} component={wrapperHeader(WrappedTransactionStatusDetailComponent , "Transaction Status Detail")} />
                      <Route path={ClientRoutes.TransactionStatus} component={wrapperHeader(WrappedTransactionStatusSearchComponent, "Transaction Status Search")} />
...
/*<Codenesium>
    <Hash>f8288d6ccae7ce23688da64755e2718c</Hash>
</Codenesium>*/