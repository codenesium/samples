        ...
        <Switch>
          <Route exact path="/" component={Dashboard} />
					  ...
					  <Route path="/events" component={EventSearchComponent} />
										  <Route path="/provinces/create" component={ProvinceCreateComponent} />
					  <Route path="/provinces/edit/:id" component={ProvinceEditComponent} />
					  ...
					  <Route path="/sales" component={SaleSearchComponent} />
										  <Route path="/saletickets/create" component={SaleTicketCreateComponent} />
					  <Route path="/saletickets/edit/:id" component={SaleTicketEditComponent} />
					  <Route path="/saletickets/:id" component={SaleTicketDetailComponent} />
					  ...
					  <Route path="/tickets" component={TicketSearchComponent} />
										  <Route path="/ticketstatus/create" component={TicketStatuCreateComponent} />
					  <Route path="/ticketstatus/edit/:id" component={TicketStatuEditComponent} />
					  <Route path="/ticketstatus/:id" component={TicketStatuDetailComponent} />
					  <Route path="/ticketstatus" component={TicketStatuSearchComponent} />
										  <Route path="/transactions/create" component={TransactionCreateComponent} />
					  <Route path="/transactions/edit/:id" component={TransactionEditComponent} />
					  <Route path="/transactions/:id" component={TransactionDetailComponent} />
					  <Route path="/transactions" component={TransactionSearchComponent} />
										  <Route path="/transactionstatus/create" component={TransactionStatuCreateComponent} />
					  <Route path="/transactionstatus/edit/:id" component={TransactionStatuEditComponent} />
					  <Route path="/transactionstatus/:id" component={TransactionStatuDetailComponent} />
					  <Route path="/transactionstatus" component={TransactionStatuSearchComponent} />
...
/*<Codenesium>
    <Hash>dc937400e7a18e0013222c9736710d98</Hash>
</Codenesium>*/