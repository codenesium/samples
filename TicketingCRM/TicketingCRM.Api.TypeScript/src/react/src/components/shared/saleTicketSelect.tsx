...
interface SaleTicketSelectComponentProps {
...
interface SaleTicketSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class SaleTicketSelectComponent extends React.Component<
  SaleTicketSelectComponentProps,
  SaleTicketSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(response => {
        ...
        let devices: Array<SaleTicketViewModel> = [];
      ...
      return (
        <Form.Item>
          ...
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map((x: SaleTicketViewModel) => {
                return (
...
/*<Codenesium>
    <Hash>3e8e4bf26e6fa9471acd8e98b3c0f306</Hash>
</Codenesium>*/