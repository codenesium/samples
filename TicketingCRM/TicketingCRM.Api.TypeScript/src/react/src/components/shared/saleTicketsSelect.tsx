...
interface SaleTicketsSelectComponentProps {
...
interface SaleTicketsSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class SaleTicketsSelectComponent extends React.Component<
  SaleTicketsSelectComponentProps,
  SaleTicketsSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(response => {
        ...
        let devices: Array<SaleTicketsViewModel> = [];
      ...
      return (
        <Form.Item>
          ...
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map((x: SaleTicketsViewModel) => {
                return (
