...
export default class AdminSearchComponent extends React.Component<AdminSearchComponentProps, AdminSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<AdminViewModel>(), filteredRecords:new Array<AdminViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleCreateClick(e:any) {
        this.props.history.push(ClientRoutes.Admins + '/create');
    }

    handleDeleteClick(e:any, row:Api.AdminClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.Admins + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.Admins + '?limit=100';
...
/*<Codenesium>
    <Hash>e7237ab3ae7ceb525431fade7785a49f</Hash>
</Codenesium>*/