...
const SaleTicketEdit = withFormik<Props, SaleTicketViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.SaleTickets +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.SaleTicketClientRequestModel>;
  ...
  export default class SaleTicketEditComponent extends React.Component<SaleTicketEditComponentProps, SaleTicketEditComponentState> {
...
/*<Codenesium>
    <Hash>3a8f9f78be93f6af6681f6e73ca0c6ef</Hash>
</Codenesium>*/