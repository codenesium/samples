  ...
  const SaleTicketEditDisplay = (props: FormikProps<SaleTicketViewModel>) => {
   ...
   return (
          ...
          <form onSubmit={props.handleSubmit} role="form">
					    ...
					    <div className="col-sm-12">
                             <Field type="datetime-local" name="ticketId" className={errorExistForField("ticketId") ? "form-control is-invalid" : "form-control"} />
...
/*<Codenesium>
    <Hash>ecda0c898b2878ddfbb5a5c4bd07caba</Hash>
</Codenesium>*/