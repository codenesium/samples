  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.SaleTickets + '/edit/' + model.model!.id
          );
        }}
      >
      ...
      <div className="form-group row">
        <label htmlFor="ticketId" className={'col-sm-2 col-form-label'}>
          TicketId
        </label>
        <div className="col-sm-12">
...
export default class SaleTicketDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>fb18e4438bd1db4bf085797cf74369c1</Hash>
</Codenesium>*/