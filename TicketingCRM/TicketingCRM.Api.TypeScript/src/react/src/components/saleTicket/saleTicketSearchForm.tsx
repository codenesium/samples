...
export default class SaleTicketSearchComponent extends React.Component<
  SaleTicketSearchComponentProps,
  SaleTicketSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<SaleTicketViewModel>(),
    filteredRecords: new Array<SaleTicketViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
                        ...
                        <Button
                          ...
                          onClick={(e: any) => {
                            this.handleDetailClick(
                              e,
                              row.original as Api.SaleTicketClientResponseModel
                            );
                          }}
                        >
...
export const WrappedSaleTicketSearchComponent = Form.create({
  name: 'SaleTicket Search',
})(SaleTicketSearchComponent);
