...
import SaleTicketViewModel from  './saleTicketViewModel';
	...
	mapApiResponseToViewModel(dto: Api.SaleTicketClientResponseModel) : SaleTicketViewModel 
	{
		...
		response.setProperties(dto.id,dto.saleId,dto.ticketId);
						...
						if(dto.saleIdNavigation != null)
				{
				  ...
				  dto.saleIdNavigation.id,dto.saleIdNavigation.ipAddress,dto.saleIdNavigation.note,dto.saleIdNavigation.saleDate,dto.saleIdNavigation.transactionId
				  );
				}
							if(dto.ticketIdNavigation != null)
				{
				  ...
				  dto.ticketIdNavigation.id,dto.ticketIdNavigation.publicId,dto.ticketIdNavigation.ticketStatusId
				  );
				}
	...
	mapViewModelToApiRequest(model: SaleTicketViewModel) : Api.SaleTicketClientRequestModel
	{
...
/*<Codenesium>
    <Hash>14df6851ba0d02fb6d8c2d141f69ca6b</Hash>
</Codenesium>*/