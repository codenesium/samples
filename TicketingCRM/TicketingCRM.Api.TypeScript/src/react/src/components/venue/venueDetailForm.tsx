  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(ClientRoutes.Venues + '/edit/' + model.model!.id);
        }}
      >
      ...
      <div className="form-group row">
        <label htmlFor="provinceId" className={'col-sm-2 col-form-label'}>
          ProvinceId
        </label>
        <div className="col-sm-12">
...
export default class VenueDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>af1d00dcd2e44b56067b60cc80878ba6</Hash>
</Codenesium>*/