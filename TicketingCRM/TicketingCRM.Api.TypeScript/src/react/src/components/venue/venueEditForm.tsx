...
const VenueEdit = withFormik<Props, VenueViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Venues + '/' + values.id,
...
export default class VenueEditComponent extends React.Component<
...
/*<Codenesium>
    <Hash>a302f219f21e0e058e1644bdee03987c</Hash>
</Codenesium>*/