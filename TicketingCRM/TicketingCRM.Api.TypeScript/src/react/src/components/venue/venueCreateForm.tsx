...
const VenueCreateDisplay: React.SFC<FormikProps<VenueViewModel>> = (
  props: FormikProps<VenueViewModel>
) => {
  ...
  let errorsForField = (name: string): string => {
    let response = '';
    if (
      props.touched[name as keyof VenueViewModel] &&
      props.errors[name as keyof VenueViewModel]
    ) {
    ...
    <form onSubmit={props.handleSubmit} role="form">
      ...
      <div className="form-group row">
        ...
        <div className="col-sm-12">
          ...
          />
          {errorExistForField('adminId') && (
            <small className="text-danger">{errorsForField('adminId')}</small>
          )}
        </div>
      </div>
...
export default class VenueCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>ea18d43925afb18ae870d575693bc625</Hash>
</Codenesium>*/