...
export default class VenueSearchComponent extends React.Component<VenueSearchComponentProps, VenueSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<VenueViewModel>(), filteredRecords:new Array<VenueViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>57a4294fe5476f4c1dd86a177b91e1db</Hash>
</Codenesium>*/