...
export default class TransactionSearchComponent extends React.Component<TransactionSearchComponentProps, TransactionSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<TransactionViewModel>(), filteredRecords:new Array<TransactionViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedTransactionSearchComponent = Form.create({ name: 'Transaction Search' })(TransactionSearchComponent);

/*<Codenesium>
    <Hash>5833593cc20b2020886f9e6df85ed409</Hash>
</Codenesium>*/