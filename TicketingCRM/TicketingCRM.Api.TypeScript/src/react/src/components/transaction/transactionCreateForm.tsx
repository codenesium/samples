...
interface Props {
   ...
   const TransactionCreateDisplay: React.SFC<FormikProps<TransactionViewModel>> = (props: FormikProps<TransactionViewModel>) => {

   let status = props.status as CreateResponse<Api.TransactionClientRequestModel>;
...
const TransactionCreate = withFormik<Props, TransactionViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.Transactions,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.TransactionClientRequestModel>;
  ...
  export default class TransactionCreateComponent extends React.Component<TransactionCreateComponentProps, TransactionCreateComponentState> {
...
/*<Codenesium>
    <Hash>f0af78929c5181b5e70e9b99475afa8d</Hash>
</Codenesium>*/