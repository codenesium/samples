  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.Transactions + '/edit/' + model.model!.id
          );
        }}
      >
      ...
      <div className="form-group row">
        <label
          htmlFor="gatewayConfirmationNumber"
...
export default class TransactionDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>333855248e503ec98251911c085abaf9</Hash>
</Codenesium>*/