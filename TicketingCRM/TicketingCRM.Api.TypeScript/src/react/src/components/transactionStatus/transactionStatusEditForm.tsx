...
> {
  ...
  submit = (model: TransactionStatusViewModel) => {
    let mapper = new TransactionStatusMapper();
    axios
      .put<CreateResponse<Api.TransactionStatusClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.TransactionStatus +
          '/' +
          this.state.model!.id,
...
export const WrappedTransactionStatusEditComponent = Form.create({
  name: 'TransactionStatus Edit',
})(TransactionStatusEditComponent);
