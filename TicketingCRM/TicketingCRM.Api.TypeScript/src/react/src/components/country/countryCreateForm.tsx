...
const CountryCreateDisplay: React.SFC<FormikProps<CountryViewModel>> = (
  props: FormikProps<CountryViewModel>
) => {
...
export default class CountryCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>8e4442dc34bbae754f0a854097724941</Hash>
</Codenesium>*/