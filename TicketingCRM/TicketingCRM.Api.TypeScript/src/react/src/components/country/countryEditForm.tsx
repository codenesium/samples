...
interface Props {
  ...
  const CountryEditDisplay = (props: FormikProps<CountryViewModel>) => {

   let status = props.status as UpdateResponse<Api.CountryClientRequestModel>;
...
const CountryEdit = withFormik<Props, CountryViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Countries +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.CountryClientRequestModel>;
  ...
  export default class CountryEditComponent extends React.Component<CountryEditComponentProps, CountryEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Countries + '/' + this.props.match.params.id, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<CountryEdit model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>a9b56a1076fbd35c28fe165030366549</Hash>
</Codenesium>*/