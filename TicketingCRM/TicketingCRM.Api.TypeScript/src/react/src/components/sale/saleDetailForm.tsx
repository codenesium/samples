...
const SaleDetailDisplay = (model: Props) => {
  return (
    <form role="form">
      ...
      <div className="form-group row">
        <label htmlFor="ipAddress" className={'col-sm-2 col-form-label'}>
          IpAddress
        </label>
        <div className="col-sm-12">{String(model.model!.ipAddress)}</div>
      </div>
      <div className="form-group row">
...
/*<Codenesium>
    <Hash>398a4b1d3a6abb6f72c5a3f3ae652bd1</Hash>
</Codenesium>*/