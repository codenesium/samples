...
interface TicketSearchComponentProps
{
...
interface TicketSearchComponentState
{
    records:Array<TicketViewModel>;
...
export default class TicketSearchComponent extends React.Component<TicketSearchComponentProps, TicketSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<TicketViewModel>(), filteredRecords:new Array<TicketViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleCreateClick(e:any) {
        this.props.history.push(ClientRoutes.Tickets + '/create');
    }

    handleDeleteClick(e:any, row:Api.TicketClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.Tickets + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.Tickets + '?limit=100';
	   ...
	   .then(resp => {
		    ...
		    let viewModels : Array<TicketViewModel> = [];
            ...
            <ReactTable 
                ...
                columns={[{
                    ...
                    columns: [
                      ...
                      Cell: (props) => {
                        return <a href='' onClick={(e) => { e.preventDefault(); this.props.history.push(ClientRoutes.TicketStatus + '/' + props.original.ticketStatusId); }}>
                          {String(
...
/*<Codenesium>
    <Hash>d3b88934568488f5777eb3d9d7acbbfd</Hash>
</Codenesium>*/