  ...
  const TicketEditDisplay = (props: FormikProps<TicketViewModel>) => {
   ...
   return (
          ...
          <form onSubmit={props.handleSubmit} role="form">
					    ...
					    <div className="col-sm-12">
                             <Field type="datetime-local" name="publicId" className={errorExistForField("publicId") ? "form-control is-invalid" : "form-control"} />
					    ...
					    <div className="col-sm-12">
                             <Field type="datetime-local" name="ticketStatusId" className={errorExistForField("ticketStatusId") ? "form-control is-invalid" : "form-control"} />
...
const TicketEdit = withFormik<Props, TicketViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Tickets +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.TicketClientRequestModel>;
  ...
  export default class TicketEditComponent extends React.Component<TicketEditComponentProps, TicketEditComponentState> {
...
/*<Codenesium>
    <Hash>008660168268b4a87324a28fa1463345</Hash>
</Codenesium>*/