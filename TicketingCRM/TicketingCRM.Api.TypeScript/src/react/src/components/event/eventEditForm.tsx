  ...
  const EventEditDisplay = (props: FormikProps<EventViewModel>) => {
   ...
   return (
          ...
          <form onSubmit={props.handleSubmit} role="form">
					    ...
					    <div className="col-sm-12">
                             <Field type="datetime-local" name="cityId" className={errorExistForField("cityId") ? "form-control is-invalid" : "form-control"} />
...
/*<Codenesium>
    <Hash>932d5027724dd607204ced8c26aa83db</Hash>
</Codenesium>*/