...
interface Props {
   ...
   const TicketStatusCreateDisplay: React.SFC<FormikProps<TicketStatusViewModel>> = (props: FormikProps<TicketStatusViewModel>) => {

   let status = props.status as CreateResponse<Api.TicketStatusClientRequestModel>;
   
   let errorsForField = (name:string) : string =>
   {
        let response = '';
        if(props.touched[name as keyof TicketStatusViewModel]  && props.errors[name as keyof TicketStatusViewModel]) {
...
const TicketStatusCreate = withFormik<Props, TicketStatusViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.TicketStatus,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.TicketStatusClientRequestModel>;
  ...
  export default class TicketStatusCreateComponent extends React.Component<TicketStatusCreateComponentProps, TicketStatusCreateComponentState> {
...
/*<Codenesium>
    <Hash>649c5cc512a5e4d3388e871f3c7ebf7d</Hash>
</Codenesium>*/