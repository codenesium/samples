...
export default class TicketStatusSearchComponent extends React.Component<TicketStatusSearchComponentProps, TicketStatusSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<TicketStatusViewModel>(), filteredRecords:new Array<TicketStatusViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.TicketStatusClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.TicketStatus + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.TicketStatus + '?limit=100';
...
/*<Codenesium>
    <Hash>78d7e1488f6557138c676044c02b5c20</Hash>
</Codenesium>*/