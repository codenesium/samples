...
const ProvinceEdit = withFormik<Props, ProvinceViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Provinces + '/' + values.id,
...
export default class ProvinceEditComponent extends React.Component<
...
/*<Codenesium>
    <Hash>7e3a41ab1bf974999318dfdc1b7f8f6c</Hash>
</Codenesium>*/