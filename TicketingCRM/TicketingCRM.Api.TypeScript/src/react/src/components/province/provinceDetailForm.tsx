  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.Provinces + '/edit/' + model.model!.id
          );
        }}
      >
...
export default class ProvinceDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>d1cde3bca0a67a30f275ae88a9963c89</Hash>
</Codenesium>*/