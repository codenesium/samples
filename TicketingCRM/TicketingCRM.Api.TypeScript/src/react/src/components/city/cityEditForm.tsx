...
const CityEdit = withFormik<Props, CityViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.Cities + '/' + values.id,
...
export default class CityEditComponent extends React.Component<
...
/*<Codenesium>
    <Hash>59d9f27c84d7eb784cf335fd3d79f480</Hash>
</Codenesium>*/