  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(ClientRoutes.Cities + '/edit/' + model.model!.id);
        }}
      >
...
export default class CityDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>bb32f268bf7c29bb03a52e6d0b53e479</Hash>
</Codenesium>*/