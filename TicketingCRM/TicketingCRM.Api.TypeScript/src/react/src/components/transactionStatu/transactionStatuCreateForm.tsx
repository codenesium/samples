...
const TransactionStatuCreateDisplay: React.SFC<
  FormikProps<TransactionStatuViewModel>
...
export default class TransactionStatuCreateComponent extends React.Component<
  TransactionStatuCreateComponentProps,
  TransactionStatuCreateComponentState
> {
  state = {
    model: undefined,
    loading: false,
...
/*<Codenesium>
    <Hash>0efccd44025f3ec41d9aa915e7ed087f</Hash>
</Codenesium>*/