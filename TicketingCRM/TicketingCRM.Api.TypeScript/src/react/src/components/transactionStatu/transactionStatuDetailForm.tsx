...
const TransactionStatuDetailDisplay = (model:Props) => {
   ...
   return (
          <form  role="form">
				<button
                  ...
                  onClick={(e) => { model.history.push(ClientRoutes.TransactionStatus + '/edit/' + model.model!.id)}}
                >
  ...
  export default class TransactionStatuDetailComponent extends React.Component<TransactionStatuDetailComponentProps, TransactionStatuDetailComponentState> {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<TransactionStatuDetailDisplay history={this.props.history} model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>66e02cca99c9763bf9b03a965b617db0</Hash>
</Codenesium>*/