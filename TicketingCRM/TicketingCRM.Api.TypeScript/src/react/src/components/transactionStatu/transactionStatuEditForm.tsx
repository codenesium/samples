...
interface Props {
  ...
  const TransactionStatuEditDisplay = (props: FormikProps<TransactionStatuViewModel>) => {

   let status = props.status as UpdateResponse<Api.TransactionStatuClientRequestModel>;
...
const TransactionStatuEdit = withFormik<Props, TransactionStatuViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.TransactionStatuClientRequestModel>;
  ...
  export default class TransactionStatuEditComponent extends React.Component<TransactionStatuEditComponentProps, TransactionStatuEditComponentState> {
...
/*<Codenesium>
    <Hash>ee4e9e3294a680cc119466d1e51ffece</Hash>
</Codenesium>*/