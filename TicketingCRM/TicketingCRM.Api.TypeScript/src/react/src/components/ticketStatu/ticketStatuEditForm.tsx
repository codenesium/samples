...
const TicketStatuEdit = withFormik<Props, TicketStatuViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.TicketStatus + '/' + values.id,
...
export default class TicketStatuEditComponent extends React.Component<
  TicketStatuEditComponentProps,
  TicketStatuEditComponentState
> {
  state = {
    model: undefined,
    loading: false,
...
/*<Codenesium>
    <Hash>f2f91d7a95f5f7e5a9aa4bfaba635bab</Hash>
</Codenesium>*/