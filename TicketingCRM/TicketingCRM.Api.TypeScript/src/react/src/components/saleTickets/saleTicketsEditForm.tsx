...
interface SaleTicketsEditComponentProps {
  form: WrappedFormUtils;
  history: any;
  match: any;
}

interface SaleTicketsEditComponentState {
...
class SaleTicketsEditComponent extends React.Component<
  SaleTicketsEditComponentProps,
  SaleTicketsEditComponentState
> {
  state = {
  ...
  submit = (model: SaleTicketsViewModel) => {
    let mapper = new SaleTicketsMapper();
    axios
      .put<CreateResponse<Api.SaleTicketsClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.SaleTickets +
          '/' +
          this.state.model!.id,
...
export const WrappedSaleTicketsEditComponent = Form.create({
  name: 'SaleTickets Edit',
})(SaleTicketsEditComponent);


/*<Codenesium>
    <Hash>61fd823e67720ba5312199e63e121ee6</Hash>
    <Hello>
