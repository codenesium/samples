...
export default class CustomerMapper {
	...
	mapApiResponseToViewModel(dto: Api.CustomerClientResponseModel) : CustomerViewModel 
	{
		...
		response.setProperties(dto.email,dto.firstName,dto.id,dto.lastName,dto.phone);
	...
	mapViewModelToApiRequest(model: CustomerViewModel) : Api.CustomerClientRequestModel
	{
		...
		response.setProperties(model.email,model.firstName,model.id,model.lastName,model.phone);
		return response;
	}
};

/*<Codenesium>
    <Hash>c8d5ba76aaca7085bbae2cba841ba9f7</Hash>
</Codenesium>*/