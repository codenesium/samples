...
REFERENCES[dbo].[Province]([id]) on delete no action on update no action
GO
...
REFERENCES[dbo].[City]([id]) on delete no action on update no action
GO
...
REFERENCES[dbo].[Transaction]([id]) on delete no action on update no action
GO
...
REFERENCES[dbo].[Sale]([id]) on delete no action on update no action
GO
...
REFERENCES[dbo].[Ticket]([id]) on delete no action on update no action
GO
...
REFERENCES[dbo].[TicketStatus]([id]) on delete no action on update no action
GO
...
REFERENCES[dbo].[TransactionStatus]([id]) on delete no action on update no action
GO
...
REFERENCES[dbo].[Admin]([id]) on delete no action on update no action
GO
