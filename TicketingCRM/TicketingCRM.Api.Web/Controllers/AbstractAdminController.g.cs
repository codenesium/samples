...
namespace TicketingCRMNS.Api.Web
{
	public abstract class AbstractAdminController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> VenuesByAdminId(int adminId, int? limit, int? offset)
		{
			...
			List<ApiVenueResponseModel> response = await this.AdminService.VenuesByAdminId(adminId, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>41b702412d48084345032717202bed37</Hash>
</Codenesium>*/