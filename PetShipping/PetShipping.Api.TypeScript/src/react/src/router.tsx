        ...
        <Switch>
          <Route exact path="/" component={Dashboard} />
					  ...
					  <Route path="/airlines" component={AirlineSearchComponent} />
										  <Route path="/airtransports/create" component={AirTransportCreateComponent} />
					  <Route path="/airtransports/edit/:id" component={AirTransportEditComponent} />
					  <Route path="/airtransports/:id" component={AirTransportDetailComponent} />
					  <Route path="/airtransports" component={AirTransportSearchComponent} />
					  ...
					  <Route path="/breeds" component={BreedSearchComponent} />
										  <Route path="/countries/create" component={CountryCreateComponent} />
					  <Route path="/countries/edit/:id" component={CountryEditComponent} />
					  <Route path="/countries/:id" component={CountryDetailComponent} />
					  <Route path="/countries" component={CountrySearchComponent} />
										  <Route path="/countryrequirements/create" component={CountryRequirementCreateComponent} />
					  <Route path="/countryrequirements/edit/:id" component={CountryRequirementEditComponent} />
					  <Route path="/countryrequirements/:id" component={CountryRequirementDetailComponent} />
					  <Route path="/countryrequirements" component={CountryRequirementSearchComponent} />
					  ...
					  <Route path="/customers" component={CustomerSearchComponent} />
										  <Route path="/customercommunications/create" component={CustomerCommunicationCreateComponent} />
					  <Route path="/customercommunications/edit/:id" component={CustomerCommunicationEditComponent} />
					  <Route path="/customercommunications/:id" component={CustomerCommunicationDetailComponent} />
					  <Route path="/customercommunications" component={CustomerCommunicationSearchComponent} />
										  <Route path="/destinations/create" component={DestinationCreateComponent} />
					  <Route path="/destinations/edit/:id" component={DestinationEditComponent} />
					  <Route path="/destinations/:id" component={DestinationDetailComponent} />
					  <Route path="/destinations" component={DestinationSearchComponent} />
					  ...
					  <Route path="/handlers" component={HandlerSearchComponent} />
										  <Route path="/handlerpipelinesteps/create" component={HandlerPipelineStepCreateComponent} />
					  <Route path="/handlerpipelinesteps/edit/:id" component={HandlerPipelineStepEditComponent} />
					  <Route path="/handlerpipelinesteps/:id" component={HandlerPipelineStepDetailComponent} />
					  <Route path="/handlerpipelinesteps" component={HandlerPipelineStepSearchComponent} />
										  <Route path="/othertransports/create" component={OtherTransportCreateComponent} />
					  <Route path="/othertransports/edit/:id" component={OtherTransportEditComponent} />
					  <Route path="/othertransports/:id" component={OtherTransportDetailComponent} />
					  <Route path="/othertransports" component={OtherTransportSearchComponent} />
					  ...
					  <Route path="/pets" component={PetSearchComponent} />
										  <Route path="/pipelines/create" component={PipelineCreateComponent} />
					  <Route path="/pipelines/edit/:id" component={PipelineEditComponent} />
					  <Route path="/pipelines/:id" component={PipelineDetailComponent} />
					  <Route path="/pipelines" component={PipelineSearchComponent} />
										  <Route path="/pipelinestatus/create" component={PipelineStatuCreateComponent} />
					  <Route path="/pipelinestatus/edit/:id" component={PipelineStatuEditComponent} />
					  <Route path="/pipelinestatus/:id" component={PipelineStatuDetailComponent} />
					  <Route path="/pipelinestatus" component={PipelineStatuSearchComponent} />
										  <Route path="/pipelinesteps/create" component={PipelineStepCreateComponent} />
					  <Route path="/pipelinesteps/edit/:id" component={PipelineStepEditComponent} />
					  <Route path="/pipelinesteps/:id" component={PipelineStepDetailComponent} />
					  <Route path="/pipelinesteps" component={PipelineStepSearchComponent} />
										  <Route path="/pipelinestepdestinations/create" component={PipelineStepDestinationCreateComponent} />
					  <Route path="/pipelinestepdestinations/edit/:id" component={PipelineStepDestinationEditComponent} />
					  <Route path="/pipelinestepdestinations/:id" component={PipelineStepDestinationDetailComponent} />
					  <Route path="/pipelinestepdestinations" component={PipelineStepDestinationSearchComponent} />
										  <Route path="/pipelinestepnotes/create" component={PipelineStepNoteCreateComponent} />
					  <Route path="/pipelinestepnotes/edit/:id" component={PipelineStepNoteEditComponent} />
					  <Route path="/pipelinestepnotes/:id" component={PipelineStepNoteDetailComponent} />
					  <Route path="/pipelinestepnotes" component={PipelineStepNoteSearchComponent} />
										  <Route path="/pipelinestepstatus/create" component={PipelineStepStatuCreateComponent} />
					  <Route path="/pipelinestepstatus/edit/:id" component={PipelineStepStatuEditComponent} />
					  <Route path="/pipelinestepstatus/:id" component={PipelineStepStatuDetailComponent} />
					  <Route path="/pipelinestepstatus" component={PipelineStepStatuSearchComponent} />
										  <Route path="/pipelinestepsteprequirements/create" component={PipelineStepStepRequirementCreateComponent} />
					  <Route path="/pipelinestepsteprequirements/edit/:id" component={PipelineStepStepRequirementEditComponent} />
					  <Route path="/pipelinestepsteprequirements/:id" component={PipelineStepStepRequirementDetailComponent} />
					  <Route path="/pipelinestepsteprequirements" component={PipelineStepStepRequirementSearchComponent} />
...
/*<Codenesium>
    <Hash>79241efee91a00440ab9c378e1029b38</Hash>
</Codenesium>*/