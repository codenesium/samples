 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new AirTransportMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.AirTransports + '/' + this.state.model!.airlineId,
...
export const WrappedAirTransportEditComponent = Form.create({ name: 'AirTransport Edit' })(AirTransportEditComponent);

/*<Codenesium>
    <Hash>ed4480e114dbb2fbd337dbbf418c9c65</Hash>
</Codenesium>*/