...
const SpeciesEdit = withFormik<Props, SpeciesViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Species +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.SpeciesClientRequestModel>;
  ...
  export default class SpeciesEditComponent extends React.Component<SpeciesEditComponentProps, SpeciesEditComponentState> {
...
/*<Codenesium>
    <Hash>4d3d66d92b4fb00fae6fc73ac5409b45</Hash>
</Codenesium>*/