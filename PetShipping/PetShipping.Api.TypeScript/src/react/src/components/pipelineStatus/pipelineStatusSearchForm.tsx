...
export default class PipelineStatusSearchComponent extends React.Component<PipelineStatusSearchComponentProps, PipelineStatusSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<PipelineStatusViewModel>(), filteredRecords:new Array<PipelineStatusViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.PipelineStatusClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.PipelineStatus + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.PipelineStatus + '?limit=100';
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<PipelineStatusViewModel>(), filteredRecords:new Array<PipelineStatusViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedPipelineStatusSearchComponent = Form.create({ name: 'PipelineStatus Search' })(PipelineStatusSearchComponent);

/*<Codenesium>
    <Hash>32e7621dc75f18bcebf7faff8d8505af</Hash>
</Codenesium>*/