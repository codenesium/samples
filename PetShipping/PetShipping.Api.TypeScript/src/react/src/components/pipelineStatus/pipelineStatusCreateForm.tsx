...
export const WrappedPipelineStatusCreateComponent = Form.create({ name: 'PipelineStatus Create' })(PipelineStatusCreateComponent);

/*<Codenesium>
    <Hash>dcd7592ba86d975a74bb641b07cddff7</Hash>
</Codenesium>*/