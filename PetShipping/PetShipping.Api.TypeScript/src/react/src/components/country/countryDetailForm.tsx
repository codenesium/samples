...
const CountryDetailDisplay = (model: Props) => {
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.Countries + '/edit/' + model.model!.id
          );
        }}
      >
...
export default class CountryDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>481df21840abb8031b4dfd30f4c34956</Hash>
</Codenesium>*/