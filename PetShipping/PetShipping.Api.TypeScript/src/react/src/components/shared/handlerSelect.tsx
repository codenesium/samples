...
interface HandlerSelectComponentProps {
...
interface HandlerSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class  HandlerSelectComponent extends React.Component<
HandlerSelectComponentProps,
HandlerSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
    ...
    axios
      ...
      .then(
        resp => {
          ...
          let devices:Array<HandlerViewModel> = [];
...
/*<Codenesium>
    <Hash>ac6c6f0105b41fe254c0f058624be1b5</Hash>
</Codenesium>*/