...
const DestinationDetailDisplay = (model: Props) => {
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.Destinations + '/edit/' + model.model!.id
          );
        }}
      >
      ...
      <div className="form-group row">
        ...
        <div className="col-sm-12">{String(model.model!.order)}</div>
      </div>
    </form>
  );
};
...
export default class DestinationDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>91eecafe2341438aa46b1adae91ca7bc</Hash>
</Codenesium>*/