...
const CountryRequirementDetailDisplay = (model:Props) => {
   ...
   return (
          <form  role="form">
				<button
                  ...
                  onClick={(e) => { model.history.push(ClientRoutes.CountryRequirements + '/edit/' + model.model!.id)}}
                >
                  <i className="fas fa-edit" />
                </button>
			 						 <div className="form-group row">
							<label htmlFor="countryId" className={"col-sm-2 col-form-label"}>CountryId</label>
  ...
  export default class CountryRequirementDetailComponent extends React.Component<CountryRequirementDetailComponentProps, CountryRequirementDetailComponentState> {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<CountryRequirementDetailDisplay history={this.props.history} model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>e6c1ddb7107aca5d8c90abf1ff20efa5</Hash>
</Codenesium>*/