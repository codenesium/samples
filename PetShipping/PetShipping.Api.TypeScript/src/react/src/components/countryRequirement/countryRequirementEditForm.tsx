...
const CountryRequirementEditDisplay = (
...
const CountryRequirementEdit = withFormik<Props, CountryRequirementViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.CountryRequirements + '/' + values.id,
...
export default class CountryRequirementEditComponent extends React.Component<
