 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new CountryRequirementMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.CountryRequirements + '/' + this.state.model!.id,
...
export const WrappedCountryRequirementEditComponent = Form.create({ name: 'CountryRequirement Edit' })(CountryRequirementEditComponent);

/*<Codenesium>
    <Hash>f69bf8874bff5256c73e5a25ae6e8637</Hash>
</Codenesium>*/