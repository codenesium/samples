...
const AirlineCreateDisplay: React.SFC<FormikProps<AirlineViewModel>> = (
  props: FormikProps<AirlineViewModel>
) => {
...
export default class AirlineCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>abbeacde8165d08dda59ec491b12596a</Hash>
</Codenesium>*/