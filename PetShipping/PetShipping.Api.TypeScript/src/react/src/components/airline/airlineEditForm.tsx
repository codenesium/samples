...
const AirlineEdit = withFormik<Props, AirlineViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Airlines +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.AirlineClientRequestModel>;
  ...
  export default class AirlineEditComponent extends React.Component<AirlineEditComponentProps, AirlineEditComponentState> {
...
/*<Codenesium>
    <Hash>101eb4ff77faffa763e7ac58e8e43344</Hash>
</Codenesium>*/