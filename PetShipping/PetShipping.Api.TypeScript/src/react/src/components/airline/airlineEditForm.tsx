...
> {
  ...
  componentDidMount() {
    ...
    axios
      .get<Api.AirlineClientResponseModel>(
  ...
  submit = (model: AirlineViewModel) => {
    let mapper = new AirlineMapper();
    axios
      .put<CreateResponse<Api.AirlineClientRequestModel>>(
...
export const WrappedAirlineEditComponent = Form.create({
  name: 'Airline Edit',
})(AirlineEditComponent);


/*<Codenesium>
    <Hash>fcf10f4c57f4532ee3a58553c7250f51</Hash>
</Codenesium>*/