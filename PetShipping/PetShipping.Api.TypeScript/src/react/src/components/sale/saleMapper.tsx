...
import SaleViewModel from  './saleViewModel';
	...
	mapApiResponseToViewModel(dto: Api.SaleClientResponseModel) : SaleViewModel 
	{
		...
		response.setProperties(dto.amount,dto.cutomerId,dto.id,dto.note,dto.petId,dto.saleDate,dto.salesPersonId);
		
						if(dto.petIdNavigation != null)
				{
				  response.petIdNavigation = new PetViewModel();
				  response.petIdNavigation.setProperties(
				  dto.petIdNavigation.breedId,dto.petIdNavigation.clientId,dto.petIdNavigation.id,dto.petIdNavigation.name,dto.petIdNavigation.weight
				  );
				}
	...
	mapViewModelToApiRequest(model: SaleViewModel) : Api.SaleClientRequestModel
	{
		...
		response.setProperties(model.amount,model.cutomerId,model.id,model.note,model.petId,model.saleDate,model.salesPersonId);
		return response;
	}
};

/*<Codenesium>
    <Hash>bb9607f6af1f2f8c88b183a6b07c66aa</Hash>
</Codenesium>*/