...
> {
  ...
  submit = (model: PipelineStepStatusViewModel) => {
    let mapper = new PipelineStepStatusMapper();
    axios
      .put<CreateResponse<Api.PipelineStepStatusClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.PipelineStepStatus +
          '/' +
          this.state.model!.id,
...
export const WrappedPipelineStepStatusEditComponent = Form.create({
  name: 'PipelineStepStatus Edit',
})(PipelineStepStatusEditComponent);


/*<Codenesium>
    <Hash>bbdf471be77bc1a81f276a506df278f3</Hash>
</Codenesium>*/