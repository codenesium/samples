...
export default class PipelineStepStatusSearchComponent extends React.Component<PipelineStepStatusSearchComponentProps, PipelineStepStatusSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<PipelineStepStatusViewModel>(), filteredRecords:new Array<PipelineStepStatusViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<PipelineStepStatusViewModel>(), filteredRecords:new Array<PipelineStepStatusViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedPipelineStepStatusSearchComponent = Form.create({ name: 'PipelineStepStatus Search' })(PipelineStepStatusSearchComponent);

/*<Codenesium>
    <Hash>c6170470ef331398578c92d29193e6f9</Hash>
</Codenesium>*/