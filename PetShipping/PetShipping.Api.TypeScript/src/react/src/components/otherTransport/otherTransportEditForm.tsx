 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new OtherTransportMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.OtherTransports + '/' + this.state.model!.id,
...
export const WrappedOtherTransportEditComponent = Form.create({ name: 'OtherTransport Edit' })(OtherTransportEditComponent);

/*<Codenesium>
    <Hash>f29085899faf839b853f12e533e70244</Hash>
</Codenesium>*/