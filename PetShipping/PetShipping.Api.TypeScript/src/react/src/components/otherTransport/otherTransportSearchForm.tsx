...
> {
  ...
  handleEditClick(e: any, row: Api.OtherTransportClientResponseModel) {
    this.props.history.push(ClientRoutes.OtherTransports + '/edit/' + row.id);
  }

  handleDetailClick(e: any, row: Api.OtherTransportClientResponseModel) {
                        ...
                        <button
                          ...
                          onClick={e => {
                            this.handleDetailClick(
                              e,
                              row.original as Api.OtherTransportClientResponseModel
                            );
                          }}
                        >
...
/*<Codenesium>
    <Hash>eabc8000b016507b1c3cc3c874a75183</Hash>
</Codenesium>*/