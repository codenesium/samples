...
export default class OtherTransportSearchComponent extends React.Component<OtherTransportSearchComponentProps, OtherTransportSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<OtherTransportViewModel>(), filteredRecords:new Array<OtherTransportViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.OtherTransportClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.OtherTransports + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.OtherTransports + '?limit=100';
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<OtherTransportViewModel>(), filteredRecords:new Array<OtherTransportViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedOtherTransportSearchComponent = Form.create({ name: 'OtherTransport Search' })(OtherTransportSearchComponent);

/*<Codenesium>
    <Hash>7d2b6008ae8e567475bab7609cf927a6</Hash>
</Codenesium>*/