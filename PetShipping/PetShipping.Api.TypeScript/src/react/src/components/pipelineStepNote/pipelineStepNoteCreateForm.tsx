...
export const WrappedPipelineStepNoteCreateComponent = Form.create({ name: 'PipelineStepNote Create' })(PipelineStepNoteCreateComponent);

/*<Codenesium>
    <Hash>9e114b79c5d67331c27bd84c50c2ed9b</Hash>
</Codenesium>*/