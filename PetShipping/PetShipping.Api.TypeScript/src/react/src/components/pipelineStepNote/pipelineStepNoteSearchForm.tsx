...
export default class PipelineStepNoteSearchComponent extends React.Component<PipelineStepNoteSearchComponentProps, PipelineStepNoteSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<PipelineStepNoteViewModel>(), filteredRecords:new Array<PipelineStepNoteViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
    ...
    handleDeleteClick(e:any, row:Api.PipelineStepNoteClientResponseModel) {
        axios.delete(Constants.ApiEndpoint + ApiRoutes.PipelineStepNotes + '/' + row.id,
        {
            headers: {
   ...
   loadRecords(query:string = '') {
	   ...
	   let searchEndpoint = Constants.ApiEndpoint + ApiRoutes.PipelineStepNotes + '?limit=100';
...
/*<Codenesium>
    <Hash>1305d6782ac3437cbf1225caf5ee5959</Hash>
</Codenesium>*/