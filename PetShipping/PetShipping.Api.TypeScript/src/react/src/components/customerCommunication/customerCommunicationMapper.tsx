...
import CustomerCommunicationViewModel from  './customerCommunicationViewModel';
	...
	mapApiResponseToViewModel(dto: Api.CustomerCommunicationClientResponseModel) : CustomerCommunicationViewModel 
	{
		let response = new CustomerCommunicationViewModel();
		response.setProperties(dto.customerId,dto.dateCreated,dto.employeeId,dto.id,dto.note);
						...
						if(dto.customerIdNavigation != null)
				{
				  ...
				  dto.customerIdNavigation.email,dto.customerIdNavigation.firstName,dto.customerIdNavigation.id,dto.customerIdNavigation.lastName,dto.customerIdNavigation.note,dto.customerIdNavigation.phone
				  );
				}
	...
	mapViewModelToApiRequest(model: CustomerCommunicationViewModel) : Api.CustomerCommunicationClientRequestModel
	{
		let response = new Api.CustomerCommunicationClientRequestModel();
		response.setProperties(model.customerId,model.dateCreated,model.employeeId,model.id,model.note);
		return response;
	}
};

/*<Codenesium>
    <Hash>07f657ced28c54bb275039a8920788e9</Hash>
</Codenesium>*/