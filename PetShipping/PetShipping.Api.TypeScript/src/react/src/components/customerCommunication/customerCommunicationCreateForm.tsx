...
const CustomerCommunicationCreateDisplay: React.SFC<
  FormikProps<CustomerCommunicationViewModel>
> = (props: FormikProps<CustomerCommunicationViewModel>) => {
  ...
  let errorsForField = (name: string): string => {
    let response = '';
    if (
      props.touched[name as keyof CustomerCommunicationViewModel] &&
      props.errors[name as keyof CustomerCommunicationViewModel]
    ) {
...
const CustomerCommunicationCreate = withFormik<
  Props,
...
export default class CustomerCommunicationCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>1ecf99e9a99e560e3a28634c7af7c2c0</Hash>
</Codenesium>*/