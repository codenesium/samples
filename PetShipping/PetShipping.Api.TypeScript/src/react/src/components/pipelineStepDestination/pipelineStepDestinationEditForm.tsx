 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new PipelineStepDestinationMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.PipelineStepDestinations + '/' + this.state.model!.id,
...
export const WrappedPipelineStepDestinationEditComponent = Form.create({ name: 'PipelineStepDestination Edit' })(PipelineStepDestinationEditComponent);

/*<Codenesium>
    <Hash>5f0fbb4d7f14a99db8fc84edbaf3a40f</Hash>
</Codenesium>*/