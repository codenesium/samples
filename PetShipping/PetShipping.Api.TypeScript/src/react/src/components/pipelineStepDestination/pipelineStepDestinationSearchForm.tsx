...
export default class PipelineStepDestinationSearchComponent extends React.Component<PipelineStepDestinationSearchComponentProps, PipelineStepDestinationSearchComponentState> {
    ...
    handleDetailClick(e:any, row:Api.PipelineStepDestinationClientResponseModel) {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<PipelineStepDestinationViewModel>(),filteredRecords:new Array<PipelineStepDestinationViewModel>(), loading:false, loaded:false, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
        ...
        if(this.state.loading) {
            ...
            <ReactTable 
                ...
                columns={[{
                    ...
                    {
                        Header: 'Actions',
                        Cell: row => (<div><button className="btn btn-sm" onClick={e => {this.handleDetailClick(e, row.original as Api.PipelineStepDestinationClientResponseModel)}} ><i className="fas fa-search"></i></button>
                        &nbsp;<button className="btn btn-primary btn-sm" onClick={e => {this.handleEditClick(e, row.original as Api.PipelineStepDestinationClientResponseModel)}} ><i className="fas fa-edit"></i></button>
                        &nbsp;<button className="btn btn-danger btn-sm" onClick={e => {this.handleDeleteClick(e, row.original as Api.PipelineStepDestinationClientResponseModel)}} ><i className="far fa-trash-alt"></i></button>
                        </div>)
                    }],
...
/*<Codenesium>
    <Hash>0900e38102b5051d7aeb65f63d470bca</Hash>
</Codenesium>*/