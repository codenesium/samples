...
import PipelineStepDestinationViewModel from  './pipelineStepDestinationViewModel';
	...
	mapApiResponseToViewModel(dto: Api.PipelineStepDestinationClientResponseModel) : PipelineStepDestinationViewModel 
	{
		...
		response.setProperties(dto.destinationId,dto.id,dto.pipelineStepId);
						...
						if(dto.destinationIdNavigation != null)
				{
				  ...
				  dto.destinationIdNavigation.countryId,dto.destinationIdNavigation.id,dto.destinationIdNavigation.name,dto.destinationIdNavigation.order
				  );
				}
	...
	mapViewModelToApiRequest(model: PipelineStepDestinationViewModel) : Api.PipelineStepDestinationClientRequestModel
	{
...
/*<Codenesium>
    <Hash>762d5b0e81a404f73486800c7a5d2570</Hash>
</Codenesium>*/