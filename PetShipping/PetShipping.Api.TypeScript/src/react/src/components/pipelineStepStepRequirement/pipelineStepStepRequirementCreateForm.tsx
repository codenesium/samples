...
const PipelineStepStepRequirementCreateDisplay: React.SFC<
  FormikProps<PipelineStepStepRequirementViewModel>
> = (props: FormikProps<PipelineStepStepRequirementViewModel>) => {
  ...
  let errorsForField = (name: string): string => {
    let response = '';
    if (
      props.touched[name as keyof PipelineStepStepRequirementViewModel] &&
      props.errors[name as keyof PipelineStepStepRequirementViewModel]
    ) {
      response +=
        props.errors[name as keyof PipelineStepStepRequirementViewModel];
    }
    ...
    <form onSubmit={props.handleSubmit} role="form">
      ...
      <div className="form-group row">
        <label
          htmlFor="name"
          className={
            errorExistForField('requirementMet')
              ? 'col-sm-2 col-form-label is-invalid'
              : 'col-sm-2 col-form-label'
          }
        >
...
const PipelineStepStepRequirementCreate = withFormik<
  Props,
...
export default class PipelineStepStepRequirementCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>0dcc26b0d6ce8c07f2394fac2494cc58</Hash>
</Codenesium>*/