...
class PipelineStatuEditComponent extends React.Component<
...
> {
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
     ...
     this.props.form.validateFields((err:any, values:any) => {
      if (!err) {
        let model = values as PipelineStatuViewModel;
  ...
  submit = (model:PipelineStatuViewModel) =>
  {  
    let mapper = new PipelineStatuMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.PipelineStatus + '/' + this.state.model!.id,
...
export const WrappedPipelineStatuEditComponent = Form.create({ name: 'PipelineStatu Edit' })(PipelineStatuEditComponent);

/*<Codenesium>
    <Hash>50eb84cdd3d9e7cd3e9867d2aadd474a</Hash>
</Codenesium>*/