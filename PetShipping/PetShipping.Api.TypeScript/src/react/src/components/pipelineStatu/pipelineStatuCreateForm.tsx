...
interface Props {
   ...
   const PipelineStatuCreateDisplay: React.SFC<FormikProps<PipelineStatuViewModel>> = (props: FormikProps<PipelineStatuViewModel>) => {

   let status = props.status as CreateResponse<Api.PipelineStatuClientRequestModel>;
   
   let errorsForField = (name:string) : string =>
   {
        let response = '';
        if(props.touched[name as keyof PipelineStatuViewModel]  && props.errors[name as keyof PipelineStatuViewModel]) {
...
const PipelineStatuCreate = withFormik<Props, PipelineStatuViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.PipelineStatus,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.PipelineStatuClientRequestModel>;
  ...
  export default class PipelineStatuCreateComponent extends React.Component<PipelineStatuCreateComponentProps, PipelineStatuCreateComponentState> {
...
/*<Codenesium>
    <Hash>72f75897f73ed24c9ed182c02da7edf3</Hash>
</Codenesium>*/