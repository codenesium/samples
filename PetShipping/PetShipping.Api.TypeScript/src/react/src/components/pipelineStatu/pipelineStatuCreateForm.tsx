...
class PipelineStatuCreateComponent extends React.Component<
...
export const WrappedPipelineStatuCreateComponent = Form.create({
  name: 'PipelineStatu Create',
})(PipelineStatuCreateComponent);


/*<Codenesium>
    <Hash>91b10ef0d7be33f98bc6d7b4b318a297</Hash>
</Codenesium>*/