...
export const WrappedPipelineStatuSearchComponent = Form.create({
  name: 'PipelineStatu Search',
})(PipelineStatuSearchComponent);


/*<Codenesium>
    <Hash>f2c61368a4dffd2a414cfdedc27eb249</Hash>
</Codenesium>*/