  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.PipelineStatus + '/edit/' + model.model!.id
          );
        }}
      >
...
export default class PipelineStatuDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>443daf6101a4f44e21efef511ce67dd1</Hash>
</Codenesium>*/