...
const PipelineCreateDisplay: React.SFC<FormikProps<PipelineViewModel>> = (
  props: FormikProps<PipelineViewModel>
) => {
...
export default class PipelineCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>cde26dfef6982214ac324747f077b9eb</Hash>
</Codenesium>*/