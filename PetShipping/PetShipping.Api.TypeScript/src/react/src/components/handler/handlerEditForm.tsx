...
> {
  ...
  submit = (model: HandlerViewModel) => {
    let mapper = new HandlerMapper();
    axios
      .put<CreateResponse<Api.HandlerClientRequestModel>>(
...
export const WrappedHandlerEditComponent = Form.create({
  name: 'Handler Edit',
})(HandlerEditComponent);


/*<Codenesium>
    <Hash>9677ee7daeb870c0a3e78bd19aab8fe6</Hash>
</Codenesium>*/