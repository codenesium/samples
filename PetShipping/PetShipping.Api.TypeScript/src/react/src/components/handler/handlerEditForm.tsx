...
const HandlerEdit = withFormik<Props, HandlerViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Handlers +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.HandlerClientRequestModel>;
  ...
  export default class HandlerEditComponent extends React.Component<HandlerEditComponentProps, HandlerEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Handlers + '/' + this.props.match.params.id, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
...
/*<Codenesium>
    <Hash>37ab4873b76f1f70e807f86cdac28f02</Hash>
</Codenesium>*/