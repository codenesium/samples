...
export default class HandlerSearchComponent extends React.Component<HandlerSearchComponentProps, HandlerSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<HandlerViewModel>(), filteredRecords:new Array<HandlerViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedHandlerSearchComponent = Form.create({ name: 'Handler Search' })(HandlerSearchComponent);

/*<Codenesium>
    <Hash>ba2ee5ceb271f11c177f4c331dce248b</Hash>
</Codenesium>*/