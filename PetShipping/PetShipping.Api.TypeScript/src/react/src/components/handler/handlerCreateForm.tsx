...
const HandlerCreateDisplay: React.SFC<FormikProps<HandlerViewModel>> = (
  props: FormikProps<HandlerViewModel>
) => {
...
export default class HandlerCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>cf9a8a395aae2d8985d12616ee7da5ae</Hash>
</Codenesium>*/