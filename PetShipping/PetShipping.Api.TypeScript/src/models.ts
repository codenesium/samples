...
this.phone = '';
			...
			export class ApiCustomerCommunicationServerRequestModel {
				customerId:number;
...
this.note = '';
			...
			export class ApiCustomerCommunicationServerResponseModel {
				customerId:number;
customerIdEntity:number;
dateCreated:string;
employeeId:number;
...
this.phone = '';
			...
			export class ApiHandlerPipelineStepServerRequestModel {
				handlerId:number;
handlerIdEntity:number;
id:number;
pipelineStepId:number;
...
this.pipelineStepId = 0;
			...
			export class ApiHandlerPipelineStepServerResponseModel {
				handlerId:number;
handlerIdEntity:number;
id:number;
pipelineStepId:number;
...
this.pipelineStepId = 0;
			...
			export class ApiOtherTransportServerRequestModel {
				handlerId:number;
handlerIdEntity:number;
id:number;
pipelineStepId:number;
...
this.pipelineStepId = 0;
			...
			export class ApiOtherTransportServerResponseModel {
				handlerId:number;
handlerIdEntity:number;
id:number;
pipelineStepId:number;
...
this.shipperId = 0;
			...
			export class ApiPipelineStepDestinationServerRequestModel {
...
this.pipelineStepId = 0;
			...
			export class ApiPipelineStepDestinationServerResponseModel {
				destinationId:number;
destinationIdEntity:number;
id:number;
pipelineStepId:number;
