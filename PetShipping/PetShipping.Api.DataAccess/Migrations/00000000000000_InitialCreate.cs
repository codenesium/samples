...
END
GO
IF (OBJECT_ID('FK_Pipeline_pipelineStatusId_PipelineStatus_id', 'F') IS NOT NULL)
BEGIN
ALTER TABLE [dbo].[Pipeline] DROP CONSTRAINT [FK_Pipeline_pipelineStatusId_PipelineStatus_id]
END
GO
IF (OBJECT_ID('FK_PipelineStepNote_pipelineStepId_PipelineStep_id', 'F') IS NOT NULL)
BEGIN
ALTER TABLE [dbo].[PipelineStepNote] DROP CONSTRAINT [FK_PipelineStepNote_pipelineStepId_PipelineStep_id]
END
GO
IF (OBJECT_ID('FK_PipelineStepStepRequirement_pipelineStepId_PipelineStep_id', 'F') IS NOT NULL)
BEGIN
