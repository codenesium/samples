...
namespace PetShippingNS.Api.Web
{
	...
	public class CustomerController : AbstractApiController
	{
		...
		[HttpGet]
		[Route("{customerId}/CustomerCommunications")]
		[ReadOnly]
		[ProducesResponseType(typeof(List<ApiCustomerCommunicationServerResponseModel>), 200)]
		public async virtual Task<IActionResult> CustomerCommunicationsByCustomerId(int customerId, int? limit, int? offset)
		{
			...
			List<ApiCustomerCommunicationServerResponseModel> response = await this.CustomerService.CustomerCommunicationsByCustomerId(customerId, query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>906e80420c2bcb797f150a8cd15ea3c7</Hash>
    <Hello>
