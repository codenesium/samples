...
namespace PetShippingNS.Api.Web
{
	public abstract class AbstractHandlerPipelineStepController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset)
		{
			...
			List<ApiHandlerPipelineStepServerResponseModel> response = await this.HandlerPipelineStepService.All(query.Limit, query.Offset);
...
/*<Codenesium>
    <Hash>4582a9e884f133a40d3e29b260b9072d</Hash>
</Codenesium>*/