...
namespace PetShippingNS.Api.Web
{
	public abstract class AbstractPipelineStatuController : AbstractApiController
	{
		...
		public async virtual Task<IActionResult> All(int? limit, int? offset, string query)
		{
			...
			List<ApiPipelineStatuServerResponseModel> response = await this.PipelineStatuService.All(searchQuery.Limit, searchQuery.Offset, searchQuery.Query);
...
/*<Codenesium>
    <Hash>197d94dd43bb979c7f729a73e64faca6</Hash>
</Codenesium>*/