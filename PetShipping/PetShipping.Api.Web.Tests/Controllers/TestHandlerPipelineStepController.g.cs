...
namespace PetShippingNS.Api.Web.Tests
{
        ...
        public partial class HandlerPipelineStepControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        HandlerPipelineStepController controller = new HandlerPipelineStepController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiHandlerPipelineStepResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiHandlerPipelineStepRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiHandlerPipelineStepRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        HandlerPipelineStepController controller = new HandlerPipelineStepController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>3ddc365be50375af224ef111cf53a8c9</Hash>
</Codenesium>*/