...
namespace PetShippingNS.Api.Web.Tests
{
	...
	public partial class OtherTransportControllerTests
	{
		...
		public async void Create_No_Errors()
		{
			...
			var createResponse = (response as CreatedResult).Value as CreateResponse<ApiOtherTransportResponseModel>;
		...
		{
			OtherTransportControllerMockFacade mock = new OtherTransportControllerMockFacade();
			var mockResult = new Mock<UpdateResponse<ApiOtherTransportResponseModel>>();
			mockResult.SetupGet(x => x.Success).Returns(true);
			mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiOtherTransportRequestModel>()))
			.Callback<int, ApiOtherTransportRequestModel>(
				(id, model) => model.HandlerId.Should().Be(1)
				)
			.Returns(Task.FromResult<UpdateResponse<ApiOtherTransportResponseModel>>(mockResult.Object));
			mock.ServiceMock.Setup(x => x.Get(It.IsAny<int>())).Returns(Task.FromResult<ApiOtherTransportResponseModel>(new ApiOtherTransportResponseModel()));
			OtherTransportController controller = new OtherTransportController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiOtherTransportModelMapper());
			controller.ControllerContext = new ControllerContext();
			controller.ControllerContext.HttpContext = new DefaultHttpContext();
		...
		public async void Update_No_Errors()
		{
			...
			var mockResult = new Mock<UpdateResponse<ApiOtherTransportResponseModel>>();
			mockResult.SetupGet(x => x.Success).Returns(true);
			mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiOtherTransportRequestModel>())).Returns(Task.FromResult<UpdateResponse<ApiOtherTransportResponseModel>>(mockResult.Object));
			mock.ServiceMock.Setup(x => x.Get(It.IsAny<int>())).Returns(Task.FromResult(new ApiOtherTransportResponseModel()));
			OtherTransportController controller = new OtherTransportController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiOtherTransportModelMapper());
			controller.ControllerContext = new ControllerContext();
			controller.ControllerContext.HttpContext = new DefaultHttpContext();
	...
	public class OtherTransportControllerMockFacade
	{
		...
		public Mock<IApiOtherTransportModelMapper> ModelMapperMock { get; set; } = new Mock<IApiOtherTransportModelMapper>();
	}
}

/*<Codenesium>
    <Hash>7ff0d6c1c1cb1302c392e8a0388c6ba8</Hash>
</Codenesium>*/