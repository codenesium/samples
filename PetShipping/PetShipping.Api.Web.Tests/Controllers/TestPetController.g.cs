...
namespace PetShippingNS.Api.Web.Tests
{
        ...
        public partial class PetControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        PetController controller = new PetController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiPetResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiPetRequestModel>()));
                }
                ...
                public async void Patch_No_Errors()
                {
                        ...
                        .Callback<int, ApiPetRequestModel>(
                                (id, model) => model.BreedId.Should().Be(1)
                                )
                ...
                public async void Update_No_Errors()
                {
                        ...
                        var mockResult = new Mock<ActionResponse>();
                        mockResult.SetupGet(x => x.Success).Returns(true);
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiPetRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        PetController controller = new PetController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>0232504e399dc14a5262dc022b11dd9f</Hash>
</Codenesium>*/