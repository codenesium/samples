...
namespace PetShippingNS.Api.Web.Tests
{
        ...
        public partial class PipelineStepStatusControllerTests
        {
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var createResponse = (response as CreatedResult).Value as CreateResponse<ApiPipelineStepStatusResponseModel>;
                ...
                {
                        PipelineStepStatusControllerMockFacade mock = new PipelineStepStatusControllerMockFacade();
                        var mockResult = new Mock<UpdateResponse<ApiPipelineStepStatusResponseModel>>();
                        ...
                        .Returns(Task.FromResult<UpdateResponse<ApiPipelineStepStatusResponseModel>>(mockResult.Object));
                        ...
                        PipelineStepStatusController controller = new PipelineStepStatusController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiPipelineStepStatusModelMapper());
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
                ...
                public async void Update_No_Errors()
                {
                        ...
                        var mockResult = new Mock<UpdateResponse<ApiPipelineStepStatusResponseModel>>();
                        mockResult.SetupGet(x => x.Success).Returns(true);
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiPipelineStepStatusRequestModel>())).Returns(Task.FromResult<UpdateResponse<ApiPipelineStepStatusResponseModel>>(mockResult.Object));
                        mock.ServiceMock.Setup(x => x.Get(It.IsAny<int>())).Returns(Task.FromResult(new ApiPipelineStepStatusResponseModel()));
                        PipelineStepStatusController controller = new PipelineStepStatusController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiPipelineStepStatusModelMapper());
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
        ...
        public class PipelineStepStatusControllerMockFacade
        {
                ...
                public Mock<IApiPipelineStepStatusModelMapper> ModelMapperMock { get; set; } = new Mock<IApiPipelineStepStatusModelMapper>();
        }
}

/*<Codenesium>
    <Hash>7853004ab8a4a49b9b7070de6c13a0d8</Hash>
</Codenesium>*/