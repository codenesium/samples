...
namespace PetShippingNS.Api.Web.Tests
{
        ...
        public partial class PipelineStepControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        PipelineStepController controller = new PipelineStepController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiPipelineStepResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiPipelineStepRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiPipelineStepRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        PipelineStepController controller = new PipelineStepController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>0d6c8ed5fd0f14e19ab60c82ea37b72f</Hash>
</Codenesium>*/