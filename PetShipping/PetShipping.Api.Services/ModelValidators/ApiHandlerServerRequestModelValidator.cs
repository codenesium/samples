...
{
	public class ApiHandlerServerRequestModelValidator : AbstractValidator<ApiHandlerServerRequestModel>, IApiHandlerServerRequestModelValidator
	{
		...
		public async Task<ValidationResult> ValidateCreateAsync(ApiHandlerServerRequestModel model)
		{
			this.CountryIdRules();
			this.EmailRules();
			this.FirstNameRules();
		...
		public async Task<ValidationResult> ValidateUpdateAsync(int id, ApiHandlerServerRequestModel model)
		{
			this.CountryIdRules();
			this.EmailRules();
			this.FirstNameRules();
...
/*<Codenesium>
    <Hash>1eb8158028e6405657783de185b4883c</Hash>
    <Hello>
