...
namespace FermataFishNS.Api.Service
{
	...
	{
		IStudioModelValidator validator { get; set; }

		public StudioFilter(IStudioModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<StudioModel>().ToList();
...
/*<Codenesium>
    <Hash>ddfd5fb9dd09fc942a525ef4e96e59ad</Hash>
</Codenesium>*/