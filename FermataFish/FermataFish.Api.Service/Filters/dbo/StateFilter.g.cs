...
namespace FermataFishNS.Api.Service
{
	...
	{
		IStateModelValidator validator { get; set; }

		public StateFilter(IStateModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<StateModel>().ToList();
...
/*<Codenesium>
    <Hash>ac9ad4c55e9d28e45b4f8726da680aae</Hash>
</Codenesium>*/