...
namespace FermataFishNS.Api.Service
{
	...
	{
		ISpaceXSpaceFeatureModelValidator validator { get; set; }

		public SpaceXSpaceFeatureFilter(ISpaceXSpaceFeatureModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SpaceXSpaceFeatureModel>().ToList();
...
/*<Codenesium>
    <Hash>1a0bd3ee6039f6943ec9cd3575c6c6f9</Hash>
</Codenesium>*/