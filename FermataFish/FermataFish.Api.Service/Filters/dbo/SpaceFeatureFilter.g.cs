...
namespace FermataFishNS.Api.Service
{
	...
	{
		ISpaceFeatureModelValidator validator { get; set; }

		public SpaceFeatureFilter(ISpaceFeatureModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SpaceFeatureModel>().ToList();
...
/*<Codenesium>
    <Hash>f3791e0f7327b85a7cc0d2978bca2ca3</Hash>
</Codenesium>*/