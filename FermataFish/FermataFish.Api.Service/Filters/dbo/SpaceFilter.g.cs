...
namespace FermataFishNS.Api.Service
{
	...
	{
		ISpaceModelValidator validator { get; set; }

		public SpaceFilter(ISpaceModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<SpaceModel>().ToList();
...
/*<Codenesium>
    <Hash>97f7305dd457d5451c90c76d2e0ace5e</Hash>
</Codenesium>*/