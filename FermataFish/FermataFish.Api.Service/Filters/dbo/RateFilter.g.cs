...
namespace FermataFishNS.Api.Service
{
	...
	{
		IRateModelValidator validator { get; set; }

		public RateFilter(IRateModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<RateModel>().ToList();
...
/*<Codenesium>
    <Hash>7860f9a160b2fbd43d30ad776853c97c</Hash>
</Codenesium>*/