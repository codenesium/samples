...
namespace FermataFishNS.Api.Service
{
	...
	{
		IAdminModelValidator validator { get; set; }

		public AdminFilter(IAdminModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<AdminModel>().ToList();
...
/*<Codenesium>
    <Hash>261b9d4cd17394b93078893cf6fb9ed7</Hash>
</Codenesium>*/