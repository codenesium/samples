...
namespace FermataFishNS.Api.Service
{
	...
	{
		IStudentXFamilyModelValidator validator { get; set; }

		public StudentXFamilyFilter(IStudentXFamilyModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<StudentXFamilyModel>().ToList();
...
/*<Codenesium>
    <Hash>d97d8fe64368a1d77f6294f93f8d7293</Hash>
</Codenesium>*/