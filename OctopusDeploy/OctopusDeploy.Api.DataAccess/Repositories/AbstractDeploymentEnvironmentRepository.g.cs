...
namespace OctopusDeployNS.Api.DataAccess
{
	public abstract class AbstractDeploymentEnvironmentRepository : AbstractRepository
	{
		...
		public async Task<DeploymentEnvironment> ByName(string name)
		{
		...
		public async Task<List<DeploymentEnvironment>> ByDataVersion(byte[] dataVersion, int limit = int.MaxValue, int offset = 0)
		{
...
/*<Codenesium>
    <Hash>9801a667255bd749af942857765d5679</Hash>
</Codenesium>*/