...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class MachineControllerTests
        {
                ...
                public async void Update_No_Errors()
                {
                        ...
                        var mockResult = new Mock<ActionResponse>();
                        mockResult.SetupGet(x => x.Success).Returns(true);
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiMachineRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        MachineController controller = new MachineController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>5dfbf95a838d53d6a0392ead252852a5</Hash>
</Codenesium>*/