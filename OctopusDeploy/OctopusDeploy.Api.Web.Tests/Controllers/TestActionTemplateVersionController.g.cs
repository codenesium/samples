...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class ActionTemplateVersionControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        ActionTemplateVersionController controller = new ActionTemplateVersionController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiActionTemplateVersionResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiActionTemplateVersionRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        var mockResult = new Mock<ActionResponse>();
                        mockResult.SetupGet(x => x.Success).Returns(true);
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiActionTemplateVersionRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        ActionTemplateVersionController controller = new ActionTemplateVersionController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>4a5d6450d5d469e222de408cb037da64</Hash>
</Codenesium>*/