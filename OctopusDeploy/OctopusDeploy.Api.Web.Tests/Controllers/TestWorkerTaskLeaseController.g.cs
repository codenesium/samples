...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class WorkerTaskLeaseControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        WorkerTaskLeaseController controller = new WorkerTaskLeaseController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiWorkerTaskLeaseResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiWorkerTaskLeaseRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        var mockResult = new Mock<ActionResponse>();
                        mockResult.SetupGet(x => x.Success).Returns(true);
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiWorkerTaskLeaseRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        WorkerTaskLeaseController controller = new WorkerTaskLeaseController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>9fc5326b02ecf12e90e9f189360ad780</Hash>
</Codenesium>*/