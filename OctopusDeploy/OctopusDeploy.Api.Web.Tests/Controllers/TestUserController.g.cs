...
namespace OctopusDeployNS.Api.Web.Tests
{
	...
	public partial class UserControllerTests
	{
		...
		public async void Patch_No_Errors()
		{
			...
			mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiUserRequestModel>()))
			.Callback<string, ApiUserRequestModel>(
				(id, model) => model.DisplayName.Should().Be("A")
				)
			.Returns(Task.FromResult<UpdateResponse<ApiUserResponseModel>>(mockResult.Object));
			mock.ServiceMock.Setup(x => x.Get(It.IsAny<string>())).Returns(Task.FromResult<ApiUserResponseModel>(new ApiUserResponseModel()));
			...
			patch.Replace(x => x.DisplayName, "A");
		...
		public async void Update_No_Errors()
		{
			...
			var mockResult = new Mock<UpdateResponse<ApiUserResponseModel>>();
			mockResult.SetupGet(x => x.Success).Returns(true);
			mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiUserRequestModel>())).Returns(Task.FromResult<UpdateResponse<ApiUserResponseModel>>(mockResult.Object));
			mock.ServiceMock.Setup(x => x.Get(It.IsAny<string>())).Returns(Task.FromResult(new ApiUserResponseModel()));
			UserController controller = new UserController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiUserModelMapper());
			controller.ControllerContext = new ControllerContext();
			controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>6dd3c489e6dff34bf7c8746fb5726d1f</Hash>
</Codenesium>*/