...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class EventRelatedDocumentControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        EventRelatedDocumentController controller = new EventRelatedDocumentController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiEventRelatedDocumentResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiEventRelatedDocumentRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<int>(), It.IsAny<ApiEventRelatedDocumentRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        EventRelatedDocumentController controller = new EventRelatedDocumentController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>b326b054d0fd2374d5073c79ae60ea83</Hash>
</Codenesium>*/