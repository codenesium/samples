...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class InterruptionControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        InterruptionController controller = new InterruptionController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiInterruptionResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiInterruptionRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiInterruptionRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        InterruptionController controller = new InterruptionController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>468622745f693dd784d793fd103d97ad</Hash>
</Codenesium>*/