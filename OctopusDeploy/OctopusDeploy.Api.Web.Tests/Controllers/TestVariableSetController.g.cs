...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class VariableSetControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        VariableSetController controller = new VariableSetController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiVariableSetResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiVariableSetRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        var mockResult = new Mock<ActionResponse>();
                        mockResult.SetupGet(x => x.Success).Returns(true);
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiVariableSetRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        VariableSetController controller = new VariableSetController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>7577610b080e5006a775323ee66f8491</Hash>
</Codenesium>*/