...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class ServerTaskControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        ServerTaskController controller = new ServerTaskController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiServerTaskResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiServerTaskRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        var mockResult = new Mock<ActionResponse>();
                        mockResult.SetupGet(x => x.Success).Returns(true);
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiServerTaskRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        ServerTaskController controller = new ServerTaskController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>c6297bee839f74bfa3464422ee96c064</Hash>
</Codenesium>*/