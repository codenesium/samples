...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class MachinePolicyControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        MachinePolicyController controller = new MachinePolicyController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiMachinePolicyResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiMachinePolicyRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiMachinePolicyRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        MachinePolicyController controller = new MachinePolicyController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>5544aa32fe55e9f8b9b0b092b6fb8f86</Hash>
</Codenesium>*/