...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class ProjectGroupControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        ProjectGroupController controller = new ProjectGroupController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, mock.ModelMapperMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var createResponse = (response as CreatedResult).Value as CreateResponse<ApiProjectGroupResponseModel>;
                ...
                {
                        ProjectGroupControllerMockFacade mock = new ProjectGroupControllerMockFacade();
                        var mockResult = new Mock<UpdateResponse<ApiProjectGroupResponseModel>>();
                        mockResult.SetupGet(x => x.Success).Returns(true);
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiProjectGroupRequestModel>()))
                        .Callback<string, ApiProjectGroupRequestModel>(
                                (id, model) => model.JSON.Should().Be("A")
                                )
                        .Returns(Task.FromResult<UpdateResponse<ApiProjectGroupResponseModel>>(mockResult.Object));
                        mock.ServiceMock.Setup(x => x.Get(It.IsAny<string>())).Returns(Task.FromResult<ApiProjectGroupResponseModel>(new ApiProjectGroupResponseModel()));
                        ProjectGroupController controller = new ProjectGroupController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiProjectGroupModelMapper());
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
                ...
                public async void Update_No_Errors()
                {
                        ...
                        var mockResult = new Mock<UpdateResponse<ApiProjectGroupResponseModel>>();
                        mockResult.SetupGet(x => x.Success).Returns(true);
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiProjectGroupRequestModel>())).Returns(Task.FromResult<UpdateResponse<ApiProjectGroupResponseModel>>(mockResult.Object));
                        mock.ServiceMock.Setup(x => x.Get(It.IsAny<string>())).Returns(Task.FromResult(new ApiProjectGroupResponseModel()));
                        ProjectGroupController controller = new ProjectGroupController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiProjectGroupModelMapper());
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
        ...
        public class ProjectGroupControllerMockFacade
        {
                ...
                public Mock<IApiProjectGroupModelMapper> ModelMapperMock { get; set; } = new Mock<IApiProjectGroupModelMapper>();
        }
}

/*<Codenesium>
    <Hash>08dc626294cdb8517285a77e0b6a58af</Hash>
</Codenesium>*/