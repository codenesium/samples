...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class ProxyControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        ProxyController controller = new ProxyController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiProxyResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiProxyRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        var mockResult = new Mock<ActionResponse>();
                        mockResult.SetupGet(x => x.Success).Returns(true);
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiProxyRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        ProxyController controller = new ProxyController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>34f461086bd997dd67955f41071ded46</Hash>
</Codenesium>*/