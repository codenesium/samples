...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class LifecycleControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        LifecycleController controller = new LifecycleController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiLifecycleResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiLifecycleRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiLifecycleRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        LifecycleController controller = new LifecycleController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>72b852eac44104a2757b00b55dc4593d</Hash>
</Codenesium>*/