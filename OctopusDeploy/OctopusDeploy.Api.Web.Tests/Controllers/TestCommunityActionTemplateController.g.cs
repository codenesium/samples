...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class CommunityActionTemplateControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        CommunityActionTemplateController controller = new CommunityActionTemplateController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiCommunityActionTemplateResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiCommunityActionTemplateRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiCommunityActionTemplateRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        CommunityActionTemplateController controller = new CommunityActionTemplateController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>4b024d48c9ad0841612fc49ef07fbcc7</Hash>
</Codenesium>*/