...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class InvitationControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        InvitationController controller = new InvitationController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiInvitationResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiInvitationRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiInvitationRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        InvitationController controller = new InvitationController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>a1dffdfc38745006dfc246270c6154dc</Hash>
</Codenesium>*/