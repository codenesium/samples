...
namespace OctopusDeployNS.Api.Web.Tests
{
        ...
        public partial class DeploymentEnvironmentControllerTests
        {
                ...
                public async void All_Exists()
                {
                        ...
                        DeploymentEnvironmentController controller = new DeploymentEnvironmentController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                ...
                public async void Create_No_Errors()
                {
                        ...
                        var record = (response as CreatedResult).Value as ApiDeploymentEnvironmentResponseModel;
                        record.Should().NotBeNull();
                        mock.ServiceMock.Verify(x => x.Create(It.IsAny<ApiDeploymentEnvironmentRequestModel>()));
                }
                ...
                public async void Update_No_Errors()
                {
                        ...
                        mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiDeploymentEnvironmentRequestModel>())).Returns(Task.FromResult<ActionResponse>(mockResult.Object));
                        DeploymentEnvironmentController controller = new DeploymentEnvironmentController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object);
                        controller.ControllerContext = new ControllerContext();
                        controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>c9df7fd7f0dd9c9bc0b1b3db88c3580d</Hash>
</Codenesium>*/