...
namespace OctopusDeployNS.Api.Web.Tests
{
	...
	public partial class TenantControllerTests
	{
		...
		public async void Update_No_Errors()
		{
			...
			var mockResult = new Mock<UpdateResponse<ApiTenantResponseModel>>();
			mockResult.SetupGet(x => x.Success).Returns(true);
			mock.ServiceMock.Setup(x => x.Update(It.IsAny<string>(), It.IsAny<ApiTenantRequestModel>())).Returns(Task.FromResult<UpdateResponse<ApiTenantResponseModel>>(mockResult.Object));
			mock.ServiceMock.Setup(x => x.Get(It.IsAny<string>())).Returns(Task.FromResult(new ApiTenantResponseModel()));
			TenantController controller = new TenantController(mock.ApiSettingsMoc.Object, mock.LoggerMock.Object, mock.TransactionCoordinatorMock.Object, mock.ServiceMock.Object, new ApiTenantModelMapper());
			controller.ControllerContext = new ControllerContext();
			controller.ControllerContext.HttpContext = new DefaultHttpContext();
...
/*<Codenesium>
    <Hash>8584e27c8bf1fa9d85ed73dc4c9c2032</Hash>
</Codenesium>*/