...
export default class DeviceActionSearchComponent extends React.Component<DeviceActionSearchComponentProps, DeviceActionSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<DeviceActionViewModel>(), filteredRecords:new Array<DeviceActionViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
/*<Codenesium>
    <Hash>45e6298a32e6a9778143dc4db965044f</Hash>
</Codenesium>*/