...
const DeviceEdit = withFormik<Props, DeviceViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Devices +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.DeviceClientRequestModel>;
  ...
  export default class DeviceEditComponent extends React.Component<DeviceEditComponentProps, DeviceEditComponentState> {
