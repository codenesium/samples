        ...
        <Switch>
          <Route exact path="/" component={Dashboard} />
					  ...
					  <Route path="/devices" component={DeviceSearchComponent} />
										  <Route path="/deviceactions/create" component={DeviceActionCreateComponent} />
					  <Route path="/deviceactions/edit/:id" component={DeviceActionEditComponent} />
					  <Route path="/deviceactions/:id" component={DeviceActionDetailComponent} />
					  <Route path="/deviceactions" component={DeviceActionSearchComponent} />
					        </Switch>
      </div>
	  </Security>
    </BrowserRouter>
...
/*<Codenesium>
    <Hash>24712a5f3fb4d082deafa3032cff295c</Hash>
</Codenesium>*/