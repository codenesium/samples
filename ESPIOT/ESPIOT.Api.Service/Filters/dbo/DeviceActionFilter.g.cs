...
namespace ESPIOTNS.Api.Service
{
	...
	{
		IDeviceActionModelValidator validator { get; set; }

		public DeviceActionFilter(IDeviceActionModelValidator validator)
		{
		...
		public override void OnActionExecuting(ActionExecutingContext actionContext)
		{
			...
			var items = actionContext.ActionArguments.Values.OfType<DeviceActionModel>().ToList();
...
/*<Codenesium>
    <Hash>6083939e0518595b59a8fb366302aa79</Hash>
</Codenesium>*/