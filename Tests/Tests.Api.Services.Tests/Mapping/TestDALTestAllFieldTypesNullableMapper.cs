...
namespace TestsNS.Api.Services
{
	...
	public class TestDALTestAllFieldTypesNullableMapper
	{
		...
		public void MapModelToEntity()
		{
			...
			ApiTestAllFieldTypesNullableServerRequestModel model = new ApiTestAllFieldTypesNullableServerRequestModel();
			...
			TestAllFieldTypesNullable response = mapper.MapModelToEntity(1, model);
		...
		public void MapEntityToModel()
		{
			...
			ApiTestAllFieldTypesNullableServerResponseModel response = mapper.MapEntityToModel(item);
		...
		public void MapEntityToModelList()
		{
			...
			TestAllFieldTypesNullable item = new TestAllFieldTypesNullable();
			item.SetProperties(1, 1, BitConverter.GetBytes(1), true, "A", DateTime.Parse("1/1/1987 12:00:00 AM"), DateTime.Parse("1/1/1987 12:00:00 AM"), DateTime.Parse("1/1/1987 12:00:00 AM"), DateTimeOffset.Parse("1/1/1987 12:00:00 AM"), 1m, 1, BitConverter.GetBytes(1), 1m, "A", "A", 1m, "A", 1m, DateTime.Parse("1/1/1987 12:00:00 AM"), 1, 1m, "A", TimeSpan.Parse("01:00:00"), BitConverter.GetBytes(1), 1, Guid.Parse("8420cdcf-d595-ef65-66e7-dff9f98764da"), BitConverter.GetBytes(1), "A", "A");
			List<ApiTestAllFieldTypesNullableServerResponseModel> response = mapper.MapEntityToModel(new List<TestAllFieldTypesNullable>() { { item} });
...
/*<Codenesium>
    <Hash>dcd2f3f2faa53dcd4289297d26de86c3</Hash>
    <Hello>
