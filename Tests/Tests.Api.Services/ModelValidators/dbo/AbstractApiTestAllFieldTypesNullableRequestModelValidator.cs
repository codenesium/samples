...
{
	public abstract class AbstractApiTestAllFieldTypesNullableRequestModelValidator : AbstractValidator<ApiTestAllFieldTypesNullableRequestModel>
	{
		private int existingRecordId;

		private ITestAllFieldTypesNullableRepository testAllFieldTypesNullableRepository;

		public AbstractApiTestAllFieldTypesNullableRequestModelValidator(ITestAllFieldTypesNullableRepository testAllFieldTypesNullableRepository)
		{
			this.testAllFieldTypesNullableRepository = testAllFieldTypesNullableRepository;
		}

		public async Task<ValidationResult> ValidateAsync(ApiTestAllFieldTypesNullableRequestModel model, int id)
		{
...
/*<Codenesium>
    <Hash>b80100fbe73a812663772f98b2153032</Hash>
</Codenesium>*/