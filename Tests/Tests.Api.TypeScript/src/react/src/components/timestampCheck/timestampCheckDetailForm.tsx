  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.TimestampChecks + '/edit/' + model.model!.id
          );
        }}
      >
      ...
      <div className="form-group row">
        ...
        <div className="col-sm-12">{String(model.model!.timestamp)}</div>
      </div>
    </form>
  );
};
...
export default class TimestampCheckDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>41edd837142b0aa22115ed56ff2dcceb</Hash>
</Codenesium>*/