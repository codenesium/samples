...
export default class TimestampCheckSearchComponent extends React.Component<
  TimestampCheckSearchComponentProps,
  TimestampCheckSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<TimestampCheckViewModel>(),
    filteredRecords: new Array<TimestampCheckViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  handleDeleteClick(e: any, row: Api.TimestampCheckClientResponseModel) {
    axios
      .delete(
        Constants.ApiEndpoint + ApiRoutes.TimestampChecks + '/' + row.id,
        {
          headers: {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.TimestampChecks + '?limit=100';
                        ...
                        <Button
                          ...
                          onClick={(e: any) => {
                            this.handleDetailClick(
                              e,
                              row.original as Api.TimestampCheckClientResponseModel
                            );
                          }}
                        >
...
export const WrappedTimestampCheckSearchComponent = Form.create({
  name: 'TimestampCheck Search',
})(TimestampCheckSearchComponent);


/*<Codenesium>
    <Hash>67553689e47a1c6e8ea06700047f67bd</Hash>
</Codenesium>*/