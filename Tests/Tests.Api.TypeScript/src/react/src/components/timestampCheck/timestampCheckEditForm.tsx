...
> {
  ...
  componentDidMount() {
    ...
    axios
      .get<Api.TimestampCheckClientResponseModel>(
  ...
  submit = (model: TimestampCheckViewModel) => {
    let mapper = new TimestampCheckMapper();
    axios
      .put<CreateResponse<Api.TimestampCheckClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.TimestampChecks +
          '/' +
          this.state.model!.id,
...
export const WrappedTimestampCheckEditComponent = Form.create({
  name: 'TimestampCheck Edit',
})(TimestampCheckEditComponent);
