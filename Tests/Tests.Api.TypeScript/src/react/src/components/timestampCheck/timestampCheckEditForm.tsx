...
class TimestampCheckEditComponent extends React.Component<
 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new TimestampCheckMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.TimestampChecks + '/' + this.state.model!.id,
...
export const WrappedTimestampCheckEditComponent = Form.create({ name: 'TimestampCheck Edit' })(TimestampCheckEditComponent);

/*<Codenesium>
    <Hash>c81f237b82c2a72cd6cad45ae14ab7d6</Hash>
</Codenesium>*/