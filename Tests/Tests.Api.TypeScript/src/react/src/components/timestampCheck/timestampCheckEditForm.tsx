...
const TimestampCheckEditDisplay = (
...
const TimestampCheckEdit = withFormik<Props, TimestampCheckViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.TimestampChecks + '/' + values.id,
...
export default class TimestampCheckEditComponent extends React.Component<
  TimestampCheckEditComponentProps,
  TimestampCheckEditComponentState
> {
  state = {
    model: undefined,
    loading: false,
...
/*<Codenesium>
    <Hash>03bd56a8072403cb5f26f0ec5a25ad09</Hash>
</Codenesium>*/