...
interface Props {
  ...
  const ColumnSameAsFKTableEditDisplay = (props: FormikProps<ColumnSameAsFKTableViewModel>) => {

   let status = props.status as UpdateResponse<Api.ColumnSameAsFKTableClientRequestModel>;
...
const ColumnSameAsFKTableEdit = withFormik<Props, ColumnSameAsFKTableViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.ColumnSameAsFKTables +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.ColumnSameAsFKTableClientRequestModel>;
  ...
  export default class ColumnSameAsFKTableEditComponent extends React.Component<ColumnSameAsFKTableEditComponentProps, ColumnSameAsFKTableEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.ColumnSameAsFKTables + '/' + this.props.match.params.id, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
...
/*<Codenesium>
    <Hash>98ff1c9194a18c781d06bcfa9d1d0497</Hash>
</Codenesium>*/