...
export default class ColumnSameAsFKTableSearchComponent extends React.Component<ColumnSameAsFKTableSearchComponentProps, ColumnSameAsFKTableSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<ColumnSameAsFKTableViewModel>(), filteredRecords:new Array<ColumnSameAsFKTableViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedColumnSameAsFKTableSearchComponent = Form.create({ name: 'ColumnSameAsFKTable Search' })(ColumnSameAsFKTableSearchComponent);

/*<Codenesium>
    <Hash>8e6b3fa826d409b589b7721b776487f6</Hash>
</Codenesium>*/