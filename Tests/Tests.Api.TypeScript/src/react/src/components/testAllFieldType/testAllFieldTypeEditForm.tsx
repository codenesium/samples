...
interface Props {
  ...
  const TestAllFieldTypeEditDisplay = (props: FormikProps<TestAllFieldTypeViewModel>) => {

   let status = props.status as UpdateResponse<Api.TestAllFieldTypeClientRequestModel>;
...
const TestAllFieldTypeEdit = withFormik<Props, TestAllFieldTypeViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.TestAllFieldTypes +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.TestAllFieldTypeClientRequestModel>;
  ...
  export default class TestAllFieldTypeEditComponent extends React.Component<TestAllFieldTypeEditComponentProps, TestAllFieldTypeEditComponentState> {
...
/*<Codenesium>
    <Hash>ae579666bd7df2451b4eed43e3b23280</Hash>
</Codenesium>*/