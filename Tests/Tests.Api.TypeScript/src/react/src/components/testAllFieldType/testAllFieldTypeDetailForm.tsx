...
> {
  ...
  handleEditClick(e:any) {
    this.props.history.push(ClientRoutes.TestAllFieldTypes + '/edit/' + this.state.model!.id);
  }
...
export const WrappedTestAllFieldTypeDetailComponent = Form.create({ name: 'TestAllFieldType Detail' })(
  TestAllFieldTypeDetailComponent
);

/*<Codenesium>
    <Hash>c31f3374db4a654d66eaa24fc47c3f85</Hash>
</Codenesium>*/