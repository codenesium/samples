  ...
  return (
    <form role="form">
      <button
        ...
        onClick={e => {
          model.history.push(
            ClientRoutes.TestAllFieldTypes + '/edit/' + model.model!.id
          );
        }}
      >
...
export default class TestAllFieldTypeDetailComponent extends React.Component<
...
/*<Codenesium>
    <Hash>5bdf540e0ca0a6ac4e6da62ad427fd31</Hash>
</Codenesium>*/