...
> {
  ...
  submit = (model: VPersonViewModel) => {
    let mapper = new VPersonMapper();
    axios
      .put<CreateResponse<Api.VPersonClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.VPersons +
          '/' +
...
export const WrappedVPersonEditComponent = Form.create({
  name: 'VPerson Edit',
})(VPersonEditComponent);


/*<Codenesium>
    <Hash>73e69be69e5edec0e6fbcaf186da1324</Hash>
</Codenesium>*/