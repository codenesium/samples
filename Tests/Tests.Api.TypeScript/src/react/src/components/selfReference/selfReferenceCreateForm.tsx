...
interface Props {
   ...
   const SelfReferenceCreateDisplay: React.SFC<FormikProps<SelfReferenceViewModel>> = (props: FormikProps<SelfReferenceViewModel>) => {

   let status = props.status as CreateResponse<Api.SelfReferenceClientRequestModel>;
...
const SelfReferenceCreate = withFormik<Props, SelfReferenceViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.SelfReferences,
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.SelfReferenceClientRequestModel>;
  ...
  export default class SelfReferenceCreateComponent extends React.Component<SelfReferenceCreateComponentProps, SelfReferenceCreateComponentState> {
...
/*<Codenesium>
    <Hash>6d741fcd78711c306ea14f0872559a6a</Hash>
</Codenesium>*/