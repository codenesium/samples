...
const SelfReferenceDetailDisplay = (model:Props) => {
   ...
   return (
          <form  role="form">
				<button
                  ...
                  onClick={(e) => { model.history.push(ClientRoutes.SelfReferences + '/edit/' + model.model!.id)}}
                >
                  <i className="fas fa-edit" />
							...
							<div className="col-sm-12">
								{String(model.model!.id)}
					   						 ...
					   						 <div className="form-group row">
							<label htmlFor="selfReferenceId" className={"col-sm-2 col-form-label"}>SelfReferenceId</label>
							<div className="col-sm-12">
								{model.model!.selfReferenceIdNavigation!.toDisplay()}
							</div>
						</div>
					   						 <div className="form-group row">
							<label htmlFor="selfReferenceId2" className={"col-sm-2 col-form-label"}>SelfReferenceId2</label>
							<div className="col-sm-12">
  ...
  export default class SelfReferenceDetailComponent extends React.Component<SelfReferenceDetailComponentProps, SelfReferenceDetailComponentState> {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<SelfReferenceDetailDisplay history={this.props.history} model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>3f3559901fbe55ad93c6fa477ce0ee73</Hash>
</Codenesium>*/