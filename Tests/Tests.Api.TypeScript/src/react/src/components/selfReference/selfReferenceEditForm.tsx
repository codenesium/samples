...
const SelfReferenceEditDisplay = (
...
const SelfReferenceEdit = withFormik<Props, SelfReferenceViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.SelfReferences + '/' + values.id,
...
export default class SelfReferenceEditComponent extends React.Component<
...
/*<Codenesium>
    <Hash>8afd491cfcaa991e71fea2e68d0f1f05</Hash>
</Codenesium>*/