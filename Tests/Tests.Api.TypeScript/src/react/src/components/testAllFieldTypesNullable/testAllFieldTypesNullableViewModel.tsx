...
this.id = 0;
	...
	setProperties(fieldBigInt : any,fieldBinary : any,fieldBit : any,fieldChar : string,fieldDate : any,fieldDateTime : any,fieldDateTime2 : any,fieldDateTimeOffset : any,fieldDecimal : any,fieldFloat : any,fieldImage : any,fieldMoney : any,fieldNChar : string,fieldNText : string,fieldNumeric : any,fieldNVarchar : string,fieldReal : any,fieldSmallDateTime : any,fieldSmallInt : any,fieldSmallMoney : any,fieldText : string,fieldTime : any,fieldTimestamp : any,fieldTinyInt : any,fieldUniqueIdentifier : any,fieldVarBinary : any,fieldVarchar : string,fieldXML : string,id : number) : void
	{
...
/*<Codenesium>
    <Hash>10758fa46af13499bd2053e8a03216aa</Hash>
</Codenesium>*/