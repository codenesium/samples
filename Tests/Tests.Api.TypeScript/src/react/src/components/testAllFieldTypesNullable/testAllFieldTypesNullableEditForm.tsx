...
> {
  ...
  submit = (model: TestAllFieldTypesNullableViewModel) => {
    let mapper = new TestAllFieldTypesNullableMapper();
    axios
      .put<CreateResponse<Api.TestAllFieldTypesNullableClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.TestAllFieldTypesNullables +
          '/' +
          this.state.model!.id,
...
export const WrappedTestAllFieldTypesNullableEditComponent = Form.create({
  name: 'TestAllFieldTypesNullable Edit',
})(TestAllFieldTypesNullableEditComponent);


/*<Codenesium>
    <Hash>6714433926c02e7e10f0ae54ab20fe97</Hash>
</Codenesium>*/