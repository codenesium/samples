...
export default class TestAllFieldTypesNullableSearchComponent extends React.Component<TestAllFieldTypesNullableSearchComponentProps, TestAllFieldTypesNullableSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<TestAllFieldTypesNullableViewModel>(), filteredRecords:new Array<TestAllFieldTypesNullableViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
