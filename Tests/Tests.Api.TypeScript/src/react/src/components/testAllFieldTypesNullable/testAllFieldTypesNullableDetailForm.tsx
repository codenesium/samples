...
const TestAllFieldTypesNullableDetailDisplay = (model:Props) => {
   ...
   return (
          <form  role="form">
				<button
                  ...
                  onClick={(e) => { model.history.push(ClientRoutes.TestAllFieldTypesNullables + '/edit/' + model.model!.id)}}
                >
  ...
  export default class TestAllFieldTypesNullableDetailComponent extends React.Component<TestAllFieldTypesNullableDetailComponentProps, TestAllFieldTypesNullableDetailComponentState> {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<TestAllFieldTypesNullableDetailDisplay history={this.props.history} model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>3c7f474d3cfa3f9bca912aeedcadd7a7</Hash>
</Codenesium>*/