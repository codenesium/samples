...
> {
  ...
  handleEditClick(e:any) {
    this.props.history.push(ClientRoutes.TestAllFieldTypesNullables + '/edit/' + this.state.model!.id);
  }
...
export const WrappedTestAllFieldTypesNullableDetailComponent = Form.create({ name: 'TestAllFieldTypesNullable Detail' })(
  TestAllFieldTypesNullableDetailComponent
);

/*<Codenesium>
    <Hash>1fa32a0f309c43033441b4085b83cb44</Hash>
</Codenesium>*/