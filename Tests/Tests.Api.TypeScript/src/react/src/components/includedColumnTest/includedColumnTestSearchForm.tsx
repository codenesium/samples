...
export default class IncludedColumnTestSearchComponent extends React.Component<IncludedColumnTestSearchComponentProps, IncludedColumnTestSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<IncludedColumnTestViewModel>(), filteredRecords:new Array<IncludedColumnTestViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedIncludedColumnTestSearchComponent = Form.create({ name: 'IncludedColumnTest Search' })(IncludedColumnTestSearchComponent);

/*<Codenesium>
    <Hash>bbdb47a9a13a12143aea6f8ed7107983</Hash>
</Codenesium>*/