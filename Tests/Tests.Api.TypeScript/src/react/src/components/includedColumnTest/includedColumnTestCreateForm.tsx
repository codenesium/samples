...
> {
  ...
  submit = (model: IncludedColumnTestViewModel) => {
    ...
    axios
      .post<CreateResponse<Api.IncludedColumnTestClientRequestModel>>(
...
export const WrappedIncludedColumnTestCreateComponent = Form.create({
  name: 'IncludedColumnTest Create',
})(IncludedColumnTestCreateComponent);


/*<Codenesium>
    <Hash>2832760fbc8c126e64444839b78d4872</Hash>
</Codenesium>*/