 ...
 handleSubmit = (e:FormEvent<HTMLFormElement>) => {
  ...
  {  
    let mapper = new IncludedColumnTestMapper();
     axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.IncludedColumnTests + '/' + this.state.model!.id,
...
export const WrappedIncludedColumnTestEditComponent = Form.create({ name: 'IncludedColumnTest Edit' })(IncludedColumnTestEditComponent);

/*<Codenesium>
    <Hash>2597dc45efb94e62dfbd4499267733ce</Hash>
</Codenesium>*/