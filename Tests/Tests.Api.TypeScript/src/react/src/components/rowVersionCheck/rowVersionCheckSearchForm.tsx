...
export default class RowVersionCheckSearchComponent extends React.Component<RowVersionCheckSearchComponentProps, RowVersionCheckSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<RowVersionCheckViewModel>(), filteredRecords:new Array<RowVersionCheckViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedRowVersionCheckSearchComponent = Form.create({ name: 'RowVersionCheck Search' })(RowVersionCheckSearchComponent);

/*<Codenesium>
    <Hash>18648575b9e6c19168f7ceb38e93509d</Hash>
</Codenesium>*/