      ...
      <div className="container-fluid">
        ...
        <Switch>
          <Route exact path="/" component={Dashboard} />
		  					  <Route path="/columnsameasfktables/create" component={ColumnSameAsFKTableCreateComponent} />
					  <Route path="/columnsameasfktables/edit/:id" component={ColumnSameAsFKTableEditComponent} />
					  <Route path="/columnsameasfktables/:id" component={ColumnSameAsFKTableDetailComponent} />
					  <Route path="/columnsameasfktables" component={ColumnSameAsFKTableSearchComponent} />
										  <Route path="/includedcolumntests/create" component={IncludedColumnTestCreateComponent} />
					  <Route path="/includedcolumntests/edit/:id" component={IncludedColumnTestEditComponent} />
					  <Route path="/includedcolumntests/:id" component={IncludedColumnTestDetailComponent} />
					  <Route path="/includedcolumntests" component={IncludedColumnTestSearchComponent} />
					  ...
					  <Route path="/people" component={PersonSearchComponent} />
										  <Route path="/rowversionchecks/create" component={RowVersionCheckCreateComponent} />
					  <Route path="/rowversionchecks/edit/:id" component={RowVersionCheckEditComponent} />
					  <Route path="/rowversionchecks/:id" component={RowVersionCheckDetailComponent} />
					  <Route path="/rowversionchecks" component={RowVersionCheckSearchComponent} />
										  <Route path="/selfreferences/create" component={SelfReferenceCreateComponent} />
					  <Route path="/selfreferences/edit/:id" component={SelfReferenceEditComponent} />
					  <Route path="/selfreferences/:id" component={SelfReferenceDetailComponent} />
					  <Route path="/selfreferences" component={SelfReferenceSearchComponent} />
					  ...
					  <Route path="/tables" component={TableSearchComponent} />
										  <Route path="/testallfieldtypes/create" component={TestAllFieldTypeCreateComponent} />
					  <Route path="/testallfieldtypes/edit/:id" component={TestAllFieldTypeEditComponent} />
					  <Route path="/testallfieldtypes/:id" component={TestAllFieldTypeDetailComponent} />
					  <Route path="/testallfieldtypes" component={TestAllFieldTypeSearchComponent} />
										  <Route path="/testallfieldtypesnullables/create" component={TestAllFieldTypesNullableCreateComponent} />
					  <Route path="/testallfieldtypesnullables/edit/:id" component={TestAllFieldTypesNullableEditComponent} />
					  <Route path="/testallfieldtypesnullables/:id" component={TestAllFieldTypesNullableDetailComponent} />
					  <Route path="/testallfieldtypesnullables" component={TestAllFieldTypesNullableSearchComponent} />
										  <Route path="/timestampchecks/create" component={TimestampCheckCreateComponent} />
					  <Route path="/timestampchecks/edit/:id" component={TimestampCheckEditComponent} />
					  <Route path="/timestampchecks/:id" component={TimestampCheckDetailComponent} />
					  <Route path="/timestampchecks" component={TimestampCheckSearchComponent} />
...
/*<Codenesium>
    <Hash>414cc6a233f731880c9934b6d4b32043</Hash>
</Codenesium>*/