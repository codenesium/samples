...
namespace TestsNS.Api.Web.IntegrationTests
{
	...
	public partial class ColumnSameAsFKTableIntegrationTests
	{
		...
		public virtual async void TestBulkInsert()
		{
			...
			context.Set<ColumnSameAsFKTable>().ToList()[1].Person.Should().Be(2);
			context.Set<ColumnSameAsFKTable>().ToList()[1].PersonId.Should().Be(2);

			context.Set<ColumnSameAsFKTable>().ToList()[2].Person.Should().Be(3);
			context.Set<ColumnSameAsFKTable>().ToList()[2].PersonId.Should().Be(3);
		}
		...
		public virtual async void TestCreate()
		{
			...
			result.Record.Person.Should().Be(2);
		...
		public virtual async void TestUpdate()
		{
			...
			context.Set<ColumnSameAsFKTable>().ToList()[0].Person.Should().Be(2);
			context.Set<ColumnSameAsFKTable>().ToList()[0].PersonId.Should().Be(2);

			updateResponse.Record.Id.Should().Be(1);
			updateResponse.Record.Person.Should().Be(2);
...
/*<Codenesium>
    <Hash>116ed7e2f1c284988efb55db061a799c</Hash>
</Codenesium>*/