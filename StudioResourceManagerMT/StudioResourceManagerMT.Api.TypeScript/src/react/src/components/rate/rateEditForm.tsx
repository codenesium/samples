...
const RateEdit = withFormik<Props, RateViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Rates +'/' + values.id,
  ...
  export default class RateEditComponent extends React.Component<RateEditComponentProps, RateEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Rates + '/' + this.props.match.params.id, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
...
/*<Codenesium>
    <Hash>f6def8e812e76b116ac03d7afbde7076</Hash>
</Codenesium>*/