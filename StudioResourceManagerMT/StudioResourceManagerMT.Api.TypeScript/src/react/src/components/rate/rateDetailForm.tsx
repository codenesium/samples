   ...
   return (
          <form  role="form">
				<button
                  ...
                  onClick={(e) => { model.history.push(ClientRoutes.Rates + '/edit/' + model.model!.id)}}
                >
                  <i className="fas fa-edit" />
							...
							<div className="col-sm-12">
								{String(model.model!.amountPerMinute)}
							</div>
						</div>
					   						 <div className="form-group row">
  ...
  export default class RateDetailComponent extends React.Component<RateDetailComponentProps, RateDetailComponentState> {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<RateDetailDisplay history={this.props.history} model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>f7d9e307e5f32f9152a5440f543279ac</Hash>
</Codenesium>*/