...
interface EventTeacherEditComponentProps {
  form: WrappedFormUtils;
  history: any;
  match: any;
}

interface EventTeacherEditComponentState {
...
class EventTeacherEditComponent extends React.Component<
  EventTeacherEditComponentProps,
  EventTeacherEditComponentState
> {
  state = {
  ...
  submit = (model: EventTeacherViewModel) => {
    let mapper = new EventTeacherMapper();
    axios
      .put<CreateResponse<Api.EventTeacherClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.EventTeachers +
          '/' +
...
export const WrappedEventTeacherEditComponent = Form.create({
  name: 'EventTeacher Edit',
})(EventTeacherEditComponent);


/*<Codenesium>
    <Hash>c6af1efef9993f1aa6d181e020f225fe</Hash>
</Codenesium>*/