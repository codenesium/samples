...
export default class EventStatuSearchComponent extends React.Component<EventStatuSearchComponentProps, EventStatuSearchComponentState> {

    state = ({deleteSubmitted:false, deleteSuccess:false, deleteResponse:'', records:new Array<EventStatuViewModel>(), filteredRecords:new Array<EventStatuViewModel>(), searchValue:'', loading:false, loaded:true, errorOccurred:false, errorMessage:''});
...
/*<Codenesium>
    <Hash>bac039310bd1270f28c797ce4e4d24ea</Hash>
</Codenesium>*/