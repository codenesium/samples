...
> {
  ...
  loadRecords(query: string = '') {
    ...
    axios
      .get<Array<Api.EventStatuClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedEventStatuSearchComponent = Form.create({
  name: 'EventStatu Search',
})(EventStatuSearchComponent);


/*<Codenesium>
    <Hash>1a858e5283743e41c10853acedbdfa5f</Hash>
</Codenesium>*/