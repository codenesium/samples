...
const EventStatuEdit = withFormik<Props, EventStatuViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.EventStatus +'/' + values.id,
  ...
  export default class EventStatuEditComponent extends React.Component<EventStatuEditComponentProps, EventStatuEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.EventStatus + '/' + this.props.match.params.id, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<EventStatuEdit model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>f8a2ce70c48318c07ebbb2478f02b72e</Hash>
</Codenesium>*/