...
const EventStatuCreateDisplay: React.SFC<FormikProps<EventStatuViewModel>> = (
  props: FormikProps<EventStatuViewModel>
) => {
  ...
  let errorsForField = (name: string): string => {
    let response = '';
    if (
      props.touched[name as keyof EventStatuViewModel] &&
      props.errors[name as keyof EventStatuViewModel]
    ) {
...
export default class EventStatuCreateComponent extends React.Component<
  EventStatuCreateComponentProps,
  EventStatuCreateComponentState
> {
  state = {
    model: undefined,
    loading: false,
...
/*<Codenesium>
    <Hash>35492a635b2613ae6b703b205057db2e</Hash>
</Codenesium>*/