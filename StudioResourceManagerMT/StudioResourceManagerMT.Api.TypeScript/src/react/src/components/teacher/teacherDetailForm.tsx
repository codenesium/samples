...
const TeacherDetailDisplay = (model:Props) => {
   ...
   return (
          <form  role="form">
				<button
                  ...
                  onClick={(e) => { model.history.push(ClientRoutes.Teachers + '/edit/' + model.model!.id)}}
                >
  ...
  export default class TeacherDetailComponent extends React.Component<TeacherDetailComponentProps, TeacherDetailComponentState> {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<TeacherDetailDisplay history={this.props.history} model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>5d176134b695102b195967c70e0ee6fe</Hash>
</Codenesium>*/