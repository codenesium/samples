...
> {
  ...
  handleDeleteClick(e: any, row: Api.TeacherClientResponseModel) {
    axios
      .delete(Constants.ApiEndpoint + ApiRoutes.Teachers + '/' + row.id, {
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.Teachers + '?limit=100';
    ...
    axios
      .get<Array<Api.TeacherClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
...
export const WrappedTeacherSearchComponent = Form.create({
  name: 'Teacher Search',
})(TeacherSearchComponent);


/*<Codenesium>
    <Hash>b47d9994952d11e98b83cc4708e9a3f4</Hash>
</Codenesium>*/