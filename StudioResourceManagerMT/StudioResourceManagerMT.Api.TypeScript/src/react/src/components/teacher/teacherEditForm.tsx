...
const TeacherEdit = withFormik<Props, TeacherViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Teachers +'/' + values.id,
        ...
        .then(resp => {
            let response = resp.data as UpdateResponse<Api.TeacherClientRequestModel>;
  ...
  export default class TeacherEditComponent extends React.Component<TeacherEditComponentProps, TeacherEditComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Teachers + '/' + this.props.match.params.id, {
            headers: {
                'Content-Type': 'application/json',
            }
        })
...
/*<Codenesium>
    <Hash>1e43b70710a79a4ce6cc8f917bb37e22</Hash>
</Codenesium>*/