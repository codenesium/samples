...
interface Props {
   ...
   const TeacherCreateDisplay: React.SFC<FormikProps<TeacherViewModel>> = (props: FormikProps<TeacherViewModel>) => {
   ...
   {
        let response = '';
        if(props.touched[name as keyof TeacherViewModel]  && props.errors[name as keyof TeacherViewModel]) {
...
const TeacherCreateComponent = withFormik<Props, TeacherViewModel>({
    mapPropsToValues: props => {
                
		let response = new TeacherViewModel();
		if (props.model != undefined)
		{
			response.setProperties(props.model!.birthday,props.model!.email,props.model!.firstName,props.model!.id,props.model!.isDeleted,props.model!.lastName,props.model!.phone,props.model!.tenantId,props.model!.userId);	
		}
		return response;
      },
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiUrl + 'teachers',
        ...
        .then(resp => {
            let response = resp.data as CreateResponse<Api.TeacherClientRequestModel>;
            actions.setStatus(response);
            console.log(response);
    
        }, error => {
            let response = error.response.data as CreateResponse<Api.TeacherClientRequestModel>;
            actions.setStatus(response);
            console.log(response);
        })
    },
...
/*<Codenesium>
    <Hash>1953ae953a1161fe5f790a8a965ca0e1</Hash>
</Codenesium>*/