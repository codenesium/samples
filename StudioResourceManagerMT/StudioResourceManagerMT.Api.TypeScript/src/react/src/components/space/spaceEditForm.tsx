...
const SpaceEdit = withFormik<Props, SpaceViewModel>({
    mapPropsToValues: props => {
		...
		response.setProperties(props.model!.description,props.model!.id,props.model!.name);	
		return response;
      },
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiEndpoint + ApiRoutes.Spaces +'/' + values.id,
...
/*<Codenesium>
    <Hash>015ff2f937059a86c21d379c383fef78</Hash>
</Codenesium>*/