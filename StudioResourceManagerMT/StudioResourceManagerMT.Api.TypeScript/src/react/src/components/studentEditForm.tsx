...
const StudentUpdate = withFormik<Props, StudentViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiUrl + 'students/' + values.id,
...
export default class StudentEditComponent extends React.Component<
...
> {
  ...
  render() {
    if (this.state.loading) {
      ...
      return <StudentUpdate model={this.state.model} />;
...
/*<Codenesium>
    <Hash>8f4493e39b6e93e247b3c4fec7bff566</Hash>
</Codenesium>*/