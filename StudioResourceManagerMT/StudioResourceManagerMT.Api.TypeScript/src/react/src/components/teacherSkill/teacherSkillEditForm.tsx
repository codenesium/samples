...
const TeacherSkillEdit = withFormik<Props, TeacherSkillViewModel>({
  ...
  handleSubmit: (values, actions) => {
    ...
    axios
      .put(
        Constants.ApiEndpoint + ApiRoutes.TeacherSkills + '/' + values.id,
...
export default class TeacherSkillEditComponent extends React.Component<
...
/*<Codenesium>
    <Hash>6e2163382829c31c122d2afa4d77110f</Hash>
</Codenesium>*/