...
interface Props {
   ...
   return (<form onSubmit={props.handleSubmit} role="form">            
					    ...
					    <div className="col-sm-12">
                             <Field type="datetime-local" name="primaryContactEmail" className={errorExistForField("primaryContactEmail") ? "form-control is-invalid" : "form-control"} />
					    ...
					    <div className="col-sm-12">
                             <Field type="datetime-local" name="primaryContactFirstName" className={errorExistForField("primaryContactFirstName") ? "form-control is-invalid" : "form-control"} />
					    ...
					    <div className="col-sm-12">
                             <Field type="datetime-local" name="primaryContactLastName" className={errorExistForField("primaryContactLastName") ? "form-control is-invalid" : "form-control"} />
					    ...
					    <div className="col-sm-12">
                             <Field type="datetime-local" name="primaryContactPhone" className={errorExistForField("primaryContactPhone") ? "form-control is-invalid" : "form-control"} />
...
const FamilyCreate = withFormik<Props, FamilyViewModel>({
    mapPropsToValues: props => {
		...
		{
			response.setProperties(props.model!.id,props.model!.note,props.model!.primaryContactEmail,props.model!.primaryContactFirstName,props.model!.primaryContactLastName,props.model!.primaryContactPhone);	
		}
		return response;
      },
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.post(Constants.ApiEndpoint + ApiRoutes.Families,
  ...
  export default class FamilyCreateComponent extends React.Component<FamilyCreateComponentProps, FamilyCreateComponentState> {
...
/*<Codenesium>
    <Hash>4da6c5b94a6c9a8a42f9717bb46d3519</Hash>
</Codenesium>*/