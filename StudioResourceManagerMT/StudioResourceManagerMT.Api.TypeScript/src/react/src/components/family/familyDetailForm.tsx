...
const FamilyDetailDisplay = (model:Props) => {
   ...
   return (
          <form  role="form">
				<button
                  ...
                  onClick={(e) => { model.history.push(ClientRoutes.Families + '/edit/' + model.model!.id)}}
                >
  ...
  export default class FamilyDetailComponent extends React.Component<FamilyDetailComponentProps, FamilyDetailComponentState> {
    ...
    componentDidMount () {
        ...
        axios.get(Constants.ApiEndpoint + ApiRoutes.Families + '/' + this.props.match.params.id,
        {
            headers: {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<FamilyDetailDisplay history={this.props.history} model={this.state.model} />);
        } 
		else {
		  return null;
		}
...
/*<Codenesium>
    <Hash>098e1b44175da0ba5ad9bd0a274fd037</Hash>
</Codenesium>*/