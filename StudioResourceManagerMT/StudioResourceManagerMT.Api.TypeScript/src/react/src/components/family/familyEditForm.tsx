      ...
      return <Spin size="large" />;
        ...
        return ( 
         <Form onSubmit={this.handleSubmit}>
              ...
              ( <DatePicker format={'YYYY-MM-DD'} placeholder={"notes"} id={"note"} /> )}
              </Form.Item>
              ...
              ( <DatePicker format={'YYYY-MM-DD'} placeholder={"primaryContactEmail"} id={"primaryContactEmail"} /> )}
              </Form.Item>
              ...
              ( <DatePicker format={'YYYY-MM-DD'} placeholder={"primaryContactFirstName"} id={"primaryContactFirstName"} /> )}
              </Form.Item>
              ...
              ( <DatePicker format={'YYYY-MM-DD'} placeholder={"primaryContactLastName"} id={"primaryContactLastName"} /> )}
              </Form.Item>
              ...
              ( <DatePicker format={'YYYY-MM-DD'} placeholder={"primaryContactPhone"} id={"primaryContactPhone"} /> )}
              </Form.Item>
...
/*<Codenesium>
    <Hash>117efb7844f3df437f9eb4e9c8d26145</Hash>
</Codenesium>*/