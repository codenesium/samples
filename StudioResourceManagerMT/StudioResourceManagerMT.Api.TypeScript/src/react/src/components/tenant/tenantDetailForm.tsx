...
interface TenantDetailComponentState {
...
class TenantDetailComponent extends React.Component<
  TenantDetailComponentProps,
  TenantDetailComponentState
> {
  state = {
  ...
  handleEditClick(e: any) {
    this.props.history.push(
      ClientRoutes.Tenants + '/edit/' + this.state.model!.id
    );
  }
...
export const WrappedTenantDetailComponent = Form.create({
  name: 'Tenant Detail',
