...
const StudioCreateDisplay: React.SFC<FormikProps<StudioViewModel>> = (
  props: FormikProps<StudioViewModel>
) => {
...
export default class StudioCreateComponent extends React.Component<
...
/*<Codenesium>
    <Hash>8e8ee272bada331c99ade26b7c685c88</Hash>
</Codenesium>*/