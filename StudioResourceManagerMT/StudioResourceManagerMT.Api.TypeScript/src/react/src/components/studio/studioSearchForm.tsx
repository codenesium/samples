...
export default class StudioSearchComponent extends React.Component<StudioSearchComponentProps, StudioSearchComponentState> {
   ...
   loadRecords(query:string = '') {
	   ...
	   .then(resp => {
		   ...
		   console.log(error);
		   this.setState({records:new Array<StudioViewModel>(), filteredRecords:new Array<StudioViewModel>(), loading:false, loaded:true, errorOccurred:true, errorMessage:'Error from API'});
	   })
    }
...
export const WrappedStudioSearchComponent = Form.create({ name: 'Studio Search' })(StudioSearchComponent);

/*<Codenesium>
    <Hash>868fdc223798e0edda7d674135f6321a</Hash>
</Codenesium>*/