...
const AdminUpdate = withFormik<Props, AdminViewModel>({
    ...
    handleSubmit: (values, actions) => {
        ...
        axios.put(Constants.ApiUrl + 'admins/' + values.id,
  ...
  export default class AdminEditComponent extends React.Component<AdminEditComponentProps, AdminEditComponentState> {
    ...
    render () {
        ...
        if (this.state.loading) {
            ...
            return (<AdminUpdate model={this.state.model} />);
        } 
...
/*<Codenesium>
    <Hash>3851d4888971cfe6b7437beafda308a3</Hash>
</Codenesium>*/