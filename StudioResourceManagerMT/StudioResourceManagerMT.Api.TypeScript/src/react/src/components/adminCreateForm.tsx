...
const AdminCreateDisplay: React.SFC<FormikProps<AdminViewModel>> = (
  props: FormikProps<AdminViewModel>
) => {
  ...
  let errorsForField = (name: string): string => {
    let response = '';
    if (
      props.touched[name as keyof AdminViewModel] &&
      props.errors[name as keyof AdminViewModel]
    ) {
...
const AdminCreateComponent = withFormik<Props, AdminViewModel>({
...
/*<Codenesium>
    <Hash>9ce75fe260f8a1ca88a4a12313a15d80</Hash>
</Codenesium>*/