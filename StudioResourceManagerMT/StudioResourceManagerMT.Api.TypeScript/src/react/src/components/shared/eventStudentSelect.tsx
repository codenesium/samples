...
interface EventStudentSelectComponentProps {
...
interface EventStudentSelectComponentState {
  loading: boolean;
  loaded: boolean;
...
export class EventStudentSelectComponent extends React.Component<
  EventStudentSelectComponentProps,
  EventStudentSelectComponentState
> {
  state = {
    loading: false,
    loaded: true,
  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(response => {
        ...
        let devices: Array<EventStudentViewModel> = [];
      ...
      return (
        <Form.Item>
          ...
          {this.props.getFieldDecorator(this.props.propertyName, {
            ...
            <Select>
              {this.state.filteredRecords.map((x: EventStudentViewModel) => {
                return (
...
/*<Codenesium>
    <Hash>0d56d37d08d9056a8dcb7fbac1041c36</Hash>
</Codenesium>*/