...
interface EventStatuTableComponentState {
  loading: boolean;
  loaded: boolean;
...
export class EventStatuTableComponent extends React.Component<
  EventStatuTableComponentProps,
  EventStatuTableComponentState
> {
  state = {
    loading: false,
    loaded: true,
...
/*<Codenesium>
    <Hash>b3bb85cd0796d57572042aa3821e6d44</Hash>
</Codenesium>*/