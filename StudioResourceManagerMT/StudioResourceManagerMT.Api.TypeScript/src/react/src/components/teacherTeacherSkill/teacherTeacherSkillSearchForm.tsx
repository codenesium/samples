...
interface TeacherTeacherSkillSearchComponentProps {
  form: WrappedFormUtils;
  history: any;
  match: any;
}

interface TeacherTeacherSkillSearchComponentState {
  records: Array<TeacherTeacherSkillViewModel>;
...
export default class TeacherTeacherSkillSearchComponent extends React.Component<
  TeacherTeacherSkillSearchComponentProps,
  TeacherTeacherSkillSearchComponentState
> {
  state = {
    deleteSubmitted: false,
    deleteSuccess: false,
    deleteResponse: '',
    records: new Array<TeacherTeacherSkillViewModel>(),
    filteredRecords: new Array<TeacherTeacherSkillViewModel>(),
    searchValue: '',
    loading: false,
    loaded: true,
    errorOccurred: false,
  ...
  handleCreateClick(e: any) {
    this.props.history.push(ClientRoutes.TeacherTeacherSkills + '/create');
  }
  ...
  loadRecords(query: string = '') {
    ...
    let searchEndpoint =
      Constants.ApiEndpoint + ApiRoutes.TeacherTeacherSkills + '?limit=100';
    ...
    axios
      .get<Array<Api.TeacherTeacherSkillClientResponseModel>>(searchEndpoint, {
        headers: GlobalUtilities.defaultHeaders(),
      })
      .then(response => {
        let viewModels: Array<TeacherTeacherSkillViewModel> = [];
...
export const WrappedTeacherTeacherSkillSearchComponent = Form.create({
  name: 'TeacherTeacherSkill Search',
})(TeacherTeacherSkillSearchComponent);
