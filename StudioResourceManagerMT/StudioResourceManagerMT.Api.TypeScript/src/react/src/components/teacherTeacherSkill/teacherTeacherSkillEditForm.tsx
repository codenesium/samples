...
interface TeacherTeacherSkillEditComponentProps {
  form: WrappedFormUtils;
  history: any;
  match: any;
}

interface TeacherTeacherSkillEditComponentState {
...
class TeacherTeacherSkillEditComponent extends React.Component<
  TeacherTeacherSkillEditComponentProps,
  TeacherTeacherSkillEditComponentState
> {
  state = {
  ...
  submit = (model: TeacherTeacherSkillViewModel) => {
    let mapper = new TeacherTeacherSkillMapper();
    axios
      .put<CreateResponse<Api.TeacherTeacherSkillClientRequestModel>>(
        Constants.ApiEndpoint +
          ApiRoutes.TeacherTeacherSkills +
          '/' +
...
export const WrappedTeacherTeacherSkillEditComponent = Form.create({
  name: 'TeacherTeacherSkill Edit',
})(TeacherTeacherSkillEditComponent);
